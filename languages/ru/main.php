...
$lang['ERROR_LOGIN'] = 'Введено неправильное имя пользователя или пароль.';
...
$lang['DONT_MESSAGE_TITLE'] = 'Вы должны указать заголовок сообщения';
$lang['INVALID_TOPIC_ID'] = 'Тема не найдена!';
$lang['INVALID_TOPIC_ID_DB'] = 'Топик отсутствует в базе данных!';

$lang['NOT_EDIT_TOR_STATUS'] = 'Вы не можете редактировать раздачу с этим статусом';
...
$lang['ANONYMOUS_TOPIC'] = 'Опубликовать тему анонимно';
$lang['ANONYMOUS_REPLY'] = 'Опубликовать ответ анонимно';
$lang['HIDE_AUTHORSHIP'] = 'По умолчанию публиковать анонимно';
$lang['HIDE_AUTHORSHIP_EXPLAIN'] = 'Если включено, новые сообщения по умолчанию будут в режиме анонимности. Вы можете переключать это для каждого сообщения.';
$lang['ALLOW_ANONYMOUS_POSTING'] = 'Разрешить анонимную публикацию';
$lang['ANONYMOUS_POST_LABEL'] = 'Опубликовано анонимно';
$lang['POSTED_ANONYMOUSLY'] = 'опубликовано анонимно';
$lang['ANONYMOUS_ADMIN_NOTICE'] = 'Администраторы и модераторы видят настоящего автора';
$lang['YOU'] = 'Вы';
...
$lang['MAX_SMILIES_PER_POST'] = 'Превышен лимит смайликов: %s.';
...
$lang['NO_SUCH_FOLDER'] = 'Папка не найдена';
...
$lang['BIRTHDAY_TO_LOW'] = 'Извините, на этом сайте не принимают пользователей младше %d лет';
...
$lang['NOBIRTHDAY_WEEK'] = 'В ближайшие %d дней никто не празднует День Рождения.'; // %d is substituted with the number of days
...
$lang['SIGNATURE_DISABLE'] = 'Подпись отключена из-за нарушения правил форума';
$lang['PUBLIC_VIEW_EMAIL'] = 'Показывать мой адрес e-mail в профиле';

$lang['EMAIL_EXPLAIN'] = 'На этот адрес будет отправлено письмо с подтверждением для завершения регистрации';
...
$lang['RESET_AUTOLOGIN_EXPL'] = 'Это выйдет из вашей учётной записи на всех устройствах, где включён автоматический вход';
...
$lang['AVATAR_DISABLE'] = 'Загрузка аватара отключена из-за нарушения <a href=\"%s\"><b>правил форума</b></a>';
...
$lang['USERNAME_TOO_LONG'] = 'Ваше имя пользователя слишком длинное.';
$lang['USERNAME_TOO_SMALL'] = 'Ваше имя пользователя слишком короткое.';
...
$lang['NO_LIKES'] = 'Никто еще не голосовал';
$lang['LIKE_ALREADY'] = 'Вы уже голосовали по этой теме';
...
$lang['GROUP_JOINED'] = 'Вы успешно подали заявку на вступление в эту группу.<br />Вы будете уведомлены, когда ваше членство одобрит модератор группы.';
...
$lang['SHOW_MORE_INFORMATION_FILE'] = 'Показать больше информации об этом файле';
...
$lang['TOR_STATUS_NAME'] = [
    ...
    TOR_NEED_EDIT => 'требуется правка',
    TOR_NO_DESC => 'неполный',
    TOR_DUP => 'дубликат',
...
$lang['CHANGE_TOR_TYPE'] = 'Статус торрента успешно изменён';
...
$lang['UNEXECUTED_RELEASE'] = 'У вас есть незаконченная раздача. Пожалуйста, завершите её перед созданием новой!';
$lang['TOR_STATUS_LOG_ACTION'] = 'Новый статус: %s.<br/>Предыдущий статус: %s.';

// tor_comment
$lang['TOR_MOD_TITLE'] = 'Статус раздачи изменён – %s';
$lang['TOR_MOD_MSG'] = "Здравствуйте, %s.\n\nСтатус [url=%s]вашей[/url] раздачи изменён на [b]%s[/b]";

$lang['TOR_AUTH_TITLE'] = 'Запрошены изменения форматирования – %s';
...
$lang['TOR_AUTH_SENT_COMMENT'] = ' &middot; <span class=\"seed bold\">Информация отправлена модератору. Ожидайте ответа.</span>';
...
$lang['UNSET_GOLD_TORRENT'] = 'Убрать статус золота';
$lang['SET_SILVER_TORRENT'] = 'Сделать серебряным';
$lang['UNSET_SILVER_TORRENT'] = 'Убрать статус серебра';
$lang['GOLD_STATUS'] = 'ЗОЛОТАЯ РАЗДАЧА! Трафик за скачивание не учитывается!';
$lang['SILVER_STATUS'] = 'СЕРЕБРЯНАЯ РАЗДАЧА! Трафик за скачивание учитывается частично!';
...
$lang['NOT_SEL_CHAPTERS'] = 'Вы не выбрали ни одной темы';
...
$lang['BT_SEED_EXIST'] = 'Сидер присутствует';
...
$lang['UNSET_DL_STATUS'] = 'Не скачивается';
...
$lang['NOT_TORRENT'] = 'Этот файл не является торрентом';
...
$lang['BONUS'] = 'Бонус';
$lang['IT_WILL_BE_DOWN'] = 'будет засчитан после скачивания';
$lang['SPMODE_FULL'] = 'Подробная статистика пиров';

// Seed Bonus
$lang['MY_BONUS'] = 'Мой бонус (%s доступно очков)';
$lang['BONUS_SELECT'] = 'Выбор';
$lang['SEED_BONUS'] = 'Сидбонус';
$lang['EXCHANGE'] = 'Обменять';
$lang['EXCHANGE_BONUS'] = 'Обмен бонусов за сидирование';
$lang['BONUS_UPLOAD_DESC'] = '<b>+%s кредит на отдачу</b> <br /> Обменяйте бонусные очки на %1$s трафика для отдачи, добавленного к вашему общему счету.';
$lang['BONUS_UPLOAD_PRICE'] = '<b class="%s">%s</b>';
$lang['PRICE'] = 'Цена';
$lang['EXCHANGE_NOT'] = 'Обмен недоступен';
$lang['BONUS_SUCCES'] = 'На ваш счёт успешно зачислено %s';
...
$lang['BT_LOW_RATIO_FOR_DL'] = 'Ваш коэффициент <b>%s</b> слишком низкий для скачивания торрентов';
$lang['BT_RATIO_WARNING_MSG'] = 'Если ваш коэффициент упадёт ниже %s, скачивание торрентов будет заблокировано! <a href=\"%s\"><b>Подробнее о коэффициенте.</b></a>';
...
$lang['ERROR_BUILD'] = 'Содержимое этого торрента не может быть отображено (не удалось построить список файлов)';
...
$lang['USER_DELETE_ME'] = 'Извините, ваш аккаунт не может быть удалён!';
$lang['USER_DELETE_CSV'] = 'Извините, этот аккаунт не может быть удалён!';
...
$lang['DELETE_USER_POSTS'] = 'Удалить все сообщения, кроме первого в каждой теме';
$lang['DELETE_USER_POSTS_ME'] = 'Вы действительно хотите удалить все свои сообщения?';
$lang['DELETE_USER_POSTS_CONFIRM'] = 'Вы уверены, что хотите удалить все сообщения, кроме первого в каждой теме?';
...
$lang['DEACTIVATE_CONFIRM'] = 'Вы действительно хотите удалить этого пользователя?';
$lang['USER_ACTIVATE_ON'] = 'Пользователь успешно активирован';
$lang['USER_DEACTIVATE_ME'] = 'Вы не можете деактивировать свой собственный аккаунт!';
$lang['ACTIVATE_CONFIRM'] = 'Вы уверены, что хотите активировать этого пользователя?';
$lang['USER_ACTIVATE_OFF'] = 'Пользователь успешно деактивирован';

// Register
$lang['CHOOSE_A_NAME'] = 'Пожалуйста, выберите имя пользователя';
$lang['CHOOSE_E_MAIL'] = 'Вы должны указать адрес электронной почты';
$lang['CHOOSE_PASS'] = 'Поле пароля не должно быть пустым!';
...
$lang['EMAILER_DISABLED'] = 'Извините, эта функция временно недоступна';
$lang['REGISTERED_IN_TIME'] = 'Регистрация в данный момент закрыта<br /><br />Регистрация доступна в: %s<br />Текущее время сервера: %s<br /><br />Приносим извинения за неудобства';
...
$lang['SCREENSHOTS_RULES'] = 'Прочитайте правила размещения скриншотов!';
$lang['AJAX_EDIT_OPEN'] = 'У вас уже есть открытая сессия быстрого редактирования!';
...
$lang['JAVASCRIPT_ON'] = 'JavaScript должен быть включен для отправки сообщений';
...
$lang['DL_UPD'] = 'обновить время сообщения: ';
...
$lang['DEL_LIST_MY_MESSAGE_INFO'] = 'После удаления <b>полный список</b> может ещё показывать ранее удалённые темы до обновления страницы';
$lang['DEL_LIST_INFO'] = 'Чтобы удалить запись из списка, нажмите на значок слева от названия любого раздела';
...
$lang['ACTIONS_LOG'] = 'Журнал действий';
...
$lang['AUTH_POLLCREATE'] = $lang['POLLCREATE'] = 'Создать опрос';
...
$lang['AUTH_SELF_ERROR'] = 'Не удалось сменить себе роль с администратора на пользователя';
$lang['NO_FORUMS_AVAILABLE'] = 'Нет доступных форумов. Сначала создайте форумы, чтобы управлять разрешениями.';
...
$lang['SMILIES_PATH_EXPLAIN'] = 'Путь в пределах вашей публичной директории TorrentPier, например assets/images/smiles';
...
$lang['LOGIN_RESET_TIME_EXPLAIN'] = 'Время в минутах, которое пользователь должен ждать, прежде чем сможет войти снова после превышения допустимого числа попыток входа.';
...
// Mods
$lang['MAX_NEWS_TITLE'] = 'Максимальная длина заголовка новости';
...
$lang['WHOIS_INFO'] = 'Информация об IP-адресе';
$lang['SHOW_MOD_HOME_PAGE'] = 'Показывать модераторов на главной странице (index.php)';
$lang['SHOW_BOARD_STARTED_INDEX'] = 'Показывать дату начала форума на index.php';
$lang['PREMOD_HELP'] = '<h4><span class=\"tor-icon tor-dup\">&#8719;</span> Премодерация</h4> <h6>Если в этом разделе и его подразделах нет торрентов со статусом v, # или T, новые раздачи автоматически получат этот статус</h6>';
$lang['TOR_COMMENT'] = '<h4>Комментарий к статусу раздачи</h4> <h6>Комментарий позволяет указать релизеру на ошибки в раздаче. Если требуются исправления, релизеру становится доступна форма ответа для правки раздачи</h6>';
$lang['SEED_BONUS_ADD'] = '<h4>Правила бонусов за сидирование</h4> <h6>Количество торрентов, раздаваемых пользователем, и соответствующие бонусные очки, начисляемые за час</h6>';
$lang['SEED_BONUS_RELEASE'] = 'до N раздач';
$lang['SEED_BONUS_POINTS'] = 'бонусных очков в час';
$lang['SEED_BONUS_TOR_SIZE'] = '<h4>Минимальный размер торрента для получения бонусных очков</h4> <h6>Оставьте пустым, чтобы начислять бонусы за все торренты независимо от размера.</h6>';
$lang['SEED_BONUS_USER_REGDATA'] = '<h4>Минимальный возраст аккаунта пользователя для получения бонусных очков</h4> <h6>Оставьте пустым, чтобы начислять бонусы всем пользователям независимо от возраста аккаунта.</h6>';
$lang['SEED_BONUS_WARNING'] = 'ВНИМАНИЕ! Сидбонусы должны быть в порядке возрастания';
$lang['SEED_BONUS_EXCHANGE'] = 'Настройка обмена бонусных очков за сидирование';
$lang['SEED_BONUS_ROPORTION'] = 'Курс обмена: бонусные очки в гигабайты трафика на отдачу';
...
$lang['BT_CHECK_ANNOUNCE_URL_EXPL'] = 'регистрировать только разрешённые URL-адреса на трекере';
...
$lang['CRON_EXECUTION_TIME'] = 'Время выполнения';
...
$lang['DELETE_JOB'] = 'Вы уверены, что хотите удалить эту задачу cron?';
...
$lang['NOSELECT'] = 'Не выбрано';
$lang['RUN_DAY'] = 'День запуска';
$lang['RUN_DAY_EXPL'] = 'день, в который выполняется эта задача';
$lang['RUN_TIME'] = 'Время запуска';
$lang['RUN_TIME_EXPL'] = 'время запуска этой задачи (например, 05:00:00)';
...
$lang['LOG_FILE_EXPL'] = 'файл для сохранения лога';
...
$lang['SCRIPT_DUPLICATE'] = 'Задание cron с этим скриптом уже существует';
$lang['TITLE_DUPLICATE'] = 'Задание cron с таким названием уже существует';
...
$lang['START_OPTION_CONTINUE'] = 'продолжить с того места, где остановились';
...
$lang['INFO_PROCESSING_ABORTED_SOON'] = 'Пожалуйста, подождите несколько минут перед продолжением...';
...
$lang['CALLSEED'] = 'Позвать сидеров';
$lang['CALLSEED_EXPLAIN'] = 'Уведомить сидеров с просьбой возобновить раздачу этого релиза';
$lang['CALLSEED_SUBJECT'] = 'Требуется помощь с сидированием: %s';
$lang['CALLSEED_TEXT'] = 'Здравствуйте![br]Ваша помощь нужна в раздаче [url=%s]%s[/url][br]Если вы хотите помочь, но торрент-файл уже удалён, его можно скачать [url=%s]здесь[/url][br][br]Будем очень благодарны за вашу помощь!';
$lang['CALLSEED_MSG_OK'] = 'Запрос отправлен всем, кто скачивал этот релиз';
$lang['CALLSEED_MSG_SPAM'] = 'Запрос уже был недавно отправлен (возможно, не вами).<br /><br />Следующий запрос можно отправить <b>%s</b>.';
...
$lang['LOG_ACTION']['LOG_TYPE'] = [
    ...
    'adm_user_ban' => 'Пользователь:<br /> <b>забанен</b>',
    'adm_user_unban' => 'Пользователь:<br /> <b>разбанен</b>',
];
...
$lang['SEARCH_FOR_RANK'] = 'Поиск пользователей с рангом %s';
...
$lang['SEARCH_USERS_LASTVISITED'] = 'Пользователи, которые посещали';
$lang['IN_THE_LAST'] = 'за последние';
$lang['AFTER_THE_LAST'] = 'ранее чем за последние';
$lang['BEFORE'] = 'До';
$lang['AFTER'] = 'После';
$lang['SEARCH_USERS_JOINED_EXPLAIN'] = 'Поиск пользователей, зарегистрированных до или после указанной даты. Формат даты: ГГГГ/ММ/ДД.';
$lang['SEARCH_USERS_GROUPS_EXPLAIN'] = 'Просмотреть всех членов выбранной группы.';
$lang['SEARCH_USERS_RANKS_EXPLAIN'] = 'Просмотр всех пользователей выбранного звания.';
...
$lang['USERFIELD'] = 'Поле пользователя';
...
$lang['MC_COMMENT_PM_MSG'] = "Здравствуйте, [b]%s[/b]\nМодератор оставил комментарий к вашему сообщению [url=%s][b]%s[/b][/url][quote]\n%s\n[/quote]";
$lang['MC_COMMENT'] = [
    0 => [
        'title' => '',
...
$lang['CAPTCHA_SETTINGS'] = '<h2>Капча не полностью настроена</h2><p>Сгенерируйте ключи с помощью панели управления вашего сервиса капчи, затем поместите их в файл config/config.php.</p>';
...
// Spam protection
$lang['REGISTRATION_DENIED'] = 'Регистрация отклонена. Пожалуйста, свяжитесь с администратором, если вы считаете, что это ошибка.';
$lang['POST_SPAM_DENIED'] = 'Ваше сообщение было определено как спам и не может быть размещено.';
$lang['PM_SPAM_DENIED'] = 'Ваше сообщение было определено как спам и не может быть отправлено.';

// Spam log (admin)
$lang['SPAM_LOG'] = 'Журнал спама';
$lang['SPAM_LOG_DESC'] = 'В этот журнал записываются все попытки регистрации и отправки контента, помеченные системой защиты от спама. <b>Отклонено</b> &mdash; действие было полностью заблокировано (регистрация отклонена, сообщение/ЛС не отправлено). <b>Модерировано</b> &mdash; для регистраций аккаунт создан, но требует активации по электронной почте; для контента сообщение/ЛС было пропущено, но помечено как подозрительное.';
$lang['SPAM_LOG_CHECK_TYPE'] = 'Тип проверки';
$lang['SPAM_LOG_CHECK_TYPE_DESC_REG'] = 'регистрация &mdash; новая регистрация аккаунта';
$lang['SPAM_LOG_CHECK_TYPE_DESC_CONTENT'] = 'контент &mdash; сообщение или личное сообщение';
$lang['SPAM_LOG_DECISION'] = 'Решение';
$lang['SPAM_LOG_PROVIDER'] = 'Поставщик';
$lang['SPAM_LOG_REASON'] = 'Причина';
$lang['SPAM_LOG_RESPONSE_TIME'] = 'Время (мс)';
$lang['SPAM_LOG_ALL'] = 'Все';
$lang['SPAM_LOG_DETAILS'] = 'Подробности';
$lang['SPAM_LOG_NO_RECORDS'] = 'Записи в журнале спама не найдены';
$lang['SPAM_LOG_TOTAL'] = 'Всего записей';
$lang['SPAM_LOG_DENIED_COUNT'] = 'Отклонено';
...
$lang['TWO_FACTOR_AUTH'] = 'Двухэтапная проверка';
$lang['TWO_FACTOR_VERIFICATION'] = 'Двухэтапная проверка';
$lang['TWO_FACTOR_SECURITY'] = 'Безопасность';
$lang['TWO_FACTOR_AUTH_EXPLAIN'] = 'Добавьте дополнительный уровень безопасности для вашего аккаунта с помощью приложения-аутентификатора TOTP';
$lang['TWO_FACTOR_ENABLE'] = 'Включить 2FA';
$lang['TWO_FACTOR_DISABLE'] = 'Отключить 2FA';
$lang['TWO_FACTOR_ENABLED'] = 'Включено';
$lang['TWO_FACTOR_DISABLED'] = 'Выключено';
$lang['TWO_FACTOR_SETUP'] = 'Настроить двухэтапную проверку';
$lang['TWO_FACTOR_SETUP_EXPLAIN'] = 'Отсканируйте этот QR-код с помощью приложения для аутентификации (Google Authenticator, Authy и т. д.) или введите ключ вручную ниже.';
$lang['TWO_FACTOR_MANUAL_ENTRY'] = 'Или введите этот ключ вручную';
$lang['TWO_FACTOR_ENTER_CODE'] = 'Введите 6-значный код из вашего приложения-аутентификатора';
$lang['TWO_FACTOR_CODE'] = 'Код аутентификации';
$lang['TWO_FACTOR_VERIFY'] = 'Проверить';
$lang['TWO_FACTOR_VERIFY_AND_ENABLE'] = 'Проверить и включить';
$lang['TWO_FACTOR_INVALID_CODE'] = 'Неверный код. Пожалуйста, попробуйте снова.';
$lang['TWO_FACTOR_SESSION_EXPIRED'] = 'Сессия проверки истекла. Пожалуйста, войдите снова.';
$lang['TWO_FACTOR_SETUP_EXPIRED'] = 'Сессия настройки истекла. Пожалуйста, попробуйте снова.';
$lang['TWO_FACTOR_ALREADY_ENABLED'] = 'Двухэтапная проверка уже включена в вашем аккаунте.';
$lang['TWO_FACTOR_NOT_ENABLED'] = 'Двухэтапная проверка не включена в вашем аккаунте.';
$lang['TWO_FACTOR_FEATURE_DISABLED'] = 'Двухэтапная проверка недоступна';
$lang['TWO_FACTOR_ENABLED_SUCCESS'] = 'Двухэтапная проверка была включена';
$lang['TWO_FACTOR_DISABLED_SUCCESS'] = 'Двухэтапная проверка была отключена';
$lang['TWO_FACTOR_RECOVERY_CODES'] = 'Коды восстановления';
$lang['TWO_FACTOR_RECOVERY_WARNING'] = 'Сохраните эти коды восстановления в безопасном месте. Если вы потеряете устройство аутентификации, вы сможете использовать эти коды для входа.';
$lang['TWO_FACTOR_RECOVERY_EXPLAIN'] = 'Каждый код можно использовать только один раз. Храните их отдельно от устройства.';
$lang['TWO_FACTOR_RECOVERY_CODE'] = 'Код восстановления';
$lang['TWO_FACTOR_ENTER_RECOVERY'] = 'Введите один из ваших кодов восстановления';
$lang['TWO_FACTOR_USE_RECOVERY'] = 'Использовать код восстановления вместо этого';
$lang['TWO_FACTOR_USE_TOTP'] = 'Использовать код аутентификатора вместо этого';
$lang['TWO_FACTOR_INVALID_RECOVERY'] = 'Неверный код восстановления. Пожалуйста, попробуйте снова.';
$lang['TWO_FACTOR_RECOVERY_CODE_USED'] = 'Код восстановления использован. У вас осталось {count, plural, one {# код} few {# кода} many {# кодов} other {# кода}}.';
$lang['TWO_FACTOR_REMAINING_CODES'] = 'У вас осталось {count, plural, one {# код} few {# кода} many {# кодов} other {# кода}} восстановления';
$lang['TWO_FACTOR_DOWNLOAD_CODES'] = 'Скачать как текстовый файл';
$lang['TWO_FACTOR_RECOVERY_EXPIRED'] = 'Время отображения кодов восстановления истекло. Ваши коды все еще активны.';
$lang['TWO_FACTOR_DOWNLOAD_EXPIRED'] = 'Ссылка для загрузки истекла.';
$lang['TWO_FACTOR_DISABLE_WARNING'] = 'Это отключит двухэтапную проверку в вашем аккаунте. Для подтверждения потребуется ввести текущий код аутентификации.';
$lang['TWO_FACTOR_DISABLE_CONFIRM'] = 'Отключить двухэтапную проверку';
$lang['TWO_FACTOR_REGENERATE'] = 'Перегенерировать коды восстановления';
$lang['TWO_FACTOR_REGENERATE_WARNING'] = 'Это сделает недействительными все существующие коды восстановления и создаст новые.';
$lang['TWO_FACTOR_REGENERATE_CONFIRM'] = 'Перегенерировать коды';
$lang['TWO_FACTOR_ADMIN_DISABLE'] = 'Отключить 2FA пользователя';
$lang['TWO_FACTOR_ADMIN_DISABLE_CONFIRM'] = 'Вы уверены, что хотите отключить двухэтапную проверку для этого пользователя?';
$lang['TWO_FACTOR_TOO_MANY_ATTEMPTS'] = 'Слишком много неудачных попыток. Пожалуйста, попробуйте снова через {count, plural, one {# минуту} few {# минуты} many {# минут} other {# минуты}}.';
$lang['TWO_FACTOR_INVALID_TOKEN'] = 'Неверный или истекший токен.';
$lang['TWO_FACTOR_DONE'] = 'Готово';
$lang['TWO_FACTOR_RECOVERY_ONETIME'] = 'Эту страницу можно просмотреть только один раз. Если вы уйдете, вы больше не сможете увидеть эти коды.';
$lang['TWO_FACTOR_ADMIN_DISABLE_SELF'] = 'Вы не можете отключить свою собственную двухэтапную проверку из панели администратора. Используйте настройки вашего профиля.';
