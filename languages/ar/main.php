...
$lang['AUTO_LOGIN'] = 'سجل دخولي تلقائيًا';
$lang['ERROR_LOGIN'] = 'اسم المستخدم أو كلمة المرور التي أدخلتها غير صحيحة.';
$lang['REMEMBER'] = 'تذكر';
...
$lang['INVALID_TOPIC_ID'] = 'الموضوع غير موجود!';
...
$lang['MAX_SMILIES_PER_POST'] = 'تم تجاوز حد الرموز التعبيرية %s.';
...
$lang['NO_SUCH_FOLDER'] = 'المجلد غير موجود';
...
$lang['ADD_RETRACKER'] = 'إضافة إعادة التتبع إلى ملفات التورنت';
...
$lang['BIRTHDAY_TO_LOW'] = 'عذرًا، هذا الموقع لا يقبل المستخدمين الأصغر من %d سنة';
...
$lang['SIGNATURE_DISABLE'] = 'تم تعطيل التوقيع بسبب مخالفة قواعد المنتدى';
$lang['PUBLIC_VIEW_EMAIL'] = 'عرض عنوان البريد الإلكتروني في ملفي الشخصي';

$lang['EMAIL_EXPLAIN'] = 'سيتم إرسال بريد إلكتروني للتحقق من هذا العنوان لإكمال التسجيل';
...
$lang['RESET_AUTOLOGIN_EXPL'] = 'سيؤدي هذا إلى تسجيل خروجك من جميع الأجهزة حيث تم تمكين الدخول التلقائي';
...
$lang['AVATAR_DISABLE'] = 'تم تعطيل رفع الصورة الرمزية بسبب انتهاك <a href="%s"><b>قواعد المنتدى</b></a>';
...
$lang['USERNAME_TOO_LONG'] = 'اسم المستخدم طويل جدًا.';
$lang['USERNAME_TOO_SMALL'] = 'اسم المستخدم قصير جدًا.';
...
$lang['NO_LIKES'] = 'لم يتم التصويت بعد';
...
$lang['GROUP_JOINED'] = 'لقد قدمت طلبًا للانضمام إلى هذه المجموعة بنجاح.<br />سيتم إبلاغك عندما يوافق مشرف المجموعة على عضويتك.';
...
$lang['SHOW_MORE_INFORMATION_FILE'] = 'عرض المزيد من المعلومات حول هذا الملف';
...
$lang['BT_REG_FAIL_SAME_HASH'] = 'تورنت آخر بنفس info_hash تم <a href="%s"><b>تسجيله</b></a> بالفعل';
...
$lang['TOR_STATUS_NOT_SELECT'] = 'لم تقم بتحديد حالة.';
...
$lang['TOR_STATUS_NAME'] = [
    ...
    TOR_NEED_EDIT => 'بحاجة إلى تعديل',
    TOR_NO_DESC => 'غير مكتمل',
    TOR_DUP => 'مكرر',
...
$lang['TOR_STATUS_FAILED'] = 'هذه الحالة غير موجودة!';
...
$lang['CHANGE_TOR_TYPE'] = 'تم تغيير نوع التورنت بنجاح';
...
// tor_comment
$lang['TOR_MOD_TITLE'] = 'تم تغيير حالة التوزيع – %s';
$lang['TOR_MOD_MSG'] = "مرحبًا، %s.\n\nتم تغيير حالة [url=%s]توزيعك[/url] إلى [b]%s[/b]";

$lang['TOR_AUTH_TITLE'] = 'تم طلب تغييرات في التنسيق – %s';
$lang['TOR_AUTH_MSG'] = "مرحبًا، %s.\n\n لقد تغير توزيعك - [url=%s]%s[/url]\n\n يرجى إعادة التحقق منه.";
$lang['TOR_AUTH_FIXED'] = 'ثابت';
$lang['TOR_AUTH_SENT_COMMENT'] = ' &middot; <span class="seed bold">تم إرسال المعلومات إلى المشرف. يرجى انتظار الرد.</span>';
...
$lang['UNSET_GOLD_TORRENT'] = 'إزالة حالة الذهب';
$lang['SET_SILVER_TORRENT'] = 'جعل الفضة';
$lang['UNSET_SILVER_TORRENT'] = 'إزالة حالة الفضة';
$lang['GOLD_STATUS'] = 'تورنت ذهبي! حركة التنزيل غير محسوبة!';
$lang['SILVER_STATUS'] = 'تورنت فضي! حركة التنزيل محسوبة جزئيًا!';
...
$lang['SEL_CHAPTERS'] = 'رابط للأقسام المختارة';
$lang['NOT_SEL_CHAPTERS'] = 'لم تقم بتحديد أي مواضيع';
$lang['SEL_CHAPTERS_HELP'] = 'يمكنك اختيار %s أقسام كحد أقصى';
$lang['HIDE_CONTENTS'] = 'إخفاء محتويات {...}';
$lang['FILTER_BY_NAME'] = '<i>Filter بالاسم </i>';

$lang['BT_ONLY_ACTIVE'] = 'نشط';
$lang['BT_ONLY_MY'] = 'إصداراتي';
$lang['BT_SEED_EXIST'] = 'المزود موجود';
...
$lang['UNSET_DL_STATUS'] = 'ليس جارٍ التنزيل';
...
$lang['RELEASED'] = 'صدر';
$lang['BONUS'] = 'مكافأة';
$lang['IT_WILL_BE_DOWN'] = 'سيتم احتسابها مرة واحدة عند التنزيل';
$lang['SPMODE_FULL'] = 'تظهر أقرانهم في التفاصيل الكاملة';

// Seed Bonus
$lang['MY_BONUS'] = 'مكافآتي (%s نقطة متاحة)';
$lang['BONUS_SELECT'] = 'حدد';
$lang['SEED_BONUS'] = 'مكافأة لزرع البذور';
$lang['EXCHANGE'] = 'تبادل';
$lang['EXCHANGE_BONUS'] = 'تبادل مكافآت المزود';
$lang['BONUS_UPLOAD_DESC'] = '<b>+%s رصيد رفع</b> <br /> استبدل نقاط المكافأة بـ %1$s من حركة الرفع التي تتم إضافتها إلى إجمالي حسابك.';
$lang['BONUS_UPLOAD_PRICE'] = '<b class="%s">%s</b>';
$lang['PRICE'] = 'السعر';
$lang['EXCHANGE_NOT'] = 'التبادل غير متوفر';
$lang['BONUS_SUCCES'] = 'تم إضافة %s إلى حسابك بنجاح';
...
$lang['SHOW_TIME_TOPICS'] = 'عرض وقت إنشاء الموضوع';
$lang['SHOW_CURSOR'] = 'تسليط الضوء على التوالي تحت المؤشر';

$lang['BT_LOW_RATIO_FOR_DL'] = 'نسبتك <b>%s</b> منخفضة جدًا لتحميل التورنتات';
$lang['BT_RATIO_WARNING_MSG'] = 'إذا انخفضت نسبتك إلى أقل من %s، فلن تتمكن من تحميل التورنتات! <a href="%s"><b>المزيد عن النسبة.</b></a>';
...
$lang['ONLY_FOR_ADMIN'] = 'هذا الخيار فقط للمسؤولين';
$lang['ONLY_FOR_SUPER_ADMIN'] = 'هذا الخيار فقط لمشرفي النظام';

$lang['LOGS'] = 'تاريخ الموضوع غير صالح.';
$lang['FORUM_LOGS'] = 'سجل المنتدى';
...
$lang['ERROR_BUILD'] = 'لا يمكن عرض محتوى هذا التورنت (فشل في بناء قائمة الملفات)';
...
$lang['USER_DELETE_ME'] = 'عذرًا، لا يمكن حذف حسابك!';
$lang['USER_DELETE_CSV'] = 'عذرًا، لا يمكن حذف هذا الحساب!';
...
$lang['DELETE_USER_POSTS'] = 'حذف جميع المشاركات باستثناء المشاركة الأولى في كل موضوع';
$lang['DELETE_USER_POSTS_ME'] = 'هل أنت متأكد من أنك تريد حذف جميع مشاركاتي؟.';
$lang['DELETE_USER_POSTS_CONFIRM'] = 'هل أنت متأكد أنك تريد حذف جميع المشاركات باستثناء المشاركة الأولى في كل موضوع؟';
...
$lang['INDIVIDUAL'] = 'يمتلك حقوقًا فردية';
...
$lang['USER_DEACTIVATE_ME'] = 'لا يمكنك تعطيل حسابك الخاص!';
$lang['ACTIVATE_CONFIRM'] = 'هل أنت متأكد أنك تريد تفعيل هذا المستخدم؟';
$lang['USER_ACTIVATE_OFF'] = 'تم تعطيل المستخدم بنجاح.';

// Register
$lang['CHOOSE_A_NAME'] = 'يرجى اختيار اسم مستخدم';
$lang['CHOOSE_E_MAIL'] = 'يجب تقديم عنوان بريد إلكتروني';
$lang['CHOOSE_PASS'] = 'حقل كلمة المرور لا يجب أن يكون فارغًا!';
...
$lang['EMAILER_DISABLED'] = 'عذرًا، هذه الميزة غير متوفرة مؤقتًا';
...
$lang['SCREENSHOTS_RULES'] = 'اقرأ قواعد نشر لقطات الشاشة!';
$lang['AJAX_EDIT_OPEN'] = 'لديك جلسة تعديل سريع مفتوحة بالفعل!';
...
$lang['DEL_LIST_MY_MESSAGE_INFO'] = 'بعد الإزالة، قد تظهر <b>القائمة الكاملة</b> الموضوعات المحذوفة سابقًا حتى يتم تحديثها';
$lang['DEL_LIST_INFO'] = 'لإزالة إدخال من القائمة، انقر على الأيقونة إلى يسار اسم القسم';

// Watched topics
$lang['WATCHED_TOPICS'] = 'شاهد المواضيع.';
$lang['NO_WATCHED_TOPICS'] = 'لا تتابع أية موضوعات';
...
$lang['ACTIONS_LOG'] = 'سجل الإجراءات';
...
$lang['AUTH_POLLCREATE'] = $lang['POLLCREATE'] = 'إنشاء استفتاء';
...
$lang['LOGIN_RESET_TIME_EXPLAIN'] = 'الوقت بالدقائق الذي يجب على المستخدم الانتظار قبل أن يتمكن من تسجيل الدخول مجددًا بعد تجاوز عدد محاولات الدخول المسموح بها.';
...
// Mods
$lang['MAX_NEWS_TITLE'] = 'الحد الأقصى لطول عنوان الأخبار';
...
$lang['TRACKER_STATS'] = 'إحصائيات المتتبع';
$lang['WHOIS_INFO'] = 'معلومات عنوان IP';
$lang['SHOW_MOD_HOME_PAGE'] = 'عرض المشرفين في الصفحة الرئيسية (index.php)';
$lang['SHOW_BOARD_STARTED_INDEX'] = 'عرض تاريخ بدء اللوحة على index.php';
$lang['PREMOD_HELP'] = '<h4><span class="tor-icon tor-dup">&#8719;</span> المراجعة المسبقة</h4> <h6>إذا لم يكن هناك تورنتات بالحالة v أو # أو T في هذا القسم والأقسام الفرعية له، ستحصل التوزيعات الجديدة تلقائيًا على هذه الحالة</h6>';
$lang['TOR_COMMENT'] = '<h4>التعليق على حالة التوزيع</h4> <h6>يتيح التعليق الإشارة إلى الأخطاء في الإصدار. إذا كانت هناك حاجة إلى تصحيح، يتوفر نموذج استجابة للمُحمّل لإصلاح الإصدار</h6>';
$lang['SEED_BONUS_ADD'] = '<h4>قواعد مكافأة التوزيع</h4> <h6>عدد التورنتات التي يقوم المستخدم بتوزيعها ونقاط المكافأة الممنوحة لكل ساعة</h6>';
$lang['SEED_BONUS_RELEASE'] = 'حتى N إصدارات';
$lang['SEED_BONUS_POINTS'] = 'نقاط مكافأة في الساعة';
$lang['SEED_BONUS_TOR_SIZE'] = '<h4>الحد الأدنى لحجم التورنت المؤهل لنقاط المكافأة</h4> <h6>اتركه فارغًا لمنح المكافآت لجميع التورنتات بغض النظر عن الحجم.</h6>';
$lang['SEED_BONUS_USER_REGDATA'] = '<h4>الحد الأدنى لعمر حساب المستخدم المؤهل لنقاط المكافأة</h4> <h6>اتركه فارغًا لمنح المكافآت لجميع المستخدمين بغض النظر عن عمر الحساب.</h6>';
$lang['SEED_BONUS_WARNING'] = 'الاهتمام! البذور المكافآت يجب أن تكون في ترتيب تصاعدي';
$lang['SEED_BONUS_EXCHANGE'] = 'تكوين تبادل نقاط مكافأة التوزيع';
$lang['SEED_BONUS_ROPORTION'] = 'معدل التبادل: نقاط المكافأة إلى جيجابايت من رصيد الرفع';
...
$lang['BT_CHECK_ANNOUNCE_URL_EXPL'] = 'السماح فقط بتسجيل عناوين URL مسموح بها على المتتبع';
...
$lang['QUESTION'] = 'هل أنت متأكد أنك تريد تنفيذ هذا الإجراء؟';
...
$lang['DELETE_JOB'] = 'هل أنت متأكد أنك تريد حذف مهمة الكرون هذه؟';
...
$lang['NOSELECT'] = 'غير محدد';
$lang['RUN_DAY'] = 'تشغيل اليوم';
$lang['RUN_DAY_EXPL'] = 'اليوم الذي يتم فيه تشغيل هذه المهمة';
$lang['RUN_TIME'] = 'وقت التشغيل';
$lang['RUN_TIME_EXPL'] = 'الوقت الذي تُشغّل فيه هذه المهمة (مثلاً 05:00:00)';
...
$lang['LOG_FILE_EXPL'] = 'الملف لحفظ السجل إليه';
...
$lang['SCRIPT_DUPLICATE'] = 'مهمة كرون باستخدام هذا السكريبت موجودة بالفعل';
$lang['TITLE_DUPLICATE'] = 'مهمة كرون بعنوان هذا الاسم موجودة بالفعل';
...
$lang['START_OPTION_CONTINUE'] = 'استمر من حيث توقفت آخر مرة';
...
$lang['INFO_PROCESSING_ABORTED_SOON'] = 'يرجى الانتظار بضع دقائق قبل المتابعة...';
...
$lang['CALLSEED'] = 'استدعاء المزودين';
$lang['CALLSEED_EXPLAIN'] = 'إبلاغ المزودين بطلب لاستئناف التوزيع لهذا الإصدار';
$lang['CALLSEED_SUBJECT'] = 'مساعدة في التوزيع مطلوبة: %s';
$lang['CALLSEED_TEXT'] = 'مرحبًا![br]مساعدتك مطلوبة للإصدار [url=%s]%s[/url][br]إذا أردت المساعدة ولكنك حذفت ملف التورنت، يمكنك تنزيله من [url=%s]هنا[/url][br][br]سيقُدّر مساعدتك كثيرًا!';
$lang['CALLSEED_MSG_OK'] = 'تم إرسال الطلب إلى جميع من قاموا بتنزيل هذا الإصدار';
$lang['CALLSEED_MSG_SPAM'] = 'تم إرسال طلب مؤخرًا (ربما ليس منك).<br /><br />يمكن إرسال الطلب التالي في <b>%s</b>.';
...
$lang['LOG_ACTION']['LOG_TYPE'] = [
    ...
    'adm_user_ban' => 'المستخدم:<br /> <b>محظور</b>',
    'adm_user_unban' => 'المستخدم:<br /> <b>تم رفع الحظر عنه</b>',
];
...
$lang['SEARCH_FOR_RANK'] = 'جارٍ البحث عن مستخدمين بالرتبة %s';
...
$lang['SEARCH_USERS_LASTVISITED'] = 'المستخدمون الذين زاروا';
$lang['IN_THE_LAST'] = 'في الماضي';
$lang['AFTER_THE_LAST'] = 'بعد آخر';
$lang['BEFORE'] = 'قبل';
$lang['AFTER'] = 'بعد';
$lang['SEARCH_USERS_JOINED_EXPLAIN'] = 'ابحث عن المستخدمين الذين انضموا قبل أو بعد تاريخ محدد. تنسيق التاريخ هو YYYY/MM/DD.';
$lang['SEARCH_USERS_GROUPS_EXPLAIN'] = 'عرض كافة أعضاء المجموعة المحددة.';
$lang['SEARCH_USERS_RANKS_EXPLAIN'] = 'عرض جميع المستخدمين بالرتبة المختارة.';
...
$lang['MC_COMMENT_PM_MSG'] = "مرحبًا، [b]%s[/b]\nلقد ترك المشرف تعليقًا على مشاركتك [url=%s][b]%s[/b][/url][quote]\n%s\n[/quote]";
$lang['MC_COMMENT'] = [
    0 => [
        'title' => '',
        'type' => 'حذف التعليق',
...
$lang['TWO_FACTOR_VERIFICATION'] = 'التحقق بخطوتين';
$lang['TWO_FACTOR_SECURITY'] = 'الأمان';
$lang['TWO_FACTOR_AUTH_EXPLAIN'] = 'أضف طبقة أمان إضافية إلى حسابك باستخدام تطبيق مصادقة TOTP';
$lang['TWO_FACTOR_ENABLE'] = 'تفعيل التحقق بخطوتين';
$lang['TWO_FACTOR_DISABLE'] = 'تعطيل التحقق بخطوتين';
$lang['TWO_FACTOR_ENABLED'] = 'تمكين';
$lang['TWO_FACTOR_DISABLED'] = 'تعطيل';
$lang['TWO_FACTOR_SETUP'] = 'إعداد التحقق بخطوتين';
$lang['TWO_FACTOR_SETUP_EXPLAIN'] = 'امسح رمز الاستجابة السريعة هذا باستخدام تطبيق المصادقة (Google Authenticator، Authy، إلخ) أو أدخل المفتاح يدويًا أدناه.';
$lang['TWO_FACTOR_MANUAL_ENTRY'] = 'أو أدخل هذا المفتاح يدويًا';
$lang['TWO_FACTOR_ENTER_CODE'] = 'أدخل الرمز المكون من 6 أرقام من تطبيق المصادقة الخاص بك';
$lang['TWO_FACTOR_CODE'] = 'رمز المصادقة';
$lang['TWO_FACTOR_VERIFY'] = 'تحقق';
$lang['TWO_FACTOR_VERIFY_AND_ENABLE'] = 'تحقق وفعل';
$lang['TWO_FACTOR_INVALID_CODE'] = 'رمز غير صالح. يرجى المحاولة مرة أخرى.';
$lang['TWO_FACTOR_SESSION_EXPIRED'] = 'انتهت صلاحية جلسة التحقق. يرجى تسجيل الدخول مرة أخرى.';
$lang['TWO_FACTOR_SETUP_EXPIRED'] = 'انتهت صلاحية جلسة الإعداد. يرجى المحاولة مرة أخرى.';
$lang['TWO_FACTOR_ALREADY_ENABLED'] = 'التحقق بخطوتين مفعل بالفعل على حسابك.';
$lang['TWO_FACTOR_NOT_ENABLED'] = 'التحقق بخطوتين غير مفعل على حسابك.';
$lang['TWO_FACTOR_FEATURE_DISABLED'] = 'التحقق بخطوتين غير متوفر';
$lang['TWO_FACTOR_ENABLED_SUCCESS'] = 'تم تفعيل التحقق بخطوتين';
$lang['TWO_FACTOR_DISABLED_SUCCESS'] = 'تم تعطيل التحقق بخطوتين';
$lang['TWO_FACTOR_RECOVERY_CODES'] = 'رموز الاسترداد';
$lang['TWO_FACTOR_RECOVERY_WARNING'] = 'احفظ هذه الرموز في مكان آمن. إذا فقدت جهاز المصادقة، يمكنك استخدام هذه الرموز لتسجيل الدخول.';
$lang['TWO_FACTOR_RECOVERY_EXPLAIN'] = 'يمكن استخدام كل رمز مرة واحدة فقط. خزّنها منفصلة عن جهازك.';
$lang['TWO_FACTOR_RECOVERY_CODE'] = 'رمز الاسترداد';
$lang['TWO_FACTOR_ENTER_RECOVERY'] = 'أدخل أحد رموز الاسترداد الخاصة بك';
$lang['TWO_FACTOR_USE_RECOVERY'] = 'استخدم رمز استرداد بدلاً من ذلك';
$lang['TWO_FACTOR_USE_TOTP'] = 'استخدم رمز المصادقة بدلاً من ذلك';
$lang['TWO_FACTOR_INVALID_RECOVERY'] = 'رمز الاسترداد غير صالح. يرجى المحاولة مرة أخرى.';
$lang['TWO_FACTOR_RECOVERY_CODE_USED'] = 'تم استخدام رمز الاسترداد. لديك {0, plural, zero {لا رموز متبقية} one {رمز واحد متبقٍ} two {رمزان متبقيان} few {# رموز متبقية} many {# رمز متبقٍ} other {# رمز متبقٍ}}.';
$lang['TWO_FACTOR_REMAINING_CODES'] = 'لديك {0, plural, zero {لا رموز استرداد متبقية} one {رمز استرداد واحد متبقٍ} two {رمزا استرداد متبقيان} few {# رموز استرداد متبقية} many {# رمز استرداد متبقٍ} other {# رمز استرداد متبقٍ}}';
$lang['TWO_FACTOR_DOWNLOAD_CODES'] = 'تحميل كملف نصي';
$lang['TWO_FACTOR_RECOVERY_EXPIRED'] = 'انتهت صلاحية عرض رموز الاسترداد. رموزك لا تزال فعالة.';
$lang['TWO_FACTOR_DOWNLOAD_EXPIRED'] = 'انتهت صلاحية رابط التحميل.';
$lang['TWO_FACTOR_DISABLE_WARNING'] = 'سيؤدي هذا إلى تعطيل التحقق بخطوتين على حسابك. ستحتاج إلى إدخال رمز المصادقة الحالي لتأكيد العملية.';
$lang['TWO_FACTOR_DISABLE_CONFIRM'] = 'تعطيل التحقق بخطوتين';
$lang['TWO_FACTOR_REGENERATE'] = 'إعادة إنشاء رموز الاسترداد';
$lang['TWO_FACTOR_REGENERATE_WARNING'] = 'سيؤدي هذا إلى إبطال جميع رموز الاسترداد الحالية وإنشاء رموز جديدة.';
$lang['TWO_FACTOR_REGENERATE_CONFIRM'] = 'إعادة إنشاء الرموز';
$lang['TWO_FACTOR_ADMIN_DISABLE'] = 'تعطيل التحقق بخطوتين للمستخدم';
$lang['TWO_FACTOR_ADMIN_DISABLE_CONFIRM'] = 'هل أنت متأكد من أنك تريد تعطيل التحقق بخطوتين لهذا المستخدم؟';
$lang['TWO_FACTOR_TOO_MANY_ATTEMPTS'] = 'عدد كبير جدًا من المحاولات الفاشلة. يرجى المحاولة مرة أخرى بعد {0, plural, zero {0 دقيقة} one {دقيقة واحدة} two {دقيقتين} few {# دقائق} many {# دقيقة} other {# دقيقة}}.';
$lang['TWO_FACTOR_INVALID_TOKEN'] = 'رمز مميز غير صالح أو منتهي الصلاحية.';
$lang['TWO_FACTOR_DONE'] = 'تم';
$lang['TWO_FACTOR_RECOVERY_ONETIME'] = 'يمكن عرض هذه الصفحة مرة واحدة فقط. إذا غادرت، لن تتمكن من رؤية هذه الرموز مرة أخرى.';
$lang['TWO_FACTOR_ADMIN_DISABLE_SELF'] = 'لا يمكنك تعطيل التحقق بخطوتين الخاص بك من لوحة الإدارة. استخدم إعدادات ملفك الشخصي بدلاً من ذلك.';
