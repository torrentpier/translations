...
$lang['TWO_FACTOR_VERIFICATION'] = 'אימות דו-שלבי';
$lang['TWO_FACTOR_SECURITY'] = 'אבטחה';
$lang['TWO_FACTOR_AUTH_EXPLAIN'] = 'הוסף שכבת אבטחה נוספת לחשבונך באמצעות אפליקציית Authenticator מבוססת TOTP';
$lang['TWO_FACTOR_ENABLE'] = 'הפעל אימות דו-שלבי';
$lang['TWO_FACTOR_DISABLE'] = 'השבת אימות דו-שלבי';
$lang['TWO_FACTOR_ENABLED'] = 'זמין';
$lang['TWO_FACTOR_DISABLED'] = 'מנוטר';
$lang['TWO_FACTOR_SETUP'] = 'הגדר אימות דו-שלבי';
$lang['TWO_FACTOR_SETUP_EXPLAIN'] = 'סרוק את קוד ה-QR הזה עם אפליקציית ה-Authenticator שלך (Google Authenticator, Authy, וכו׳) או הזן את המפתח ידנית למטה.';
$lang['TWO_FACTOR_MANUAL_ENTRY'] = 'או הזן מפתח זה ידנית';
$lang['TWO_FACTOR_ENTER_CODE'] = 'הזן את קוד 6 הספרות מאפליקציית ה-Authenticator שלך';
$lang['TWO_FACTOR_CODE'] = 'קוד אימות';
$lang['TWO_FACTOR_VERIFY'] = 'אמת';
$lang['TWO_FACTOR_VERIFY_AND_ENABLE'] = 'אמת והפעל';
$lang['TWO_FACTOR_INVALID_CODE'] = 'קוד לא תקין. אנא נסה שוב.';
$lang['TWO_FACTOR_SESSION_EXPIRED'] = 'פג תוקף סשן האימות. אנא התחבר מחדש.';
$lang['TWO_FACTOR_SETUP_EXPIRED'] = 'פג תוקף סשן ההגדרות. אנא נסה שוב.';
$lang['TWO_FACTOR_ALREADY_ENABLED'] = 'אימות דו-שלבי כבר מופעל בחשבונך.';
$lang['TWO_FACTOR_NOT_ENABLED'] = 'אימות דו-שלבי אינו מופעל בחשבונך.';
$lang['TWO_FACTOR_FEATURE_DISABLED'] = 'אימות דו-שלבי אינו זמין';
$lang['TWO_FACTOR_ENABLED_SUCCESS'] = 'אימות דו-שלבי הופעל בהצלחה';
$lang['TWO_FACTOR_DISABLED_SUCCESS'] = 'אימות דו-שלבי הושבת בהצלחה';
$lang['TWO_FACTOR_RECOVERY_CODES'] = 'קודי שחזור';
$lang['TWO_FACTOR_RECOVERY_WARNING'] = 'שמור את קודי השחזור במקום בטוח. אם תאבד את מכשיר האימות שלך, תוכל להשתמש בקודים אלו להיכנס.';
$lang['TWO_FACTOR_RECOVERY_EXPLAIN'] = 'כל קוד ניתן לשימוש פעם אחת בלבד. אחסן אותם בנפרד מהמכשיר שלך.';
$lang['TWO_FACTOR_RECOVERY_CODE'] = 'קוד שחזור';
$lang['TWO_FACTOR_ENTER_RECOVERY'] = 'הזן אחד מקודי השחזור שלך';
$lang['TWO_FACTOR_USE_RECOVERY'] = 'השתמש במקום זאת בקוד שחזור';
$lang['TWO_FACTOR_USE_TOTP'] = 'השתמש במקום זאת בקוד מאפליקציית Authenticator';
$lang['TWO_FACTOR_INVALID_RECOVERY'] = 'קוד שחזור לא תקין. אנא נסה שוב.';
$lang['TWO_FACTOR_RECOVERY_CODE_USED'] = 'קוד השחזור שומש. נותרו לך %d קודים.';
$lang['TWO_FACTOR_REMAINING_CODES'] = 'נותרו לך %d קודי שחזור';
$lang['TWO_FACTOR_DOWNLOAD_CODES'] = 'הורד כקובץ טקסט';
$lang['TWO_FACTOR_RECOVERY_EXPIRED'] = 'תצוגת קודי השחזור פגה. הקודים שלך עדיין פעילים.';
$lang['TWO_FACTOR_DOWNLOAD_EXPIRED'] = 'קישור ההורדה פג תוקף.';
$lang['TWO_FACTOR_DISABLE_WARNING'] = 'פעולה זו תשבית את האימות הדו-שלבי בחשבונך. תצטרך להזין את קוד האימות הנוכחי כדי לאשר.';
$lang['TWO_FACTOR_DISABLE_CONFIRM'] = 'השבת אימות דו-שלבי';
$lang['TWO_FACTOR_REGENERATE'] = 'חדש קודי שחזור';
$lang['TWO_FACTOR_REGENERATE_WARNING'] = 'פעולה זו תבטל את כל קודי השחזור הקיימים ותיצור חדשים.';
$lang['TWO_FACTOR_REGENERATE_CONFIRM'] = 'חדש קודים';
$lang['TWO_FACTOR_ADMIN_DISABLE'] = 'השבת אימות דו-שלבי למשתמש';
$lang['TWO_FACTOR_ADMIN_DISABLE_CONFIRM'] = 'האם אתה בטוח שברצונך להשבית את האימות הדו-שלבי למשתמש זה?';
$lang['TWO_FACTOR_TOO_MANY_ATTEMPTS'] = 'יותר מדי ניסיונות כושלים. אנא נסה שוב בעוד %d דקות.';
$lang['TWO_FACTOR_INVALID_TOKEN'] = 'אסימון לא תקין או שפג תוקפו.';
$lang['TWO_FACTOR_DONE'] = 'בוצע';
$lang['TWO_FACTOR_RECOVERY_ONETIME'] = 'דף זה ניתן לצפייה רק פעם אחת. אם תעזוב, לא תוכל לראות את הקודים האלה שוב.';
$lang['TWO_FACTOR_ADMIN_DISABLE_SELF'] = 'אי אפשר להשבית את האימות הדו-שלבי שלך דרך לוח הניהול. השתמש בהגדרות הפרופיל שלך במקום זאת.';
