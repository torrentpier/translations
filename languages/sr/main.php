...
$lang['NOTIFICATION_SUBJECT'] = 'Нова приватна порука је примљена!';
...
$lang['NOBIRTHDAY_WEEK'] = 'Корисници немају рођендан у наредних неколико дана %d'; // %d is substituted with the number of days
...
$lang['EMAIL_BANNED'] = 'Жао ми је, али адреса <b>%s</b> је забрањена.';
...
$lang['ATTACH_QUOTA_REACHED'] = 'Жао ми је, али максимална величина за све прикључке достигнута. Молимо вас, контактирајте администратора ако имате питања.';
...
// Errors -> PM Related
$lang['ATTACH_QUOTA_SENDER_PM_REACHED'] = 'Жао ми је, али максимална величина за све прикључке у вашем Поштанском сандучету достигнута. Молимо вас, избришите неке од ваших примљених/посланих прикључака.';
$lang['ATTACH_QUOTA_RECEIVER_PM_REACHED'] = 'Жао ми је, али максимална величина за све прикључке у Поштанском сандучету корисника \'%s\' достигнута. Молимо вас, обавестите га/је, или сачекајте док не избрише неке од својих прикључака.';
...
$lang['ATTACHBOX_LIMIT'] = 'Ваш Attachbox је<br /><b>%d%%</b> пун';
...
$lang['BT_FLIST_ANNOUNCERS_LIST'] = 'Списак оглашивача';
$lang['BT_FLIST_ANNOUNCERS'] = 'Оглашивачи';
$lang['BT_FLIST_ANNOUNCERS_NOTICE'] = 'Овај списак садржи оглашиваче торрент фајла';
...
$lang['UNSET_SILVER_TORRENT'] = 'Промените сребро';
...
$lang['JAVASCRIPT_ON_REGISTER'] = 'Да бисте се регистровали, морате да омогућите JavaScript';
...
$lang['ACRONYM'] = 'Анатомска';
$lang['ACRONYM_TITLE'] = 'Анатомска: [acronym=Пун текст]Кратак текст[/acronym]';
...
$lang['CONFLICT_WARNING'] = 'Упозорење о сукобу ауторизације';
...
$lang['UNBAN_USERNAME'] = 'Деактивирајте једног или више одређених корисника';
...
$lang['FORUM_ADMIN_EXPLAIN'] = 'Са ове панеле можете додавати, брисати, мењати, преуређивати и ресинхронизовати категорије и форуме';
...
// Attachments -> Sync
$lang['SYNC_THUMBNAIL_RESETTED'] = 'Преглед је ресетован за прикључену датотеку: %s'; // replace %s with physical Filename
...
$lang['TOTAL_FILESIZE'] = 'Укупна величина датотеке';
...
$lang['TIME_LIMIT_EXPLAIN_SAFE'] = '<i>Ваш PHP (безбедан режим) има истек времена подешен на %s секунди, па остајте испод ове вредности</i>';
...
$lang['LOG_ACTION']['LOG_TYPE'] = [
    ...
    'mod_topic_poll_started' => 'Тема:<br /> <b>анке је почео</b>',
