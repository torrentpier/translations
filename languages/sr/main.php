...
$lang['FORUM_INDEX'] = '%s Индекс Форума'; // e.g. sitename Forum Index, %s can be removed if you prefer
...
$lang['CLICK_RETURN_GROUP'] = 'Кликните %sHere%s за повратак на информације о групи.';
...
$lang['SEARCH_UNANSWERED'] = 'Неодговорене поруке.';
...
$lang['AUTO_LOGIN'] = 'Аутоматски ме пријави';
$lang['ERROR_LOGIN'] = 'Корисничко име које сте поднели је погрешно или неважеће, или је лозинка неважећа.';
...
// Viewtopic
$lang['VIEW_TOPIC'] = 'Погледај тему';

$lang['GUEST'] = 'Гост';
$lang['POST_SUBJECT'] = 'Наслов поста';
...
$lang['DELETE_POST'] = 'Обриши овај пост.';
...
$lang['INVALID_TOPIC_ID'] = 'Тема недостаје!';
$lang['INVALID_TOPIC_ID_DB'] = 'Теме не постоји у бази података!';

$lang['NOT_POST'] = 'Порука о одсуству';
...
$lang['MAX_SMILIES_PER_POST'] = 'Лимит смајлија од %s је прекорачен.';
...
$lang['POLL_DELETE'] = 'Ваша анкета је успешно уклоњена.';
...
$lang['ADD_RETRACKER'] = 'Додајте ретрекер у торрент датотеке';
...
$lang['SIGNATURE_DISABLE'] = 'Затворен за кршење правила форума.';
$lang['PUBLIC_VIEW_EMAIL'] = 'Прикажите адресу е-поште у мом профилу.';

$lang['EMAIL_EXPLAIN'] = 'На ову адресу ће вам бити послато довршите регистрацију.';
...
$lang['RESET_AUTOLOGIN_EXPL'] = 'укључујући сва места која сте посетили где је форум омогућује аутоматску пријаву.';
...
$lang['AVATAR_DISABLE'] = 'Опција контроле аватара је онемогућена због кршења <a href="%s"><b>правила форума</b></a>.';
...
$lang['USERNAME_TOO_SMALL'] = 'Ваше име је превише кратко.';
...
$lang['REGISTRATION'] = 'Услови регистрационог споразума.';
...
$lang['NO_LIKES'] = 'Нико није дао глас до сада';
...
$lang['GROUP_JOINED'] = 'Успешно сте се пријавили на ову групу.<br />Бићете обавештени када ваша претплата буде одобрена од стране модератора групе.';
$lang['GROUP_REQUEST'] = 'Захтев за придруживање вашој групи је поднет.';
...
$lang['SEARCH_QUERY'] = 'Запит за претрагу.';
...
$lang['NO_SEARCHABLE_FORUMS'] = 'Немате права да тражите било који форум на овом сајту.';
...
$lang['EXTENSION_DISABLED_AFTER_POSTING'] = 'Додаци \'%s\' су деактивирани од стране администраторa, па овај прилог није приказан.'; // used in Posts and PM's, replace %s with mime type
...
$lang['SHOW_MORE_INFORMATION_FILE'] = 'Прикажи више информација о фајлу';
...
$lang['ATTACHMENT_THUMBNAIL'] = 'Скица прилога.';
...
$lang['DELETE_THUMBNAIL'] = 'Обриши скицу.';
$lang['UPLOAD_NEW_VERSION'] = 'Поставите нову верзију.';

// Errors -> Posting Attachments
$lang['INVALID_FILENAME'] = '%s је неважеће име.'; // replace %s with given filename
$lang['ATTACHMENT_PHP_SIZE_NA'] = 'Прилог је превелик.';
$lang['ATTACHMENT_PHP_SIZE_OVERRUN'] = 'Прилог је превелик.<br />Максимална величина отпремања: %d МБ.<br />Имајте на уму да је ова величина дефинисана у php.ini, што значи да је подешена од стране PHP-а и Attachment Mod не може да је промени.'; // replace %d with ini_get('upload_max_filesize')
...
$lang['ATTACHMENT_TOO_BIG'] = 'Прилог сувише велики.<br />Величина: %s'; // replace %d with maximum file size, %s with size var
$lang['TOO_MANY_ATTACHMENTS'] = 'Не може се додати прилог, зашто је максималан број %d додатака у овом посту достигнут.'; // replace %d with maximum number of attachments
$lang['ERROR_IMAGESIZE'] = 'Прилог/слике морају бити мањи од %d пиксела у ширини и %d пиксела у висини.';
...
$lang['ERROR_MISSING_OLD_ENTRY'] = 'Не могу да обновим приложак, не могу да пронађем стару ставку.';
...
// Delete Attachments
$lang['DELETED_ATTACHMENTS'] = 'Неки прикладне су избрисани.';
$lang['ERROR_DELETED_ATTACHMENTS'] = 'Није било могуће обрисати прилоге.';

// General Error Messages
$lang['ATTACHMENT_FEATURE_DISABLED'] = 'Функција прилога је онемогућена.';
...
$lang['DIRECTORY_NOT_WRITEABLE'] = 'Директоријум \'%s\' није доступан за упис. Мораћете да креирате пут за учитавање и промените права на 777 (или промените власника на ваш хттпд сервер) да бисте пренели датотеке.<br />Ако имате само основни ФТП приступ промените \'Атрибут\' директоријума на rwxrwxrwx.'; // replace %s with directory
...
$lang['MB'] = 'МБ';
$lang['GB'] = 'ГБ';
$lang['ATTACH_SEARCH_QUERY'] = 'Тражите прилоге.';
$lang['TEST_SETTINGS'] = 'Тестирање поставки.';
$lang['NOT_ASSIGNED'] = 'Није именован.';
...
$lang['BT_REG_FAIL_SAME_HASH'] = 'Други торент са истим info_hash-ом је већ <a href="%s"><b>регистрован</b></a>';
...
$lang['TOR_STATUS_NAME'] = [
    ...
    TOR_NEED_EDIT => 'није формализовано до',
    TOR_NO_DESC => 'није формализовано',
    TOR_DUP => 'дупликат',
...
$lang['TOR_STATUS_FAILED'] = 'This translation does not follow the correct grammatical structure and terminology in Serbian (Cyrillic).';
...
$lang['CHANGE_TOR_TYPE'] = 'Тип торента је успешно промењен.';
...
// tor_comment
$lang['TOR_MOD_TITLE'] = 'Промена статуса дистрибуције - %s.';
$lang['TOR_MOD_MSG'] = "Здраво, %s.\n\nСтатус [url=%s]вашег[/url] дистрибуције је промењен у [b]%s[/b]";

$lang['TOR_AUTH_TITLE'] = 'Промена у дизајн - %s.';
$lang['TOR_AUTH_MSG'] = "Здраво, %s.\n\nВаша дистрибуција је промењена - [url=%s]%s[/url]\n\nМолимо проверавајте поново.";
$lang['TOR_AUTH_FIXED'] = 'фиксно.';
$lang['TOR_AUTH_SENT_COMMENT'] = 'Информација је послата модератору. Чекајте.';
...
$lang['UNSET_GOLD_TORRENT'] = 'Улога златне торренте';
$lang['SET_SILVER_TORRENT'] = 'Поставити сребро.';
$lang['UNSET_SILVER_TORRENT'] = 'Улога сребрне торренте';
$lang['GOLD_STATUS'] = 'ЗЛАТНИ ТОРЕНТ! Саобраћај приликом преузимања се не рачуна!';
$lang['SILVER_STATUS'] = 'СРЕБРНИ ТОРЕНТ! ДОВНЛОАД САОБРАЋАЈ ДЕЛИМИЧНО СЕ БАВИ!';
...
$lang['SEL_CHAPTERS_HELP'] = 'Можете изабрати највише %s одељака';
...
$lang['CUR_DOWNLOADS'] = 'Текућа преузимања.';
...
$lang['ALLOWED_ONLY_1ST_POST_REG'] = 'Регистрација бујица само из првог поста.';
...
$lang['ONLY_1_TOR_PER_TOPIC'] = 'Можете регистровати само један торрент у једној теми.';
...
$lang['IT_WILL_BE_DOWN'] = 'Сматраће се након што буде преузето.';
$lang['SPMODE_FULL'] = 'Прикажи вршњаке у свим детаљима.';

// Seed Bonus
$lang['MY_BONUS'] = 'Мој бонус (%s бонуса на располагању).';
$lang['BONUS_SELECT'] = 'Изаберите';
$lang['SEED_BONUS'] = 'Бонус семена.';
$lang['EXCHANGE'] = 'Размена.';
$lang['EXCHANGE_BONUS'] = 'Размена семена бонуса.';
$lang['BONUS_UPLOAD_DESC'] = '<b>%s на дистрибуцију</b> <br /> За размену бонус поена за %1$s промет који ће бити додат вашем укупном износу дистрибуције.';
$lang['BONUS_UPLOAD_PRICE'] = '<b class="%s">%s</b>';
$lang['PRICE'] = 'Цена';
$lang['EXCHANGE_NOT'] = 'Размена није доступна.';
$lang['BONUS_SUCCES'] = 'За вас је то успешно пријављено %s.';
...
$lang['SHOW_TIME_TOPICS'] = 'Показују време стварања теме.';
$lang['SHOW_CURSOR'] = 'Изааберите линију испод курсора.';

$lang['BT_LOW_RATIO_FOR_DL'] = "Са коефицијентом <b>%s</b> не можете да преузмете торент.";
$lang['BT_RATIO_WARNING_MSG'] = 'Ако ваш коефицијент падне испод %s, нећете моћи да преузмете бујицу! <a href="%s"><b>Више о ранг листи.</b></a>.';
...
$lang['ERROR_BUILD'] = 'Садржај ове торрент датотеке не можете видети на сајту (није могуће направити списак фајлова)';
$lang['TORFILE_INVALID'] = 'Торрент датотека је оштећена';

// Profile
$lang['WEBSITE_ERROR'] = '"Сајт" може садржати само http://sitename';
$lang['INVALID_DATE'] = 'Погрешан датум';
...
$lang['BAN_USER'] = 'Да бисте забранили кориснику';
...
$lang['USER_DELETE_ME'] = 'Нажалост, ваш налог забрањен за брисање!';
$lang['USER_DELETE_CSV'] = 'Нажалост, овај налог није дозвољен за брисање!';
...
$lang['DELETE_USER_POSTS'] = 'Обриши све поруке, осим првих постова';
$lang['DELETE_USER_POSTS_ME'] = 'Да ли сте сигурни да желите да уклоните све моје поруке?';
$lang['DELETE_USER_POSTS_CONFIRM'] = 'Да ли сте сигурни да желите да обришете све поруке, осим првих постова?';
...
$lang['USER_DEACTIVATE_ME'] = 'Не можете да деактивирате свој налог!';
$lang['ACTIVATE_CONFIRM'] = 'Да ли сте сигурни да желите да онемогућите овог корисника?';
...
$lang['SCREENSHOTS_RULES'] = 'Прочитајте правила у слици!';
$lang['AJAX_EDIT_OPEN'] = 'Да ли сте већ отворили једну брзу измену?';
...
$lang['DL_PERCENT'] = 'Комплетан проценат';
$lang['DL_UL'] = 'Ст';
$lang['DL_DL'] = 'Дл';
...
$lang['DEL_LIST_MY_MESSAGE_INFO'] = 'Након уклањања до ажурирања <b>целог списка</b>, могу се већ приказивати обрисане теме.';
$lang['DEL_LIST_INFO'] = 'Да бисте уклонили налог са листе, кликните на икону лево од имена било којег дела.';

// Watched topics
$lang['WATCHED_TOPICS'] = 'Гледане теме';
$lang['NO_WATCHED_TOPICS'] = 'Не посматрајте ниједну тему';
...
$lang['AUTH_SELF_ERROR'] = 'Не можете да промените себе из администратора у корисника';
...
$lang['BAN_USERNAME_EXPLAIN'] = 'Можете забранити више корисника у једном тренутку, користећи одговарајућу комбинацију миша и тастатуре вашег рачунара и прегледача.';
...
$lang['SMILIES_PATH_EXPLAIN'] = 'Пут под вашим TorrentPier главним директоријумом, нпр. стилови/slike/nasmejani';
...
$lang['NO_GROUP_MODE'] = 'Морате да наведете режим за ову групу, отворен или затворен.';
...
$lang['LOGIN_RESET_TIME_EXPLAIN'] = 'Време у минутима које корисник мора да чека пре него што буде поново дозвољен пријава након што је прекорачио број дозвољених покушаја пријављивања.';
...
$lang['TRACKER_STATS'] = 'Статистика о хттп тракеру';
$lang['WHOIS_INFO'] = 'Информација о ИП адреси';
$lang['SHOW_MOD_HOME_PAGE'] = 'Приказати модераторима index.php';
$lang['SHOW_BOARD_STARTED_INDEX'] = 'Прикажи датум почетка форума на index.php';
$lang['PREMOD_HELP'] = '<h4><span class="tor-icon tor-dup">&#8719;</span> Унапред модерација</h4> <h6>Ако немате дистрибуције статуса, # или T у овом одељку, укључујући одељке, онда дистрибуција аутоматски добија овај статус</h6>';
...
$lang['SEED_BONUS_ADD'] = '<h4>Додавање семенских бонуса</h4> <h6>Број дистрибуција које користи корисник и величину бонуса за њих (пута пуњење сат)</h6>';
$lang['SEED_BONUS_RELEASE'] = 'на N-број издања';
$lang['SEED_BONUS_POINTS'] = 'бонуса на сат';
$lang['SEED_BONUS_TOR_SIZE'] = '<h4>Минимална дистрибуција за коју ће бити додељени бонуси</h4> <h6> ако желите да израчунате бонусе за све дистрибуције, оставите празно.</h6>';
$lang['SEED_BONUS_USER_REGDATA'] = '<h4>Минимална дужина корисника тракера, након којег ће бити додељени бонуси</h4> <h6>Ако желите да припишете бонусе свим корисницима, оставите ово поље празно.</h6>';
$lang['SEED_BONUS_WARNING'] = 'Пажња! Семе појачања морају бити у растућем редоследу';
$lang['SEED_BONUS_EXCHANGE'] = 'Подешавање Замену Бонуса за мреже';
$lang['SEED_BONUS_ROPORTION'] = 'Пропорција додатак за размену бонуса на ГБ';

// Modules, this replaces the keys used
$lang['CONTROL_PANEL'] = 'Контролни Панел';
$lang['EXTENSION_CONTROL'] = 'Контрола Ширења';
$lang['EXTENSION_GROUP_MANAGE'] = 'Контрола група проширења';
...
$lang['ATTACH_FILESIZE_SETTINGS'] = 'Подешавања величине прикључене датотеке';
$lang['ATTACH_NUMBER_SETTINGS'] = 'Параметри број прилога';
$lang['ATTACH_OPTIONS_SETTINGS'] = 'Опције за прилог';

$lang['UPLOAD_DIRECTORY'] = 'Уплоад Директоријум';
$lang['UPLOAD_DIRECTORY_EXPLAIN'] = 'Унесите релативну путању из ваше инсталације TorrentPier до директорија за учитане прилоге.';
$lang['ATTACH_IMG_PATH'] = 'Икона Прилоге Објаве';
$lang['ATTACH_IMG_PATH_EXPLAIN'] = 'Ова слика се приказује поред прилога појединих објава.';
$lang['ATTACH_TOPIC_ICON'] = 'Икона теме прилога';
$lang['ATTACH_TOPIC_ICON_EXPLAIN'] = 'Ова слика се приказује пре тема са прилозима.';
$lang['ATTACH_DISPLAY_ORDER'] = 'Редослед прикакаzaња';
$lang['ATTACH_DISPLAY_ORDER_EXPLAIN'] = 'Овде можете да изаберете да ли желите да прикажете прилоге у порукама/ПМС у опадајућем редоследу времена (нови прилог први) или у растућем редоследу времена (најстарији прилог први).';

$lang['MAX_FILESIZE_ATTACH'] = 'Величина датотеке';
$lang['MAX_FILESIZE_ATTACH_EXPLAIN'] = 'Максимална величина датотека за прилоге. Вредност 0 значи \'неограничено\'. Ова подешавања ограничена су конфигурацијом вашег сервера. На пример, ако ваша ПХП конфигурација дозвољава само максимално 2 МБ за учитавање, то не може бити замењено модификацијом.';
$lang['MAX_FILESIZE_PM'] = 'Максимална величина датотека у фолдеру личних порука.';
$lang['MAX_FILESIZE_PM_EXPLAIN'] = 'Максимални простор на диску прикључци могу да користе у сваком фолдеру за личне поруке корисника. Вредност 0 значи \'неограничено\'.';

$lang['MAX_ATTACHMENTS'] = 'Максималан број прилога.';
$lang['MAX_ATTACHMENTS_EXPLAIN'] = 'Максималан број прилога у једном посту.';
$lang['MAX_ATTACHMENTS_PM'] = 'Максималан број прилога у једној приватној поруци.';
$lang['MAX_ATTACHMENTS_PM_EXPLAIN'] = 'Одредите максималан број прилога које корисник може укључити у приватну поруку.';

$lang['DISABLE_MOD'] = 'Искључите модификацију прилога.';
$lang['DISABLE_MOD_EXPLAIN'] = 'Ова опција је углавном за тестирање нових шаблона или тема, и онемогућава све функције везане за прилоге осим администраторског панела.';
...
$lang['MANAGE_EXTENSIONS_EXPLAIN'] = 'Овде можете управљати својим екстензијама. Ако желите да омогућите или онемогућите додавање екстензије, молимо вас да користите управљање групама екстензија.';
$lang['EXPLANATION'] = 'Објашњење';
$lang['EXTENSION_GROUP'] = 'Група екстензија';
$lang['EXTENSION_EXIST'] = 'Проширење %s већ постоји'; // replace %s with the Extension

// Extensions -> Extension Groups Management
$lang['MANAGE_EXTENSION_GROUPS'] = 'Управљање Групама Проширења';
$lang['MANAGE_EXTENSION_GROUPS_EXPLAIN'] = 'Овде можете додати, обрисати и изменити своје групе проширења, можете онемогућити групе проширења, доделити им посебну категорију, променити механизам преузимања и одредити иконицу за отпрему која ће бити приказана испред прилога.';
$lang['SPECIAL_CATEGORY'] = 'Посебна Категорија';
$lang['CATEGORY_IMAGES'] = 'Слике';
$lang['ALLOWED'] = 'Дозвољено';
$lang['ALLOWED_FORUMS'] = 'Дозвољени Форум';
$lang['EXT_GROUP_PERMISSIONS'] = 'Дозволе Групе';
$lang['DOWNLOAD_MODE'] = 'Режим преузимања';
$lang['UPLOAD_ICON'] = 'Икона за отпрему';
$lang['MAX_GROUPS_FILESIZE'] = 'Максимална величина';
$lang['EXTENSION_GROUP_EXIST'] = 'Група проширења %s већ постоји'; // replace %s with the group name

// Extensions -> Special Categories
$lang['MANAGE_CATEGORIES'] = 'Управљање Посебним Категоријама';
$lang['MANAGE_CATEGORIES_EXPLAIN'] = 'Овде можете конфигурисати Специјалне категорије. Можете подесити Специјалне параметре и услове за Специјалне категорије додељене групи проширења.';
$lang['SETTINGS_CAT_IMAGES'] = 'Подешавања за посебне категорије: слике';
$lang['DISPLAY_INLINED'] = 'Прикажи слике у реду';
$lang['DISPLAY_INLINED_EXPLAIN'] = 'Изаберите да ли да прикажете слике директно у посту (да) или да прикажете слике као везу?';
$lang['MAX_IMAGE_SIZE'] = 'Максималне Димензије Слике';
$lang['MAX_IMAGE_SIZE_EXPLAIN'] = 'Овде можете дефинисати максималне дозвољене димензије слике за припајање (ширина x висина у пикселима). Ако је постављено на 0x0, ова функција је онемогућена. Са неким сликама, ова функција можда неће радити због ограничења у PHP.';
$lang['IMAGE_LINK_SIZE'] = 'Димензије слике линка';
$lang['IMAGE_LINK_SIZE_EXPLAIN'] = 'Ако је изабрана димензија слике достигнута, слика ће бити приказана као веза, а не у уграђеном облику.';
$lang['ASSIGNED_GROUP'] = 'Додељена Група';

$lang['IMAGE_CREATE_THUMBNAIL'] = 'Направите Смањену слику';
$lang['IMAGE_MIN_THUMB_FILESIZE'] = 'Минимална величина минијатуре';
$lang['IMAGE_MIN_THUMB_FILESIZE_EXPLAIN'] = 'Ако је слика мања од ове дефинисане величине, неће бити креиран ниједан минијатурни преглед, јер је довољно мала.';

// Extensions -> Extension Groups Control -> Group Permissions
$lang['GROUP_PERMISSIONS_TITLE_ADMIN'] = 'Дозволе групе проширења → \'%s\''; // Replace %s with the Groups Name
$lang['GROUP_PERMISSIONS_EXPLAIN'] = 'Овде можете ограничити изабрану групу проширења на форуме по вашем избору (одређено у пољу Дозвољени форуми). Подразумевано је да групе проширења буду доступне на свим форумима на које корисник може да прикачи датотеке.';
$lang['NOTE_ADMIN_EMPTY_GROUP_PERMISSIONS'] = 'Напомена:<br />Корисници могу да прикључе датотеке у наведеним форумима, али пошто ниједна група проширења није дозвољена, ваши корисници неће моћи да прикључе ништа. Ако покушају, добиће поруку о грешци. Можда желите да подесите дозволу \'Постави датотеке\' на ADMIN у овим форумима.<br /><br />';
$lang['ADD_FORUMS'] = 'Додајте форуме';
$lang['ADD_SELECTED'] = 'Додајте изабране';
$lang['PERM_ALL_FORUMS'] = 'СВЕ ФОРУМЕ';

// Attachments -> Control Panel
$lang['CONTROL_PANEL_TITLE'] = 'Контролни панел за управљање прилозима';
$lang['CONTROL_PANEL_EXPLAIN'] = 'Овде можете да видите и управљате свим прилозима на основу корисника, прилога, прегледа итд...';

// Control Panel -> Search
$lang['SEARCH_WILDCARD_EXPLAIN'] = 'Користите * као џокер за делимично поклапање';
$lang['SIZE_SMALLER_THAN'] = 'Величина прилога мања од (бајтова)';
$lang['SIZE_GREATER_THAN'] = 'Величина прилога већа од (бајтова)';
$lang['COUNT_SMALLER_THAN'] = 'Број преузимања мањи од';
$lang['COUNT_GREATER_THAN'] = 'Број преузимања већи од';
$lang['MORE_DAYS_OLD'] = 'Више од оволико дана старо';
$lang['NO_ATTACH_SEARCH_MATCH'] = 'Нема прилога који задовољавају услове претраге';

// Control Panel -> Statistics
$lang['NUMBER_OF_ATTACHMENTS'] = 'Број прилога';
$lang['TOTAL_FILESIZE'] = 'Укупна величина фајла';
...
$lang['NUMBER_PMS_ATTACH'] = 'Укупни број прилога у приватним порукама';

// Control Panel -> Attachments
$lang['STATISTICS_FOR_USER'] = 'Статистика прилога за %s'; // replace %s with username
$lang['DOWNLOADS'] = 'Преузимања';
$lang['POST_TIME'] = 'Време писања';
$lang['POSTED_IN_TOPIC'] = 'Објављено у теми';
$lang['SUBMIT_CHANGES'] = 'Потврди промене';

// Sort Types
$lang['SORT_ATTACHMENTS'] = 'Прилози';
...
$lang['SORT_POSTTIME'] = 'Време објављивања';
...
$lang['ATTACH_CONFIG_UPDATED'] = 'Подешавања прилога су успешно ажурирана.';
$lang['CLICK_RETURN_ATTACH_CONFIG'] = 'Кликните %sовде%s да се вратите на Подешавање прилога.';
$lang['TEST_SETTINGS_SUCCESSFUL'] = 'Тестирање подешавања је завршено, конфигурација изгледа добро.';
...
$lang['BT_CHECK_ANNOUNCE_URL_EXPL'] = 'Региструјте се на тракеру само дозвољени URL-ovi.';
...
$lang['CHANGED'] = 'Промена.';
$lang['REMOVED'] = 'Уклоните.';
$lang['QUESTION'] = 'Потврђивање, да ли сте сигурни да желите да извршите ову акцију';
...
$lang['RUN_DAY_EXPL'] = 'дата када овај посао ради.';
$lang['RUN_TIME'] = 'Време за обављање.';
$lang['RUN_TIME_EXPL'] = 'време када овај посао ради (на пример, 05:00:00).';
...
$lang['START_OPTION_CONTINUE'] = 'Наставите са последњим заустављањем';
...
$lang['DISABLE_BOARD'] = 'Искључите форум';
...
$lang['CALLSEED'] = 'Позови семенке';
$lang['CALLSEED_EXPLAIN'] = 'Обратите пажњу на захтев за повратак у дистрибуцију.';
$lang['CALLSEED_SUBJECT'] = 'Преузмите помоћ %s.';
$lang['CALLSEED_TEXT'] = 'Здраво![br]Ваша помоћ је потребна у издању [url=%s]%s[/url][br]Ако одлучите да помогнете, али већ сте обрисали торрент файл, можете га преузети [url=%s]овде[/url][br][br]Надам се за вашу помоћ!';
$lang['CALLSEED_MSG_OK'] = 'Порука је послата свима који су преузели ово издање.';
$lang['CALLSEED_MSG_SPAM'] = 'Захтев је већ једном успешно послат (вероватно не и Ви)<br /><br />Наредна могућност да пошаљете захтев је <b>%s</b>.';
...
$lang['LOG_ACTION']['LOG_TYPE'] = [
    ...
    'adm_user_ban' => 'Корисника:<br /> <b>бан</b>',
    'adm_user_unban' => 'Корисника:<br /> <b>отклонити</b>',
];
...
$lang['SEARCH_FOR_RANK'] = 'Претрага ранга носача %s.';
...
$lang['BEFORE'] = 'Пре';
$lang['AFTER'] = 'Након';
$lang['SEARCH_USERS_JOINED_EXPLAIN'] = 'Претрага корисника који су се придружили пре или после (и) одређеног датума. Формат датума је ГГГГ/ММ/ДД.';
$lang['SEARCH_USERS_GROUPS_EXPLAIN'] = 'Погледајте све чланове изабране групе.';
$lang['SEARCH_USERS_RANKS_EXPLAIN'] = 'Погледајте све носиоце изабраног ранга.';
...
$lang['MC_COMMENT_PM_MSG'] = "Здраво, [b]%s[/b]\nМодератор је оставио у вашој поруци [url=%s][b]%s[/b][/url][quote]\n%s\n[/quote]";
$lang['MC_COMMENT'] = [
    0 => [
        'title' => '',
...
$lang['CAPTCHA_SETTINGS'] = '<h2>Captcha није потпуно конфигурисан</h2><p>Генеришите кључеве користећи контролну таблу ваше captcha услуге, након тога их ставите у фајл library/config.php.</p>';
