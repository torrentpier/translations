...
$lang['NOTIFICATION_SUBJECT'] = 'Получено е ново лично съобщение!';
...
$lang['NOBIRTHDAY_WEEK'] = 'Потребителите имат рожден ден през следващите %d дни'; // %d is substituted with the number of days
...
$lang['EMAIL_BANNED'] = 'Съжалявам, но адресът <b>%s</b> е забранен.';
...
// Errors -> PM Related
$lang['ATTACH_QUOTA_SENDER_PM_REACHED'] = 'Съжаляваме, но максималният размер за всички приложения в папката лични съобщения е постигнат. Моля, изтрийте някои от вашите получени/изпратени прикачени файлове.';
$lang['ATTACH_QUOTA_RECEIVER_PM_REACHED'] = 'Съжаляваме, но максималният размер за всички приложения в папката лични съобщения от \'%s\' е постигнат. Моля, уведомете го, или изчакайте, докато той/тя изтрие някои от своите приложения.';
...
$lang['ATTACHBOX_LIMIT'] = 'Вашият Attachbox е<br /><b>%d%%</b> пълен';
...
$lang['BT_FLIST_ANNOUNCERS_LIST'] = 'Списък на обявите';
$lang['BT_FLIST_ANNOUNCERS'] = 'Обявления';
$lang['BT_FLIST_ANNOUNCERS_NOTICE'] = 'Този списък съдържа обяви на файл с торент';
...
$lang['JAVASCRIPT_ON_REGISTER'] = 'За да се регистрирате, трябва да активирате JavaScript';
...
$lang['CONFLICT_WARNING'] = 'Предупреждение за конфликт на разрешения';
...
$lang['FORUM_ADMIN_EXPLAIN'] = 'От тази панел можете да добавяте, изтривате, редактирате, пренареждате и повторно синхронизирате категории и форуми';
...
// Attachments -> Sync
$lang['SYNC_THUMBNAIL_RESETTED'] = 'Прегледът е нулиран за прикачения файл: %s'; // replace %s with physical Filename
...
$lang['GROUP_PERMISSIONS_TITLE_ADMIN'] = 'Разрешения на групата разширение → \'%s\''; // Replace %s with the Groups Name
...
$lang['TIME_LIMIT_EXPLAIN_SAFE'] = '<i>Вашият PHP (безопасен режим) е конфигуриран с време на изчакване от %s секунди, затова останете под тази стойност</i>';
...
$lang['ATOM_NO_MODE'] = 'Не е предоставена опция за режим за фийда';
