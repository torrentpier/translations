...
$lang['GOTO_PAGE'] = 'Старонка.';
$lang['GOTO_SHORT'] = 'Старонка.';
...
$lang['CLICK_RETURN_GROUP'] = 'Націсніце %sТут%s, каб вярнуцца да інфармацыі аб групе.';
...
$lang['ERROR_LOGIN'] = 'Імя карыстальніка, якое вы ўвялі, недакладнае або недзейснае, або пароль недзейсны.';
...
$lang['NOT_POST'] = 'Паведамленне адсутня';
...
$lang['SIGNATURE_DISABLE'] = 'Падпіс адключаны за парушэнне правілаў форуму.';
$lang['PUBLIC_VIEW_EMAIL'] = 'Паказаць адрас электроннай пошты ў маім профілі.';

$lang['EMAIL_EXPLAIN'] = 'На гэты адрас вам будзе адпраўлена для завяршэння рэгістрацыі.';
...
$lang['RESET_AUTOLOGIN_EXPL'] = 'у тым ліку ўсе месцы, якія вы наведалі форум, дзе ўключаны аўтаматычны ўваход.';
...
$lang['AVATAR_DISABLE'] = 'Магчымасць кіравання аватарамі адключана за парушэнне <a href="%s"><b>правілаў форуму</b></a>.';
...
$lang['REGISTRATION'] = 'Умовы пагаднення аб рэгістрацыі';
...
$lang['NO_LIKES'] = 'Ніхто яшчэ не прагаласаваў';
...
$lang['GROUP_JOINED'] = 'Вы паспяхова падпісаліся на гэтую групу.<br />Вас будуць апавяшчаць, калі ваш даведнік будзе зацверджаны мадэратарам групы.';
$lang['GROUP_REQUEST'] = 'Запыт на ўступленне да вашай групы быў адрасаваны.';
$lang['GROUP_APPROVED'] = 'Ваш запыт быў ухвалены.';
$lang['GROUP_ADDED'] = 'Вы былі дададзены ў гэту групу.';
...
$lang['NO_SEARCHABLE_FORUMS'] = 'У вас няма правоў для пошуку любога форума на гэтым сайце.';
...
$lang['TZ']['-12'] = 'Сусветны час - 12';
$lang['TZ']['-11'] = 'Сусветны час - 11';
$lang['TZ']['-10'] = 'Сусветны час - 10';
$lang['TZ']['-9'] = 'Сусветны час - 9';
$lang['TZ']['-8'] = 'Сусветны час - 8';
$lang['TZ']['-7'] = 'Сусветны час - 7';
$lang['TZ']['-6'] = 'Сусветны час - 6';
$lang['TZ']['-5'] = 'Сусветны час - 5';
$lang['TZ']['-4'] = 'Сусветны час - 4';
$lang['TZ']['-3.5'] = 'Сусветны час - 3.5';
$lang['TZ']['-3'] = 'Сусветны час - 3';
$lang['TZ']['-2'] = 'Сусветны час - 2';
$lang['TZ']['-1'] = 'Сусветны час - 1';
$lang['TZ']['0'] = 'Сусветны час ± 0';
$lang['TZ']['1'] = 'Сусветны час + 1';
$lang['TZ']['2'] = 'Сусветны час + 2';
$lang['TZ']['3'] = 'Сусветны час + 3';
$lang['TZ']['3.5'] = 'Сусветны час + 3.5';
$lang['TZ']['4'] = 'Сусветны час + 4';
$lang['TZ']['4.5'] = 'Сусветны час + 4.5';
$lang['TZ']['5'] = 'Сусветны час + 5';
$lang['TZ']['5.5'] = 'Сусветны час + 5.5';
$lang['TZ']['6'] = 'Сусветны час + 6';
$lang['TZ']['6.5'] = 'Сусветны час + 6.5';
$lang['TZ']['7'] = 'Сусветны час + 7';
$lang['TZ']['8'] = 'Сусветны час + 8';
$lang['TZ']['9'] = 'Сусветны час + 9';
$lang['TZ']['9.5'] = 'Сусветны час + 9.5';
$lang['TZ']['10'] = 'Сусветны час + 10';
$lang['TZ']['11'] = 'Сусветны час + 11';
$lang['TZ']['12'] = 'Сусветны час + 12';
$lang['TZ']['13'] = 'Сусветны час + 13';
...
$lang['EXTENSION_DISABLED_AFTER_POSTING'] = 'Шырэнне \'%s\' было дэзактыўвана адміністратаром форуму, таму гэта ўкладанне не адлюстроўваецца.'; // used in Posts and PM's, replace %s with mime type
...
$lang['SHOW_MORE_INFORMATION_FILE'] = 'Паказаць больш інфармацыі пра файл';
...
$lang['ATTACHMENT_THUMBNAIL'] = 'Эскіз ўкладання';
...
$lang['ATTACHMENT_PHP_SIZE_NA'] = 'Ўкладанне занадта вялікае.<br />Немагчыма атрымаць максімальны памер, вызначаны ў PHP.<br />Модуль укладання не можа вызначыць максімальны памер загрузкі, вызначаны ў php.ini.';
$lang['ATTACHMENT_PHP_SIZE_OVERRUN'] = 'Ўкладанне занадта вялікае.<br />Максімальны памер загрузкі: %d МБ.<br />Калі ласка, звярніце ўвагу, што гэты памер вызначаны ў php.ini, гэта азначае, што ён зададзены PHP, і модуль укладання не можа перапісваць гэта значэнне.'; // replace %d with ini_get('upload_max_filesize')
...
$lang['ATTACHMENT_TOO_BIG'] = 'Ўкладанне занадта вялікая.<br />Максімальны памер: %s'; // replace %d with maximum file size, %s with size var
$lang['TOO_MANY_ATTACHMENTS'] = 'Укладання не могуць быць дададзены, бо дасягнута максімальная колькасць %d ўкладанняў у гэтым паведамленні.'; // replace %d with maximum number of attachments
...
$lang['ERROR_EMPTY_ADD_ATTACHBOX'] = 'Вы павінны ўводзіць значэнні ў поле \'Дадаць ўкладанне\'.';
$lang['ERROR_MISSING_OLD_ENTRY'] = 'Не магу абнавіць ўкладанне, не магу знайсці стары запіс ўкладання.';
...
$lang['DIRECTORY_NOT_WRITEABLE'] = 'Каталог \'%s\' не запісваецца. Вам трэба будзе стварыць шлях загрузкі і змяніць правы доступу.'; // replace %s with directory
...
$lang['TOR_MOD_MSG'] = "Добры дзень, %s.\n\nСтатус [url=%s]ваш[/url] размеркаванне змяніўся на [b]%s[/b]";
...
$lang['TOR_AUTH_SENT_COMMENT'] = ' &middot; <span class="seed bold">Інфармацыя адпраўлена мадэратару. Чакаць.</span>';
...
$lang['UNSET_GOLD_TORRENT'] = 'Скасаваць золата';
$lang['SET_SILVER_TORRENT'] = 'Срэбра';
$lang['UNSET_SILVER_TORRENT'] = 'Скасаваць срэбра';
...
$lang['CUR_DOWNLOADS'] = 'Бягучыя загрузкі';
...
$lang['ALLOWED_ONLY_1ST_POST_REG'] = 'Рэгістрацыя торэнтаў дазволена толькі з першага паста.';
...
$lang['BONUS_UPLOAD_DESC'] = '<b>%s да размеркавання</b> <br /> Для абмену бонусных балаў на %1$s трафік, які будзе дададзены да вашага агульнага размеркавання.';
...
$lang['SHOW_TIME_TOPICS'] = 'паказвае час стварэння тэм.';
$lang['SHOW_CURSOR'] = 'вылучыце радок пад курсорам';

$lang['BT_LOW_RATIO_FOR_DL'] = "З каэфіцыентам <b>%s</b> Вы не можаце спампаваць торэнт";
$lang['BT_RATIO_WARNING_MSG'] = 'Калі гэта суадносіны падае ніжэй %s, Вы не зможаце спампаваць торэнты! <a href="%s"><b>Больш аб рэйтынгу.</b></a>.';
...
$lang['INVALID_DATE'] = 'Няправільная дата';
...
$lang['BAN_USER'] = 'Каб захаваць карыстальніка';
...
$lang['USER_DELETE_CSV'] = 'На жаль, гэтаму ўліковаму запісу не дазваляецца выдаляць!';
...
$lang['DELETE_USER_POSTS'] = 'Выдаліць усе паведамленні, акрамя першых пастоў';
$lang['DELETE_USER_POSTS_ME'] = 'Вы ўпэўненыя, што хочаце выдаліць усе мае пасты?';
$lang['DELETE_USER_POSTS_CONFIRM'] = 'Вы ўпэўненыя, што хочаце выдаліць усе паведамленні, акрамя першых постаў?';
...
$lang['SCREENSHOTS_RULES'] = 'Чытайце правілы выкладкі скрыншотаў!';
$lang['AJAX_EDIT_OPEN'] = 'Вы ўжо адкрылі адно хуткае рэдагаванне!';
...
$lang['DEL_LIST_MY_MESSAGE_INFO'] = 'Пасля выдалення да абнаўлення <b>усе спісы</b> можа адлюстравацца выдаленыя тэмы';
...
$lang['NO_WATCHED_TOPICS'] = 'Вы не глядзіце на ніводную тэму.';
...
$lang['AUTH_SELF_ERROR'] = 'Не ўдалося змяніць сябе з адміністратара на карыстальніка';
...
$lang['SMILIES_PATH_EXPLAIN'] = 'Шлях пад вашым карэнным каталогам TorrentPier, напрыклад, styles/images/smiles';
...
$lang['NO_GROUP_MODE'] = 'Неабходна пазначыць рэжым групы, адкрыты ці закрыты.';
...
$lang['LOGIN_RESET_TIME_EXPLAIN'] = 'Час у хвілінах, які мусіць чакаць карыстальнік.';
...
$lang['PREMOD_HELP'] = '<h4><span class="tor-icon tor-dup">&#8719;</span> Папярэдняя мадэрацыя</h4> <h6>Калі вы не маеце размеркаванняў са статусам v, # або T у гэтым раздзеле, уключаючы падраздзелы, размеркаванне аўтаматычна атрымае гэты статус</h6>';
$lang['TOR_COMMENT'] = '<h4>Каментарый да статусу размеркавання</h4> <h6>Каментарый дазваляе паказаць на памылкі, зробленыя выпускніку. Калі статусы няпоўныя, для менеджара даступная форма адказу для выпраўлення выпуску.</h6>';
$lang['SEED_BONUS_ADD'] = '<h4>Даданне бонуса насення</h4> <h6>Колькасць дыстрыбутываў выдасёнага карыстальнікам і памер бонусаў для іх (раз зарадка гадзіну)</h6>.';
$lang['SEED_BONUS_RELEASE'] = 'да N-колькасці рэлізаў.';
$lang['SEED_BONUS_POINTS'] = 'бонусаў за гадзіну.';
...
$lang['SEED_BONUS_USER_REGDATA'] = 'Даўжыня трэкара карыстальнікаў, пасля якой будуць налічаны бонусы.';
...
$lang['EXTENSION_GROUP_MANAGE'] = 'Кантроль Групаў Пашырэнняў.';
$lang['SPECIAL_CATEGORIES'] = 'Спецыяльныя Катэгорыі';

// Attachments -> Management
$lang['ATTACH_SETTINGS'] = 'Налады Укладанняў';
$lang['MANAGE_ATTACHMENTS_EXPLAIN'] = 'Тут вы можаце наладзіць асноўныя параметры для модуля ўкладанняў. Калі вы націснеце на кнопку праверкі налад, модуль укладанняў правядзе некалькі сістэмных тэстаў, каб упэўніцца, што модуль будзе працаваць належным чынам. Калі ў вас ёсць праблемы з загрузкай файлаў, калі ласка, выканайце гэты тэст, каб атрымаць падрабязныя паведамленні пра памылку.';
$lang['ATTACH_FILESIZE_SETTINGS'] = 'Налады памеру файлаў укладання';
...
$lang['ATTACH_IMG_PATH_EXPLAIN'] = 'Гэта выява адлюстроўваецца побач з укладкамі ў асобных паведамленнях. Пакіньце гэта поле пустым, калі вы не хочаце, каб значок адлюстроўваўся. Гэты параметр будзе перазапісаны ў наладах кіравання групамі пашырэнняў.';
$lang['ATTACH_TOPIC_ICON'] = 'Значок Тэмы Ўкладання.';
$lang['ATTACH_TOPIC_ICON_EXPLAIN'] = 'Гэта выява адлюстроўваецца перад тэмамі з укладаннямі. Пакіньце гэта поле пустым, калі вы не хочаце, каб значок адлюстроўваўся.';
$lang['ATTACH_DISPLAY_ORDER'] = 'Парадак адлюстравання ўкладання.';
$lang['ATTACH_DISPLAY_ORDER_EXPLAIN'] = 'Тут вы можаце выбраць, ці варта адлюстровываць уласцівасці ўкладанняў у паведамленнях/ЛС у парадку змяншэння часу загрузкі (самыя новыя ўкладанні першымі) або ў парадку ўзрастання часу загрузкі (самыя старэйшыя ўкладанні першымі).';

$lang['MAX_FILESIZE_ATTACH'] = 'Памер файла';
...
$lang['MAX_FILESIZE_PM'] = 'Максімальны памер файла ў асабістых паведамленнях.';
$lang['MAX_FILESIZE_PM_EXPLAIN'] = 'Максімальны аб\'ём памяці, які могуць выкарыстоўваць укладанні ў скрыні асабістых паведамленняў кожнага карыстальніка. Значэнне 0 азначае \'неабмежаваны\'.';
...
$lang['DISABLE_MOD_EXPLAIN'] = 'Гэты параметр у асноўным для тэставання новых шаблонаў або тэм. Ён адключае ўсе функцыі ўкладанняў, акрамя адміністрацыйнай панэлі.';
...
$lang['EXTENSION_EXIST'] = 'Пашырэнне %s ужо існуе.'; // replace %s with the Extension

// Extensions -> Extension Groups Management
$lang['MANAGE_EXTENSION_GROUPS'] = 'Кіраванне Групамі Пашырэнне';
$lang['MANAGE_EXTENSION_GROUPS_EXPLAIN'] = 'Тут вы можаце дадаваць, выдаляць і змяняць групы пашырэнняў. Вы можаце адключыць групы пашырэнняў, прызначыць спецыяльную катэгорыю ім, змяніць механізм загрузкі, і вы можаце вызначыць значок загрузкі, які будзе адлюстроўвацца перад укладаннем, якое належыць групе.';
...
$lang['EXTENSION_GROUP_EXIST'] = 'Група пашырэння %s ўжо існуе.'; // replace %s with the group name

// Extensions -> Special Categories
$lang['MANAGE_CATEGORIES'] = 'Кіраванне Спецыяльных Катэгорый';
$lang['MANAGE_CATEGORIES_EXPLAIN'] = 'Тут вы можаце наладжваць спецыяльныя катэгорыі. Вы можаце ўсталяваць спецыяльныя параметры і ўмовы для спецыяльных катэгорый, прызначаных групе пашырэнняў.';
$lang['SETTINGS_CAT_IMAGES'] = 'Налады для спецыяльнай катэгорыі: карцінкі';
$lang['DISPLAY_INLINED'] = 'Паказваць выявы ўнутры';
$lang['DISPLAY_INLINED_EXPLAIN'] = 'Выберыце, ці варта адлюстроўваць выявы непасрэдна ў постах (так) ці адлюстраваць выявы ў якасці спасылкі?';
$lang['MAX_IMAGE_SIZE'] = 'Максімальныя Памеры Малюнка';
$lang['MAX_IMAGE_SIZE_EXPLAIN'] = 'Тут вы можаце вызначыць максімальныя допустимыя памеры малюнкаў, якія могуць быць прымацаваны (Шырыня х Вышыня ў пікселях).<br />Калі ён усталяваны на 0x0, гэтая функцыя адключаецца. З некаторымі малюнкамі гэтую функцыю не будзе працаваць з-за абмежаванняў PHP.';
$lang['IMAGE_LINK_SIZE'] = 'Памеры малюнка спасылкі.';
$lang['IMAGE_LINK_SIZE_EXPLAIN'] = 'Калі гэты пэўны памер малюнка дасягнуты, малюнак будзе адлюстраваны як спасылка, а не адлюстравацца ў убудаваным выглядзе,<br />калі ўбудаваны выгляд уключаны (шырыня x вышыня ў пікселях).<br />Калі ён усталяваны на 0x0, гэтая функцыя адключаная. З некаторымі малюнкамі гэтая функцыя не будзе працаваць з-за абмежаванняў у PHP.';
$lang['ASSIGNED_GROUP'] = 'Прызначаная Група';

$lang['IMAGE_CREATE_THUMBNAIL'] = 'Стварыць Эскіз';
$lang['IMAGE_MIN_THUMB_FILESIZE'] = 'Мінімальны памер файла мініятуры';
$lang['IMAGE_MIN_THUMB_FILESIZE_EXPLAIN'] = 'Калі малюнак меншы за гэты вызначаны памер файла, мініяцюра не будзе створана, бо ён дастаткова малы.';

// Extensions -> Extension Groups Control -> Group Permissions
$lang['GROUP_PERMISSIONS_TITLE_ADMIN'] = 'Дазволы групы пашырэнняў → \'%s\''; // Replace %s with the Groups Name
$lang['GROUP_PERMISSIONS_EXPLAIN'] = 'Тут вы можаце абмежаваць абраныя групы пашырэння на форумах па вашаму выбару (вызначаецца ў полі дазволеныя форумы). Па змаўчанні дазволеныя групы пашырэння для ўсіх форумаў, у якія карыстальніку дазволена прыкладаць файлы (звычайны спіс, як гэта рабіў мод з самага пачатку). Проста дадайце тыя форумы, на якіх вы хочаце, каб група пашырэння (пашырэнні ў гэтай групе) магла быць дазволена, стандартнае УСЕ ФОРУМЫ знікне, калі вы дадасце форумы ў спіс. Вы можаце паўторна дадаць УСЕ ФОРУМЫ ў любы час. Калі вы дадасце форум на ваш савет, і дазвол усталяваны на УСЕ ФОРУМЫ, нічога не зменіцца. Але калі вы змянілі і абмежавалі доступ да некаторых форумаў, вам трэба праверыць тут, каб дадаць новы створаны форум. Гэта лёгка рабіць аўтаматычна, але гэта прымусіць вас змяняць шмат файлаў, таму я выбраў той шлях, якім я іду зараз. Калі ласка, майце на ўвазе, што ўсе вашы форумы будуць пералічаныя тут.';
$lang['NOTE_ADMIN_EMPTY_GROUP_PERMISSIONS'] = 'Заўвага:<br />У ніжэй прыкладзеных форумах вашым карыстальнікам звычайна дазволена прыкладаць файлы, але паколькі ні адна група пашырэння не дазволена быць прыкладзенай, вашыя карыстальнікі не змогуць нічога прыкладаць. Калі яны паспрабуюць, яны атрымліваюць паведамленні пра памылку. Магчыма, вы хочаце ўсталяваць дазвол \'Публікаваць файлы\' для адміністратара на гэтых форумах.<br /><br />';
$lang['ADD_FORUMS'] = 'Дадаць Форумы';
$lang['ADD_SELECTED'] = 'Дадаць Выбраныя';
$lang['PERM_ALL_FORUMS'] = 'УСЕ ФОРУМЫ';

// Attachments -> Control Panel
$lang['CONTROL_PANEL_TITLE'] = 'Панэль Кіравання Укладаннямі Файлаў';
...
$lang['TOTAL_FILESIZE'] = 'Агульны памер файла';
...
$lang['ATTACH_CONFIG_UPDATED'] = 'Налады прыкладання паспяхова абноўлены';
$lang['CLICK_RETURN_ATTACH_CONFIG'] = 'Націсніце %sТут%s, каб вярнуцца ў налады прыкладання';
$lang['TEST_SETTINGS_SUCCESSFUL'] = 'Праверка налад завершана, канфігурацыя здаецца нармальнай.';
...
$lang['REMOVED'] = 'Выдалены';
$lang['QUESTION'] = 'Пацвердзіце, ці ўпэўнены вы, што хочаце выканаць гэта дзеянне';
...
$lang['RUN_TIME_EXPL'] = 'Час, калі гэтая праца запускаецца (напрыклад, 05:00:00).';
...
$lang['START_OPTION_CONTINUE'] = 'працягнуць з апошняга спынення.';
...
$lang['DISABLE_BOARD'] = 'Адключыць форум.';
...
$lang['PROCESSING_TIME'] = 'This translation is inaccurate.';
...
$lang['CALLSEED'] = 'Патэлефанаваць семянам';
$lang['CALLSEED_EXPLAIN'] = 'Прымаць паведамлення з просьбай вярнуцца на раздачу';
$lang['CALLSEED_SUBJECT'] = 'Спампаваць дапамогу %s';
$lang['CALLSEED_TEXT'] = 'Добры дзень![br]Ваша дапамога патрэбна для рэлізу [url=%s]%s[/url][br]Калі вы вырашылі дапамагчы, але ўжо выдалілі торэнт-файл, вы можаце спампаваць яго [url=%s]гэта[/url][br][br]Спадзяюся на вашу дапамогу!';
$lang['CALLSEED_MSG_OK'] = 'Паведамленне было адпраўлена ўсім тым, хто запампаваў гэты рэліз';
$lang['CALLSEED_MSG_SPAM'] = 'Запыт ужо быў аднойчы паспяхова адпраўлены (напэўна, не вы)<br /><br />Наступная магчымасць даслаць запыт будзе <b>%s</b>.';
...
$lang['LOG_ACTION']['LOG_TYPE'] = [
    ...
    'adm_user_ban' => 'Карыстальнікаў:<br /> <b>забарана</b>.',
    'adm_user_unban' => 'Карыстальнікаў:<br /> <b>знята забарона</b>.',
];
...
$lang['SEARCH_USERS_LASTVISITED'] = 'Карыстальнікі, якія наведалі сайце';
$lang['IN_THE_LAST'] = 'у апошнія';
$lang['AFTER_THE_LAST'] = 'пасля апошняга';
$lang['BEFORE'] = 'Перад';
$lang['AFTER'] = 'Пасля';
$lang['SEARCH_USERS_JOINED_EXPLAIN'] = 'Пошук карыстальнікаў, якія далучыліся да або пасля (і на) канкрэтную дату. Фармат даты: ГГГГ/мм/ДД.';
...
$lang['MC_COMMENT_PM_MSG'] = "Прывітанне, [b]%s[/b]\nМодаратары пакінулі ў вашым паведамленні [url=%s][b]%s[/b][/url][quote]\n%s\n[/quote]";
$lang['MC_COMMENT'] = [
    0 => [
        'title' => '',
...
$lang['ATOM_NO_MODE'] = 'Не прадстаўлена опцыя рэжыму для стужкі.';
$lang['ATOM_NO_FORUM'] = 'Гэты форум не мае фіда (адсутнічаюць актыўныя тэмы).';
$lang['ATOM_NO_USER'] = 'У гэтага карыстальніка няма фіда (няма актыўных тэм).';
...
$lang['CAPTCHA_SETTINGS'] = '<h2>Captcha не поўнасцю наладжаны</h2><p>Сгенеруйце ключы, выкарыстоўваючы панэль кіравання вашай captcha-сэрвісу, пасля гэтага вам трэба ўставіць іх у файл library/config.php.</p>';
