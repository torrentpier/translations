...
$lang['PASSWORD_SHOW_BTN'] = 'Εμφάνιση κωδικού πρόσβασης';
$lang['EMAIL'] = 'E-mail';
$lang['PM'] = 'ΠΜ';
...
$lang['MOVE_TO_TOP'] = 'Μετακίνηση στην κορυφή';
$lang['UNKNOWN'] = 'Άγνωστο';
$lang['COPY_TO_CLIPBOARD'] = 'Αντιγραφή στο πρόχειρο';
$lang['NO_ITEMS'] = 'Δεν φαίνεται να υπάρχουν δεδομένα εδώ...';
$lang['PLEASE_TRY_AGAIN'] = 'Παρακαλώ δοκιμάστε ξανά μετά από λίγα δευτερόλεπτα...';

$lang['NEXT_PAGE'] = 'Επόμενη';
...
$lang['VIEW_LATEST_POST'] = 'Δείτε την τελευταία δημοσίευση';
...
$lang['CONFIRM_LOGOUT'] = 'Είστε σίγουροι ότι θέλετε να αποσυνδεθείτε;';

$lang['FORGOTTEN_PASSWORD'] = 'Ξεχάσατε τον κωδικό σας;';
$lang['AUTO_LOGIN'] = 'Σύνδεσή μου αυτόματα';
$lang['ERROR_LOGIN'] = 'Το όνομα χρήστη ή ο κωδικός πρόσβασης που εισαγάγατε είναι λάθος.';
...
$lang['SPOILER_CLOSE'] = 'κλείσιμο';
$lang['PLAY_ON_CURPAGE'] = 'Ξεκινήστε να παίζετε στην τρέχουσα σελίδα';

$lang['EDITED_TIME_TOTAL'] = 'Τελευταία επεξεργασία από <b>%s</b> στις %s; edited %d time in total'; // Last edited by me on 12 Oct 2001; edited 1 time in total
$lang['EDITED_TIMES_TOTAL'] = 'Τελευταία επεξεργασία από <b>%s</b> στις %s; edited %d times in total'; // Last edited by me on 12 Oct 2001; edited 2 times in total
...
$lang['INVALID_TOPIC_ID'] = 'Το θέμα δεν βρέθηκε!';
$lang['INVALID_TOPIC_ID_DB'] = 'Το θέμα δεν υπάρχει στη βάση δεδομένων!';

$lang['NOT_EDIT_TOR_STATUS'] = 'Δεν μπορείτε να επεξεργαστείτε την κυκλοφορία με αυτή την κατάσταση';
...
$lang['POST_DOWNLOAD'] = 'Λήψη';

// Anonymous posting
$lang['ANONYMOUS'] = 'Ανωνύμως';
$lang['ANONYMOUS_TOPIC'] = 'Δημοσίευση θέματος ανώνυμα';
$lang['ANONYMOUS_REPLY'] = 'Απάντηση ανώνυμα';
$lang['HIDE_AUTHORSHIP'] = 'Ανώνυμη δημοσίευση από προεπιλογή';
$lang['HIDE_AUTHORSHIP_EXPLAIN'] = 'Όταν είναι ενεργοποιημένο, οι νέες δημοσιεύσεις θα είναι από προεπιλογή ανώνυμες. Μπορείτε να το αλλάξετε για κάθε δημοσίευση ξεχωριστά.';
$lang['ALLOW_ANONYMOUS_POSTING'] = 'Επιτρέπεται η ανώνυμη δημοσίευση';
$lang['ANONYMOUS_POST_LABEL'] = 'Δημοσιεύτηκε ανώνυμα';
$lang['POSTED_ANONYMOUSLY'] = 'δημοσιεύτηκε ανώνυμα';
$lang['ANONYMOUS_ADMIN_NOTICE'] = 'Οι διαχειριστές και οι συντονιστές μπορούν να δουν τον πραγματικό συγγραφέα';
$lang['YOU'] = 'Εσύ';

$lang['PRINT_PAGE'] = 'Εκτύπωση σελίδας';

$lang['CONFIRM_DELETE'] = 'Είστε σίγουροι ότι θέλετε να διαγράψετε αυτήν την ανάρτηση;';
...
$lang['MAX_SMILIES_PER_POST'] = 'Το όριο των emoticon %s έχει ξεπεραστεί.';
...
$lang['NO_SUCH_FOLDER'] = 'Ο φάκελος δεν βρέθηκε';
...
$lang['ADD_RETRACKER'] = 'Προσθέστε retracker στα αρχεία torrent';
...
$lang['BIRTHDAY_TO_LOW'] = 'Συγγνώμη, αυτός ο ιστότοπος δεν δέχεται χρήστες κάτω των %d ετών';
...
$lang['SIGNATURE_DISABLE'] = 'Η υπογραφή απενεργοποιήθηκε λόγω παραβίασης κανόνων φόρουμ';
$lang['PUBLIC_VIEW_EMAIL'] = 'Εμφάνιση διεύθυνσης e-mail στο προφίλ μου';

$lang['EMAIL_EXPLAIN'] = 'Ένα email επιβεβαίωσης θα σταλεί σε αυτή τη διεύθυνση για να ολοκληρωθεί η εγγραφή σας';
...
$lang['RESET_AUTOLOGIN_EXPL'] = 'αυτό θα σας αποσυνδέσει από όλες τις συσκευές όπου είναι ενεργοποιημένο το αυτόματο σύνδεμα';
...
$lang['AVATAR_DISABLE'] = 'Η αποστολή avatar απενεργοποιήθηκε λόγω παραβίασης των <a href="%s"><b>κανόνων φόρουμ</b></a>';
...
$lang['USERNAME_TOO_LONG'] = 'Το όνομά χρήστη είναι πολύ μεγάλο.';
$lang['USERNAME_TOO_SMALL'] = 'Το όνομά χρήστη είναι πολύ μικρό.';
...
$lang['THANKS_GRATITUDE'] = 'Εκτιμούμε την ευγνωμοσύνη σας';
$lang['LAST_LIKES'] = 'Τελευταίες ψήφοι';
$lang['LIKE_OWN_POST'] = 'Δεν μπορείτε να ψηφίσετε για το δικό σας θέμα';
$lang['NO_LIKES'] = 'Κανείς δεν έχει ψηφίσει ακόμα';
$lang['LIKE_ALREADY'] = 'Έχετε ήδη ψηφίσει για αυτό το θέμα';

// Invites
$lang['INVITE_CODE'] = 'Κωδικός πρόσκλησης';
$lang['INCORRECT_INVITE'] = 'Η πρόσκληση δεν βρέθηκε';
$lang['INVITE_EXPIRED'] = 'Η πρόσκληση έχει λήξει';
...
$lang['GROUP_JOINED'] = 'Έχετε υποβάλει με επιτυχία αίτηση για να συμμετάσχετε σε αυτήν την ομάδα.<br />Θα ειδοποιηθείτε όταν η συμμετοχή σας εγκριθεί από τον συντονιστή της ομάδας.';
...
$lang['GROUPS_RELEASES'] = 'Κυκλοφορίες της ομάδας';
$lang['MORE_RELEASES'] = 'Βρείτε όλες τις κυκλοφορίες της ομάδας';
$lang['NOT_A_RELEASE_GROUP'] = 'Αυτή η ομάδα δεν είναι ομάδα κυκλοφοριών';
...
$lang['SEARCH_WORDS_EXPL'] = 'Μπορείτε να χρησιμοποιήσετε <b>+</b> για να ορίσετε λέξεις που πρέπει να περιλαμβάνονται στα αποτελέσματα και <b>-</b> για λέξεις που δεν πρέπει να υπάρχουν στα αποτελέσματα (π.χ.: "+λέξη1 -λέξη2"). Χρησιμοποιήστε * ως μπαλαντέρ για μερικές αντιστοιχίσεις';
$lang['SEARCH_AUTHOR'] = 'Αναζήτηση συγγραφέα';
$lang['SEARCH_AUTHOR_EXPL'] = 'Χρησιμοποιήστε * ως μπαλαντέρ για μερική αντιστοιχία';

$lang['SEARCH_TITLES_ONLY'] = 'Αναζήτηση μόνο στους τίτλους των θεμάτων';
$lang['SEARCH_ALL_WORDS'] = 'όλες οι λέξεις';
$lang['IN_MY_POSTS'] = 'Στις δημοσιεύσεις μου';
$lang['SEARCH_MY_TOPICS'] = 'Στα θέματά μου';
$lang['NEW_TOPICS'] = 'Νέα θέματα';

$lang['SEARCH_PREVIOUS'] = 'Προηγούμενη αναζήτηση';

$lang['SORT_BY'] = 'Ταξινόμηση κατά';
$lang['SORT_TIME'] = 'Ώρα δημοσίευσης';
$lang['SORT_TOPIC_TITLE'] = 'Τίτλος θέματος';
...
$lang['SORRY_AUTH_VIEW'] = 'Συγγνώμη, αλλά μόνο %s μπορούν να δουν αυτό το φόρουμ.';
$lang['SORRY_AUTH_READ'] = 'Συγγνώμη, αλλά μόνο %s μπορούν να διαβάσουν τα θέματα σε αυτό το φόρουμ.';
$lang['SORRY_AUTH_REPLY'] = 'Συγγνώμη, αλλά μόνο %s μπορούν να απαντήσουν στις δημοσιεύσεις σε αυτό το φόρουμ.';
$lang['SORRY_AUTH_EDIT'] = 'Συγγνώμη, αλλά μόνο %s μπορούν να επεξεργαστούν τις δημοσιεύσεις σε αυτό το φόρουμ.';
$lang['SORRY_AUTH_DELETE'] = 'Συγγνώμη, αλλά μόνο %s μπορούν να διαγράψουν τις δημοσιεύσεις σε αυτό το φόρουμ.';

// These replace the %s in the above strings
$lang['AUTH_ANONYMOUS_USERS'] = '<b>ανώνυμοι χρήστες</b>';
$lang['AUTH_REGISTERED_USERS'] = '<b>εγγεγραμμένοι χρήστες</b>';
$lang['AUTH_USERS_GRANTED_ACCESS'] = '<b>χρήστες με ειδική πρόσβαση</b>';
$lang['AUTH_MODERATORS'] = '<b>συντονιστές</b>';
$lang['AUTH_ADMINISTRATORS'] = '<b>διαχειριστές</b>';

$lang['NOT_MODERATOR'] = 'Δεν είστε συντονιστής αυτού του φόρουμ.';
$lang['NOT_AUTHORISED'] = 'Δεν Επιτρέπεται';

$lang['YOU_BEEN_BANNED'] = 'Έχετε αποκλειστεί από αυτό το φόρουμ. Για περισσότερες πληροφορίες επικοινωνήστε με τον διαχειριστή του φόρουμ.';
...
$lang['NO_TOPICS_REMOVED'] = 'Δεν αφαιρέθηκε κανένα θέμα.';
...
$lang['NO_TOPICS_MOVED'] = 'Δεν μετακινήθηκε κανένα θέμα.';

$lang['CONFIRM_DELETE_TOPIC'] = 'Είστε σίγουροι ότι θέλετε να αφαιρέσετε τα επιλεγμένα θέματα;';
$lang['CONFIRM_MOVE_TOPIC'] = 'Είστε σίγουροι ότι θέλετε να μετακινήσετε τα επιλεγμένα θέματα;';

$lang['MOVE_TO_FORUM'] = 'Μετακίνηση στο φόρουμ';
$lang['LEAVE_SHADOW_TOPIC'] = 'Αφήστε το σκιασμένο θέμα στο παλιό φόρουμ.';

$lang['SPLIT_TOPIC_EXPLAIN'] = 'Χρησιμοποιώντας την παρακάτω φόρμα μπορείτε να χωρίσετε ένα θέμα σε δύο, είτε επιλέγοντας μεμονωμένα τις δημοσιεύσεις, είτε χωρίζοντας από μια επιλεγμένη δημοσίευση';
$lang['NEW_TOPIC_TITLE'] = 'Τίτλος νέου θέματος';
$lang['FORUM_FOR_NEW_TOPIC'] = 'Φόρουμ για νέο θέμα';
$lang['SPLIT_POSTS'] = 'Διαίρεση επιλεγμένων δημοσιεύσεων';
$lang['SPLIT_AFTER'] = 'Διαίρεση από την επιλεγμένη δημοσίευση';
$lang['TOPIC_SPLIT'] = 'Το επιλεγμένο θέμα έχει χωριστεί με επιτυχία';
$lang['NONE_SELECTED'] = 'Δεν έχετε επιλέξει κάτι για να εκτελέσετε αυτήν την ενέργεια. Επιστρέψτε και επιλέξτε τουλάχιστον ένα.';

$lang['THIS_POSTS_IP'] = 'Διεύθυνση IP για αυτή τη δημοσίευση';
$lang['OTHER_IP_THIS_USER'] = 'Άλλες διευθύνσεις IP από τις οποίες έχει δημοσιεύσει αυτός ο χρήστης';
$lang['USERS_THIS_IP'] = 'Χρήστες που δημοσιεύουν από αυτή τη διεύθυνση IP';
$lang['IP_INFO'] = 'Πληροφορίες IP';
$lang['LOOKUP_IP'] = 'Αναζήτηση διεύθυνσης IP';

// Timezones ... for display on each page
$lang['ALL_TIMES'] = 'Όλες οι ώρες είναι <span class="tz_time">%s</span>'; // This is followed by UTC and the timezone offset
...
// Country selector
$lang['COUNTRY'] = 'Χώρα';
$lang['SET_OWN_COUNTRY'] = 'Ορίστε τη δική σας χώρα (Χειροκίνητα)';
...
$lang['MAX_FILE_SIZE'] = 'Μέγιστο μέγεθος αρχείου';
$lang['ALLOWED_EXTENSIONS'] = 'Επιτρεπτές επεκτάσεις';

// Viewtopic -> Display of Attachments -> TorrServer integration
$lang['STREAM'] = 'Ροή';
$lang['RESOLUTION'] = 'Ανάλυση: <b>%s</b>';
$lang['CHANNELS'] = 'Κανάλια: <b>%s</b>';
$lang['CHANNELS_LAYOUT'] = 'Διάταξη καναλιών: <b>%s</b>';
$lang['BITRATE'] = 'Bitrate: <b>%s</b>';
$lang['SAMPLE_RATE'] = 'Ρυθμός δείγματος: <b>%s</b>';
$lang['AUDIO_TRACK'] = 'Πληροφορίες ήχου (%d):';
$lang['AUDIO_CODEC'] = 'Κωδικοποιητής ήχου: <b title="%s">%s</b>';
$lang['VIDEO_CODEC'] = 'Κωδικοποιητής βίντεο: <b title="%s">%s</b>';
$lang['SHOW_MORE_INFORMATION_FILE'] = 'Εμφάνισε περισσότερες πληροφορίες για αυτό το αρχείο';
$lang['DOWNLOAD_M3U_FILE'] = 'Λήψη αρχείου .m3u';
$lang['PLAYBACK_M3U'] = 'Αναπαραγωγή αρχείου .m3u';
$lang['COPY_STREAM_LINK'] = 'Αντιγραφή συνδέσμου ροής στο πρόχειρο';
...
$lang['TORRSERVER_UNAVAILABLE'] = 'Το TorrServer δεν είναι διαθέσιμο';
$lang['TORRSERVER_INVALID_REQUEST'] = 'Μη έγκυρες παράμετροι αιτήματος';
...
$lang['UPDATE_ATTACHMENT'] = 'Ενημέρωση συνημμένου';
...
$lang['DOWNLOAD_LIMIT_EXCEEDED'] = 'Υπέρβαση ημερήσιου ορίου λήψεων. Παρακαλώ δοκιμάστε ξανά αύριο.';
...
$lang['BT_REG_FAIL_SAME_HASH'] = 'Άλλο torrent με το ίδιο info_hash είναι ήδη <a href="%s"><b>καταχωρημένο</b></a>';
...
$lang['BT_FLIST_LIMIT'] = 'Οι ρυθμίσεις του Tracker δεν επιτρέπουν την επεξεργασία λιστών με περισσότερα από %d αρχεία. Ο τρέχων αριθμός είναι: %d';
$lang['BT_FLIST_BTMR_HASH'] = 'BTMR Hash';
$lang['BT_FLIST_BTMR_NOTICE'] = 'Η ρίζα Merkle του BitTorrent είναι ένα hash ενός αρχείου που ενσωματώνεται σε torrents με υποστήριξη BitTorrent v2, οι χρήστες του tracker μπορούν να το εξαγάγουν, να το υπολογίσουν, να κατεβάσουν επίσης deduplicated torrents χρησιμοποιώντας εργαλεία επιτραπέζιων υπολογιστών όπως <a href="%s" target="_blank" referrerpolicy="origin">Αναγνώστης Ρίζας Merkle Torrent</a>';
$lang['BT_FLIST_CREATION_DATE'] = 'Ημερομηνία δημιουργίας';
...
$lang['TOR_STATUS_NOT_SELECT'] = 'Δεν έχετε επιλέξει κατάσταση.';
...
$lang['TOR_STATUS_NAME'] = [
    ...
    TOR_NEED_EDIT => 'χρειάζεται επεξεργασία',
    TOR_NO_DESC => 'μη ολοκληρωμένο',
    TOR_DUP => 'διπλότυπο',
...
$lang['TOR_STATUS_LOG_ACTION'] = 'Νέα κατάσταση: %s.<br/>Προηγούμενη κατάσταση: %s.';

// tor_comment
$lang['TOR_MOD_TITLE'] = 'Η κατάσταση διανομής άλλαξε – %s';
$lang['TOR_MOD_MSG'] = "Γεια σου, %s.\n\nΗ κατάσταση της [url=%s]διανομής σου[/url] άλλαξε σε [b]%s[/b]";

$lang['TOR_AUTH_TITLE'] = 'Αιτήθηκε αλλαγή μορφοποίησης – %s';
$lang['TOR_AUTH_MSG'] = "Γεια σας, %s.\n\nΗ διανομή σας έχει αλλάξει - [url=%s]%s[/url]\n\nΠαρακαλώ ελέγξτε ξανά.";
$lang['TOR_AUTH_FIXED'] = 'Σταθερό';
$lang['TOR_AUTH_SENT_COMMENT'] = ' &middot; <span class="seed bold">Οι πληροφορίες έχουν αποσταλεί στον διαχειριστή. Περιμένετε απάντηση.</span>';
...
$lang['UNSET_GOLD_TORRENT'] = 'Αφαίρεση κατάστασης χρυσού';
$lang['SET_SILVER_TORRENT'] = 'Κάντε το ασημένιο';
$lang['UNSET_SILVER_TORRENT'] = 'Αφαίρεση κατάστασης ασημιού';
$lang['GOLD_STATUS'] = 'ΧΡΥΣΌ TORRENT! Η ΚΥΚΛΟΦΟΡΊΑ ΛΉΨΗΣ ΔΕΝ ΛΑΜΒΆΝΕΤΑΙ ΥΠΌΨΗ!';
$lang['SILVER_STATUS'] = 'ΑΣΗΜΈΝΙΟ TORRENT! Η ΚΥΚΛΟΦΟΡΊΑ ΛΉΨΗΣ ΛΑΜΒΆΝΕΤΑΙ ΜΕΡΙΚΏΣ ΥΠΌΨΗ!';
...
$lang['SEL_CHAPTERS'] = 'Σύνδεσμος στα επιλεγμένα τμήματα';
$lang['NOT_SEL_CHAPTERS'] = 'Δεν έχετε επιλέξει κανένα θέμα';
$lang['SEL_CHAPTERS_HELP'] = 'Μπορείτε να επιλέξετε το πολύ %s τμήματα';
...
$lang['UNSET_DL_STATUS'] = 'Δεν γίνεται λήψη';
...
$lang['BONUS'] = 'Μπόνους';
$lang['IT_WILL_BE_DOWN'] = 'θα υπολογιστεί όταν γίνει λήψη';
$lang['SPMODE_FULL'] = 'Εμφάνιση συνομηλίκων σε πλήρη λεπτομέρεια.';

// Seed Bonus
$lang['MY_BONUS'] = 'Το μπόνους μου (%s πόντοι διαθέσιμοι)';
$lang['BONUS_SELECT'] = 'Επιλέξτε';
$lang['SEED_BONUS'] = 'Μπόνους σπόρου.';
$lang['EXCHANGE'] = 'Ανταλλαγή';
$lang['EXCHANGE_BONUS'] = 'Ανταλλαγή πόντων μπόνους';
$lang['BONUS_UPLOAD_DESC'] = '<b>+%s πίστωση ανέβασματος</b> <br /> Ανταλλάξτε πόντους μπόνους για %1$s ανώτατη κυκλοφορία ανέβασματος που προστίθεται στο συνολικό λογαριασμό σας.';
$lang['BONUS_UPLOAD_PRICE'] = '<b class="%s">%s</b>';
$lang['PRICE'] = 'Τιμή';
$lang['EXCHANGE_NOT'] = 'Η ανταλλαγή δεν είναι διαθέσιμη';
$lang['BONUS_SUCCES'] = 'Το ποσό %s έχει πιστωθεί με επιτυχία στο λογαριασμό σας';
...
$lang['SHOW_TIME_TOPICS'] = 'εμφάνιση χρόνου δημιουργίας θέματος';
$lang['SHOW_CURSOR'] = 'Επισημάνετε τη γραμμή κάτω από τον δρομέα.';

$lang['BT_LOW_RATIO_FOR_DL'] = 'Η αναλογία σας <b>%s</b> είναι πολύ χαμηλή για να κατεβάσετε torrents';
$lang['BT_RATIO_WARNING_MSG'] = 'Εάν η αναλογία σας πέσει κάτω από %s, δεν θα μπορείτε να κατεβάσετε torrents! <a href="%s"><b>Περισσότερα σχετικά με την αναλογία.</b></a>';

$lang['SEEDER_LAST_SEEN'] = 'Seeder δεν έχει δει: <b>%s</b>.';

$lang['NEED_TO_LOGIN_FIRST'] = 'Πρέπει να συνδεθείτε πρώτα';
$lang['ONLY_FOR_MOD'] = 'Αυτή η επιλογή είναι μόνο για συντονιστές';
$lang['ONLY_FOR_ADMIN'] = 'Αυτή η επιλογή είναι μόνο για διαχειριστές';
$lang['ONLY_FOR_SUPER_ADMIN'] = 'Αυτή η επιλογή είναι μόνο για υπερ-διαχειριστές';
...
$lang['ALREADY_REG_IP'] = 'Ένας χρήστης %s είναι ήδη εγγεγραμμένος με τη διεύθυνση IP σας. Εάν δεν έχετε εγγραφεί προηγουμένως στον ανιχνευτή μας, στείλτε email στον <a href="mailto:%s">Διαχειριστή</a>';
$lang['HIDDEN'] = 'Κρυφό';

// from admin
$lang['NOT_ADMIN'] = 'Δεν είστε εξουσιοδοτημένος να διαχειρίζεστε αυτόν τον πίνακα';
...
$lang['NO_POSTS_REMOVED'] = 'Δεν έχουν αφαιρεθεί αναρτήσεις.';
...
$lang['FORUM_S'] = 'στο φόρουμ';
$lang['TRACKER_S'] = 'για ανιχνευτή';
...
$lang['EMPTY_TOPIC_ID'] = 'Λείπει το αναγνωριστικό θέματος';
$lang['TOR_NOT_FOUND'] = 'Το αρχείο λείπει από τον διακομιστή';
$lang['ERROR_BUILD'] = 'Το περιεχόμενο αυτού του torrent δεν μπορεί να εμφανιστεί (αποτυχία δημιουργίας λίστας αρχείων)';
...
$lang['USER_DELETE_ME'] = 'Συγγνώμη, ο λογαριασμός σας δεν μπορεί να διαγραφεί!';
$lang['USER_DELETE_CSV'] = 'Συγγνώμη, αυτός ο λογαριασμός δεν μπορεί να διαγραφεί!';
...
$lang['DELETE_USER_POSTS'] = 'Διαγραφή όλων των δημοσιεύσεων εκτός από την πρώτη σε κάθε θέμα';
$lang['DELETE_USER_POSTS_ME'] = 'Είστε σίγουροι ότι θέλετε να διαγράψετε όλες τις αναρτήσεις μου;';
$lang['DELETE_USER_POSTS_CONFIRM'] = 'Είστε βέβαιοι ότι θέλετε να διαγράψετε όλες τις δημοσιεύσεις εκτός από την πρώτη σε κάθε θέμα;';
...
$lang['INDIVIDUAL'] = 'Έχει ατομικά δικαιώματα';
...
$lang['USER_DEACTIVATE_ME'] = 'Δεν μπορείτε να απενεργοποιήσετε το δικό σας λογαριασμό!';
$lang['ACTIVATE_CONFIRM'] = 'Είστε βέβαιοι ότι θέλετε να ενεργοποιήσετε αυτόν τον χρήστη;';
$lang['USER_ACTIVATE_OFF'] = 'Χρήστη έχει απενεργοποιηθεί με επιτυχία';

// Register
$lang['CHOOSE_A_NAME'] = 'Παρακαλώ επιλέξτε ένα όνομα χρήστη';
$lang['CHOOSE_E_MAIL'] = 'Πρέπει να προσκομίσετε μία διεύθυνση email';
$lang['CHOOSE_PASS'] = 'Το πεδίο κωδικού πρόσβασης δεν πρέπει να είναι κενό!';
...
$lang['CHOOSE_PASS_ERR_LETTER'] = 'Ο κωδικός πρόσβασης πρέπει να περιέχει τουλάχιστον ένα γράμμα από το λατινικό αλφάβητο';
$lang['CHOOSE_PASS_ERR_LETTER_UPPERCASE'] = 'Ο κωδικός πρόσβασης πρέπει να περιέχει τουλάχιστον ένα κεφαλαίο γράμμα από το λατινικό αλφάβητο';
$lang['CHOOSE_PASS_ERR_SPEC_SYMBOL'] = 'Ο κωδικός πρόσβασης πρέπει να περιέχει τουλάχιστον ένα ειδικό χαρακτήρα';
...
$lang['EMAILER_DISABLED'] = 'Συγγνώμη, αυτή η λειτουργία είναι προσωρινά μη διαθέσιμη';
...
$lang['SCREENSHOTS_RULES'] = 'Διαβάστε τους κανόνες δημοσίευσης στιγμιότυπων οθόνης!';
$lang['AJAX_EDIT_OPEN'] = 'Έχετε ήδη ανοιχτή συνεδρία γρήγορης επεξεργασίας!';
...
$lang['DEL_LIST_MY_MESSAGE_INFO'] = 'Μετά την αφαίρεση, η <b>πλήρης λίστα</b> μπορεί να εμφανίζει ακόμα προηγούμενες διαγραμμένες συζητήσεις μέχρι να ανανεωθεί';
$lang['DEL_LIST_INFO'] = 'Για να αφαιρέσετε μια εγγραφή από τη λίστα, κάντε κλικ στο εικονίδιο αριστερά από οποιοδήποτε όνομα τμήματος';

// Watched topics
$lang['WATCHED_TOPICS'] = 'Παρακολουθούμενα θέματα';
$lang['NO_WATCHED_TOPICS'] = 'Δεν παρακολουθείτε κανένα θέμα';
...
$lang['ACTIONS_LOG'] = 'Αρχείο ενέργειών';

// Migrations
$lang['MIGRATIONS_STATUS'] = 'Κατάσταση μετανάστευσης βάσης δεδομένων';
$lang['MIGRATIONS_DATABASE_NAME'] = 'Όνομα βάσης δεδομένων';
$lang['MIGRATIONS_DATABASE_TOTAL'] = 'Συνολικοί Πίνακες';
$lang['MIGRATIONS_DATABASE_SIZE'] = 'Μέγεθος βάσης δεδομένων';
$lang['MIGRATIONS_DATABASE_INFO'] = 'Πληροφορίες βάσης δεδομένων';
$lang['MIGRATIONS_SYSTEM'] = 'Σύστημα Μετανάστευσης';
$lang['MIGRATIONS_NEEDS_SETUP'] = 'Απαιτείται ρύθμιση';
$lang['MIGRATIONS_ACTIVE'] = 'Ενεργό';
$lang['MIGRATIONS_NOT_INITIALIZED'] = 'Μη αρχικοποιημένο';
$lang['MIGRATIONS_UP_TO_DATE'] = 'Όλα ενημερωμένα';
$lang['MIGRATIONS_PENDING_COUNT'] = 'εκκρεμεί';
$lang['MIGRATIONS_APPLIED'] = 'Εφαρμοσμένες Μεταναστεύσεις';
$lang['MIGRATIONS_PENDING'] = 'Εκκρεμείς Μεταναστεύσεις';
$lang['MIGRATIONS_VERSION'] = 'Έκδοση';
$lang['MIGRATIONS_NAME'] = 'Όνομα Μετανάστευσης';
$lang['MIGRATIONS_FILE'] = 'Αρχείο Μετανάστευσης';
$lang['MIGRATIONS_APPLIED_AT'] = 'Εφαρμόστηκε το';
$lang['MIGRATIONS_COMPLETED_AT'] = 'Ολοκληρώθηκε το';
$lang['MIGRATIONS_CURRENT_VERSION'] = 'Τρέχουσα Έκδοση';
$lang['MIGRATIONS_NOT_APPLIED'] = 'Δεν έχουν εφαρμοστεί μεταναστεύσεις';
$lang['MIGRATIONS_INSTRUCTIONS'] = 'Οδηγίες';
$lang['MIGRATIONS_SETUP_STATUS'] = 'Κατάσταση Ρύθμισης';
$lang['MIGRATIONS_SETUP_GUIDE'] = 'Δείτε τον οδηγό ρύθμισης παρακάτω';
...
$lang['ADMIN_SYSTEM_DATABASE_VER'] = 'Βάση δεδομένων:';
$lang['ADMIN_SYSTEM_PHP_MEM_LIMIT'] = 'Όριο μνήμης:';
$lang['ADMIN_SYSTEM_DISK_SPACE_INFO_TITLE'] = 'Πληροφορίες χώρου στο δίσκο:';
$lang['ADMIN_SYSTEM_DISK_SPACE_INFO'] = '%s (χρησιμοποιημένο: %s | διαθέσιμο: %s)';
...
// Robots.txt editor
$lang['ROBOTS_TXT_EDITOR_TITLE'] = 'Διαχείριση robots.txt';
$lang['ROBOTS_TXT_UPDATED_SUCCESSFULLY'] = 'Το αρχείο robots.txt ενημερώθηκε επιτυχώς';
$lang['CLICK_RETURN_ROBOTS_TXT_CONFIG'] = '%sΠατήστε Εδώ για να επιστρέψετε στη διαχείριση του robots.txt%s';
...
$lang['AUTH_POLLCREATE'] = $lang['POLLCREATE'] = 'Δημιουργία ψηφοφορίας';
...
$lang['AUTH_SELF_ERROR'] = 'Δεν μπορέσατε να αλλάξετε τον εαυτό σας από διαχειριστής σε χρήστη';
...
$lang['CATEGORY_NAME_EMPTY'] = 'Όνομα κατηγορίας δεν καθορίστηκε';
...
$lang['LOGIN_RESET_TIME_EXPLAIN'] = 'Χρόνος σε λεπτά που πρέπει να περιμένει ο χρήστης πριν επιτραπεί η νέα σύνδεση μετά από υπέρβαση επιτρεπτού αριθμού προσπαθειών.';
...
$lang['TRACKER_STATS'] = 'Στατιστικά tracker';
$lang['WHOIS_INFO'] = 'Πληροφορίες διεύθυνσης IP';
$lang['SHOW_MOD_HOME_PAGE'] = 'Εμφάνιση συντονιστών στην αρχική σελίδα (index.php)';
$lang['SHOW_BOARD_STARTED_INDEX'] = 'Εμφάνιση ημερομηνίας έναρξης του φόρουμ στο index.php';
$lang['PREMOD_HELP'] = '<h4><span class="tor-icon tor-dup">&#8719;</span> Προ-μέτρηση</h4> <h6>Εάν δεν υπάρχουν torrents με κατάσταση v, # ή T σε αυτήν την ενότητα και τις υποενότητές της, οι νέες διανομές θα λάβουν αυτόματα αυτή την κατάσταση</h6>';
$lang['TOR_COMMENT'] = '<h4>Σχόλιο σχετικά με την κατάσταση μιας διανομής</h4> <h6>Το σχόλιο σας επιτρέπει να επισημάνετε λάθη στην κυκλοφορία. Εάν απαιτούνται διορθώσεις, γίνεται διαθέσιμη μια φόρμα απάντησης στον αποστολέα για να διορθώσει την κυκλοφορία</h6>';
$lang['SEED_BONUS_ADD'] = '<h4>Κανόνες μπόνους σπόρου</h4> <h6>Αριθμός torrents που σπόρινει ο χρήστης και οι αντίστοιχοι πόντοι μπόνους που απονέμονται ανά ώρα</h6>';
$lang['SEED_BONUS_RELEASE'] = 'έως Ν κυκλοφορίες';
$lang['SEED_BONUS_POINTS'] = 'πόντοι μπόνους ανά ώρα';
$lang['SEED_BONUS_TOR_SIZE'] = '<h4>Ελάχιστο μέγεθος torrent για να δικαιούται μπόνους πόντους</h4> <h6>Αφήστε κενό για να δίνεται μπόνους σε όλα τα torrents ανεξαρτήτως μεγέθους.</h6>';
$lang['SEED_BONUS_USER_REGDATA'] = '<h4>Ελάχιστη ηλικία λογαριασμού χρήστη για να δικαιούται πόντους μπόνους</h4> <h6>Αφήστε κενό για να δίνεται μπόνους σε όλους τους χρήστες ανεξαρτήτως ηλικίας λογαριασμού.</h6>';
$lang['SEED_BONUS_WARNING'] = 'ΠΡΟΣΟΧΉ! Μπόνους Σπόρων πρέπει να είναι σε αύξουσα σειρά.';
$lang['SEED_BONUS_EXCHANGE'] = 'Διαμόρφωση ανταλλαγής πόντων σπόρου';
$lang['SEED_BONUS_ROPORTION'] = 'Ισοτιμία: πόντοι μπόνους προς GB πίστωση ανέβασματος';
...
$lang['BT_CHECK_ANNOUNCE_URL_EXPL'] = 'εγγραφή μόνο επιτρεπόμενων URL στον tracker';
...
$lang['QUESTION'] = 'Είστε βέβαιοι ότι θέλετε να εκτελέσετε αυτήν την ενέργεια;';
...
$lang['CRON_EXECUTION_TIME'] = 'Χρόνος εκτέλεσης';
...
$lang['DELETE_JOB'] = 'Είστε βέβαιοι ότι θέλετε να διαγράψετε αυτήν την εργασία cron;';
...
$lang['NOSELECT'] = 'Δεν έχει επιλεχθεί';
$lang['RUN_DAY'] = 'Εκτελέστε την ημέρα.';
$lang['RUN_DAY_EXPL'] = 'η ημέρα που εκτελείται αυτή η εργασία';
$lang['RUN_TIME'] = 'Το χρόνο εκτέλεσης.';
$lang['RUN_TIME_EXPL'] = 'η ώρα που εκτελείται αυτή η εργασία (π.χ. 05:00:00)';
...
$lang['LOG_FILE_EXPL'] = 'το αρχείο για αποθήκευση του αρχείου καταγραφής';
...
$lang['START_OPTION_CONTINUE'] = 'συνέχισε από εκεί που σταμάτησες την τελευταία φορά';
...
$lang['CALLSEED_EXPLAIN'] = 'Ειδοποιήστε τους σπόρους με αίτημα να συνεχίσουν το σπόρισμα αυτής της κυκλοφορίας';
$lang['CALLSEED_SUBJECT'] = 'Χρειάζεται βοήθεια σπορίσματος: %s';
$lang['CALLSEED_TEXT'] = 'Γεια σας![br]Η βοήθειά σας χρειάζεται για την κυκλοφορία [url=%s]%s[/url][br]Εάν θέλετε να βοηθήσετε αλλά έχετε ήδη διαγράψει το αρχείο torrent, μπορείτε να το κατεβάσετε [url=%s]εδώ[/url][br][br]Η βοήθειά σας θα εκτιμηθεί πολύ!';
$lang['CALLSEED_MSG_OK'] = 'Το αίτημα στάλθηκε σε όλους που κατέβασαν αυτήν την κυκλοφορία';
$lang['CALLSEED_MSG_SPAM'] = 'Έχει ήδη σταλεί πρόσφατο αίτημα (πιθανότατα όχι από εσάς).<br /><br />Το επόμενο αίτημα μπορεί να σταλεί στις <b>%s</b>.';
...
$lang['LOG_ACTION']['LOG_TYPE'] = [
    ...
    'mod_topic_set_downloaded' => 'Θέμα:<br /> <b>έχει ρυθμιστεί λήψη</b>',
    'mod_topic_unset_downloaded' => 'Θέμα:<br /> <b>αφαίρεση λήψης</b>',
    'mod_topic_change_tor_status' => 'Θέμα:<br /> <b>αλλαγή κατάστασης torrent</b>',
    'mod_topic_change_tor_type' => 'Θέμα:<br /> <b>αλλαγή τύπου torrent</b>',
    'mod_topic_tor_unregister' => 'Θέμα:<br /> <b>το torrent δεν είναι εγγεγραμμένο</b>',
    'mod_topic_tor_register' => 'Θέμα:<br /> <b>το torrent είναι εγγεγραμμένο</b>',
    'mod_topic_tor_delete' => 'Θέμα:<br /> <b>το torrent διαγράφηκε</b>',
    'mod_topic_renamed' => 'Θέμα:<br /> <b>μετονομασία</b>',
    'mod_topic_poll_started' => 'Θέμα:<br /> <b>η ψηφοφορία ξεκίνησε</b>',
    'mod_topic_poll_finished' => 'Θέμα:<br /> <b>η ψηφοφορία ολοκληρώθηκε</b>',
    ...
    'adm_user_ban' => 'Χρήστης:<br /> <b>απαγορευμένος</b>',
    'adm_user_unban' => 'Χρήστης:<br /> <b>απαγορεύτηκε</b>',
];
...
$lang['TPL_EMPTY_FIELD'] = 'Πρέπει να συμπληρώσετε το πεδίο <b>%s</b>';
$lang['TPL_EMPTY_SEL'] = 'Θα πρέπει να επιλέξετε <b>%s</b>';
$lang['TPL_NOT_NUM'] = '<b>%s</b> - Δεν είναι αριθμός';
...
$lang['SEARCH_FOR_RANK'] = 'Αναζητώντας χρήστες με βαθμό %s';
...
$lang['SEARCH_USERS_LASTVISITED'] = 'Χρήστες που επισκέφθηκαν';
$lang['IN_THE_LAST'] = 'Στα τελευταία.';
$lang['AFTER_THE_LAST'] = 'Μετά την τελευταία.';
$lang['BEFORE'] = 'Πριν.';
$lang['AFTER'] = 'Μετά.';
$lang['SEARCH_USERS_JOINED_EXPLAIN'] = 'Αναζήτηση χρηστών που εγγράφηκαν πριν ή μετά από συγκεκριμένη ημερομηνία. Η μορφή ημερομηνίας είναι ΕΕΕΕ/ΜΜ/ΗΗ.';
$lang['SEARCH_USERS_GROUPS_EXPLAIN'] = 'Δείτε όλα τα μέλη της επιλεγμένης ομάδας.';
$lang['SEARCH_USERS_RANKS_EXPLAIN'] = 'Προβολή όλων των χρηστών με τον επιλεγμένο βαθμό.';
...
$lang['MC_COMMENT_PM_MSG'] = "Γεια σου, [b]%s[/b]\nΈνας συντονιστής άφησε σχόλιο στην ανάρτησή σου [url=%s][b]%s[/b][/url][quote]\n%s\n[/quote]";
$lang['MC_COMMENT'] = [
    0 => [
        'title' => '',
...
// Null ratio
$lang['BT_NULL_RATIO'] = 'Επαναφορά αναλογίας';
$lang['BT_NULL_RATIO_NONE'] = 'Δεν έχετε αναλογία';
$lang['BT_NULL_RATIO_ALERT'] = "Προσοχή!\n\nΕίστε σίγουροι ότι θέλετε να επαναφέρετε την αναλογία σας;";
$lang['BT_NULL_RATIO_AGAIN'] = 'Έχετε ήδη επαναφέρει την αναλογία σας!';
$lang['BT_NULL_RATIO_NOT_NEEDED'] = 'Έχετε καλή αναλογία. Η επαναφορά είναι δυνατή μόνο με αναλογία μικρότερη από %s';
$lang['BT_NULL_RATIO_SUCCESS'] = 'Η αναλογία έχει επαναφερθεί επιτυχώς!';

// Releaser stats
$lang['RELEASER_STAT_SIZE'] = 'Συνολικό μέγεθος:';
$lang['RELEASER_STAT'] = 'Στατιστικά στοιχεία απελευθερωτή:';
...
$lang['TWO_FACTOR_VERIFICATION'] = 'Διπλός έλεγχος ταυτότητας';
$lang['TWO_FACTOR_SECURITY'] = 'Ασφάλεια';
$lang['TWO_FACTOR_AUTH_EXPLAIN'] = 'Προσθέστε ένα επιπλέον επίπεδο ασφάλειας στον λογαριασμό σας χρησιμοποιώντας μια εφαρμογή πιστοποίησης TOTP';
$lang['TWO_FACTOR_ENABLE'] = 'Ενεργοποίηση 2FA';
$lang['TWO_FACTOR_DISABLE'] = 'Απενεργοποίηση 2FA';
$lang['TWO_FACTOR_ENABLED'] = 'Ενεργοποιημένη';
$lang['TWO_FACTOR_DISABLED'] = 'Απενεργοποιημένο';
$lang['TWO_FACTOR_SETUP'] = 'Ρύθμιση διπλού ελέγχου ταυτότητας';
$lang['TWO_FACTOR_SETUP_EXPLAIN'] = 'Σάρωσε αυτόν τον κωδικό QR με την εφαρμογή αυθεντικοποίησής σου (Google Authenticator, Authy, κ.λπ.) ή εισήγαγε το κλειδί χειροκίνητα παρακάτω.';
$lang['TWO_FACTOR_MANUAL_ENTRY'] = 'Ή εισάγετε αυτόν τον κωδικό χειροκίνητα';
$lang['TWO_FACTOR_ENTER_CODE'] = 'Εισάγετε τον 6-ψήφιο κωδικό από την εφαρμογή πιστοποίησής σας';
$lang['TWO_FACTOR_CODE'] = 'Κωδικός πιστοποίησης';
$lang['TWO_FACTOR_VERIFY'] = 'Επαλήθευση';
$lang['TWO_FACTOR_VERIFY_AND_ENABLE'] = 'Επαλήθευση και ενεργοποίηση';
$lang['TWO_FACTOR_INVALID_CODE'] = 'Μη έγκυρος κωδικός. Παρακαλώ δοκιμάστε ξανά.';
$lang['TWO_FACTOR_SESSION_EXPIRED'] = 'Η συνεδρία επαλήθευσης έληξε. Παρακαλώ εισέλθετε ξανά.';
$lang['TWO_FACTOR_SETUP_EXPIRED'] = 'Η συνεδρία ρύθμισης έληξε. Παρακαλώ δοκιμάστε ξανά.';
$lang['TWO_FACTOR_ALREADY_ENABLED'] = 'Η διπλή επαλήθευση είναι ήδη ενεργοποιημένη στον λογαριασμό σας.';
$lang['TWO_FACTOR_NOT_ENABLED'] = 'Η διπλή επαλήθευση δεν είναι ενεργοποιημένη στον λογαριασμό σας.';
$lang['TWO_FACTOR_FEATURE_DISABLED'] = 'Η διπλή επαλήθευση δεν είναι διαθέσιμη';
$lang['TWO_FACTOR_ENABLED_SUCCESS'] = 'Η διπλή επαλήθευση έχει ενεργοποιηθεί';
$lang['TWO_FACTOR_DISABLED_SUCCESS'] = 'Η διπλή επαλήθευση έχει απενεργοποιηθεί';
$lang['TWO_FACTOR_RECOVERY_CODES'] = 'Κωδικοί ανάκτησης';
$lang['TWO_FACTOR_RECOVERY_WARNING'] = 'Αποθηκεύστε αυτούς τους κωδικούς ανάκτησης σε ασφαλές μέρος. Αν χάσετε τη συσκευή πιστοποίησης, μπορείτε να χρησιμοποιήσετε αυτούς τους κωδικούς για να συνδεθείτε.';
$lang['TWO_FACTOR_RECOVERY_EXPLAIN'] = 'Κάθε κωδικός μπορεί να χρησιμοποιηθεί μόνο μία φορά. Αποθηκεύστε τους χωριστά από τη συσκευή σας.';
$lang['TWO_FACTOR_RECOVERY_CODE'] = 'Κωδικός ανάκτησης';
$lang['TWO_FACTOR_ENTER_RECOVERY'] = 'Εισάγετε έναν από τους κωδικούς ανάκτησής σας';
$lang['TWO_FACTOR_USE_RECOVERY'] = 'Χρησιμοποιήστε έναν κωδικό ανάκτησης αντ\' αυτού';
$lang['TWO_FACTOR_USE_TOTP'] = 'Χρησιμοποιήστε κωδικό πιστοποίησης αντ\' αυτού';
$lang['TWO_FACTOR_INVALID_RECOVERY'] = 'Μη έγκυρος κωδικός ανάκτησης. Παρακαλώ δοκιμάστε ξανά.';
$lang['TWO_FACTOR_RECOVERY_CODE_USED'] = 'Ο κωδικός ανάκτησης χρησιμοποιήθηκε. Έχετε %d κωδικούς εναπομείναντες.';
$lang['TWO_FACTOR_REMAINING_CODES'] = 'Έχετε %d κωδικούς ανάκτησης εναπομείναντες';
$lang['TWO_FACTOR_DOWNLOAD_CODES'] = 'Λήψη ως αρχείο κειμένου';
$lang['TWO_FACTOR_RECOVERY_EXPIRED'] = 'Η προβολή των κωδικών ανάκτησης έχει λήξει. Οι κωδικοί σας παραμένουν ενεργοί.';
$lang['TWO_FACTOR_DOWNLOAD_EXPIRED'] = 'Ο σύνδεσμος λήψης έχει λήξει.';
$lang['TWO_FACTOR_DISABLE_WARNING'] = 'Αυτό θα απενεργοποιήσει τον διπλό έλεγχο ταυτότητας στον λογαριασμό σας. Θα χρειαστεί να εισάγετε τον τρέχοντα κωδικό πιστοποίησής σας για επιβεβαίωση.';
$lang['TWO_FACTOR_DISABLE_CONFIRM'] = 'Απενεργοποίηση διπλού ελέγχου ταυτότητας';
$lang['TWO_FACTOR_REGENERATE'] = 'Αναδημιουργία κωδικών ανάκτησης';
$lang['TWO_FACTOR_REGENERATE_WARNING'] = 'Αυτό θα ακυρώσει όλους τους υπάρχοντες κωδικούς ανάκτησης και θα δημιουργήσει νέους.';
$lang['TWO_FACTOR_REGENERATE_CONFIRM'] = 'Αναδημιουργία κωδικών';
$lang['TWO_FACTOR_ADMIN_DISABLE'] = 'Απενεργοποίηση 2FA χρήστη';
$lang['TWO_FACTOR_ADMIN_DISABLE_CONFIRM'] = 'Είστε σίγουρος ότι θέλετε να απενεργοποιήσετε τον διπλό έλεγχο ταυτότητας για αυτόν τον χρήστη;';
$lang['TWO_FACTOR_TOO_MANY_ATTEMPTS'] = 'Πολύς αριθμός αποτυχημένων προσπαθειών. Παρακαλώ δοκιμάστε ξανά σε %d λεπτά.';
$lang['TWO_FACTOR_INVALID_TOKEN'] = 'Μη έγκυρος ή ληγμένος κωδικός.';
$lang['TWO_FACTOR_DONE'] = 'Ολοκληρώθηκε';
$lang['TWO_FACTOR_RECOVERY_ONETIME'] = 'Αυτή η σελίδα μπορεί να προβληθεί μόνο μία φορά. Αν φύγετε, δεν θα μπορείτε να δείτε ξανά αυτούς τους κωδικούς.';
$lang['TWO_FACTOR_ADMIN_DISABLE_SELF'] = 'Δεν μπορείτε να απενεργοποιήσετε τον δικό σας διπλό έλεγχο ταυτότητας από το πάνελ διαχείρισης. Χρησιμοποιήστε τις ρυθμίσεις του προφίλ σας.';
