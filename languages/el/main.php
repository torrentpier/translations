...
$lang['FONT_COLOR'] = 'Το χρώμα της γραμματοσειράς';
...
$lang['NOTIFICATION_SUBJECT'] = 'Έχετε λάβει Νέο Ιδιωτικό Μήνυμα!';
...
$lang['EMAIL_BANNED'] = 'Λυπάμαι, αλλά η διεύθυνση <b>%s</b> έχει απαγορευτεί.';
...
$lang['ATTACH_QUOTA_REACHED'] = 'Συγγνώμη, αλλά το μέγιστο μέγεθος αρχείου για όλα τα Συνημμένα έχει επιτευχθεί. Παρακαλώ επικοινωνήστε με το Διαχειριστή του συστήματος εάν έχετε ερωτήσεις.';
...
// Errors -> PM Related
$lang['ATTACH_QUOTA_SENDER_PM_REACHED'] = 'Συγγνώμη, αλλά το μέγιστο μέγεθος αρχείου για όλα τα Συνημμένα στον Ιδιωτικό Μήνυμα Φάκελο έχει επιτευχθεί. Παρακαλώ διαγράψτε ορισμένα από τα λαμβανόμενα/αποστέλλονται Συνημμένα.';
$lang['ATTACH_QUOTA_RECEIVER_PM_REACHED'] = 'Συγγνώμη, αλλά το μέγιστο μέγεθος αρχείου για όλα τα Συνημμένα στον Ιδιωτικό Μήνυμα Φάκελο του \'%s\' έχει επιτευχθεί. Παρακαλώ ενημερώστε τον, ή περιμένετε μέχρι να διαγράψει κάποια Συνημμένα.';
...
$lang['ATTACHBOX_LIMIT'] = 'Το Attach box σας είναι<br /><b>%d%%</b> γεμάτο';
...
$lang['BT_FLIST_ANNOUNCERS_LIST'] = 'Λίστα αναγγελιών';
$lang['BT_FLIST_ANNOUNCERS'] = 'Αναγγελίες';
$lang['BT_FLIST_ANNOUNCERS_NOTICE'] = 'Αυτή η λίστα περιέχει αναγγελίες αρχείου torrent';
...
$lang['JAVASCRIPT_ON_REGISTER'] = 'Για να εγγραφείτε, πρέπει να ενεργοποιήσετε την JavaScript';
...
$lang['CONFLICT_WARNING'] = 'Προειδοποίηση Σύγκρουσης Εξουσιοδότησης';
...
$lang['FORUM_ADMIN_EXPLAIN'] = 'Από αυτόν τον πίνακα μπορείτε να προσθέσετε, να διαγράψετε, να επεξεργαστείτε, να αλλάξετε τη σειρά και να συγχρονίσετε ξανά τις κατηγορίες και τα φόρουμ';
...
// Attachments -> Sync
$lang['SYNC_THUMBNAIL_RESETTED'] = 'Η προεπισκόπηση έχει επαναφερθεί για το συνημμένο: %s'; // replace %s with physical Filename
...
$lang['DISPLAY_INLINED'] = 'Επίδειξη Εικόνων Inlined';
...
$lang['TIME_LIMIT_EXPLAIN'] = 'Πόσος χρόνος (δευτερόλεπτα) μπορεί να διαρκέσει η επεξεργασία πριν μετακινηθεί στο επόμενο κύκλο';
$lang['TIME_LIMIT_EXPLAIN_SAFE'] = '<i>Η PHP σας (λειτουργία ασφαλείας) έχει οριστεί σε χρονικό όριο %s δευτερολέπτων, έτσι μείνετε κάτω από αυτή την τιμή</i>';
...
$lang['TPL_NOT_NUM'] = '<b>%s</b> - Όχι ένας αριθμός';
...
$lang['SEARCH_FOR_USERFIELD_WEBSITE'] = 'Αναζητώντας χρήστες με μια Ιστοσελίδα που ταιριάζει %s';
...
$lang['ATOM_NO_MODE'] = 'Δεν παρέχεται επιλογή τρόπου για την τροφοδοσία';
