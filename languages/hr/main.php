...
$lang['ERROR_LOGIN'] = 'Korisničko ime koje ste unijeli je netočno ili lozinka nije ispravna.';
...
$lang['MAX_SMILIES_PER_POST'] = 'Limit emotikona od %s prekoračen.';
...
$lang['BIRTHDAY_TO_LOW'] = 'Žao nam je, ova web stranica ne prihvaća korisnike mlađe od %d godina';
...
$lang['EMAIL_EXPLAIN'] = 'Na tu adresu bit će vam poslan formular za dovršetak registracije.';
...
$lang['RESET_AUTOLOGIN_EXPL'] = 'uključujući sva mjesta na kojima ste bili prijavljeni automatski.';
...
$lang['USERNAME_TOO_SMALL'] = 'Žao nam je, ali ovo ime je premalo.';
...
$lang['NO_LIKES'] = 'Nitko još nije dao glas';
...
$lang['TOR_STATUS_NAME'] = [
    ...
    TOR_NEED_EDIT => 'Nije formalizirano do',
...
$lang['TOR_AUTH_SENT_COMMENT'] = 'Informacije su poslane moderatoru. Očekujte.';
...
$lang['BONUS'] = 'Neobično';
$lang['IT_WILL_BE_DOWN'] = 'to se smatra nakon što će biti preuzeto';
$lang['SPMODE_FULL'] = 'Prikaži vršnjacima u svim detaljima';

// Seed Bonus
$lang['MY_BONUS'] = 'Moj bonus (%s bonusa na lageru)';
$lang['BONUS_SELECT'] = 'Odaberite';
$lang['SEED_BONUS'] = 'Bonus sjemena';
$lang['EXCHANGE'] = 'Razmjena';
$lang['EXCHANGE_BONUS'] = 'Razmjena sjemenskih bonusa';
$lang['BONUS_UPLOAD_DESC'] = '<b>%s za distribuciju</b> <br /> Za razmjenu bonus bodova za %1$s promet koji će se dodati na vaš ukupni iznos distribucije.';
...
$lang['BT_LOW_RATIO_FOR_DL'] = "S koeficijentom <b>%s</b> ne možete preuzeti torrente";
$lang['BT_RATIO_WARNING_MSG'] = 'Ako vaš koeficijent padne ispod %s, nećete moći preuzeti torrente! <a href="%s"><b>Više o koeficijentu.</b></a>';
...
$lang['BAN_USER'] = 'Kako bi se spriječio korisnika.';
...
$lang['DELETE_USER_POSTS_CONFIRM'] = 'Jeste li sigurni da želite izbrisati sve poruke, osim prvih postova?';
...
$lang['USER_DEACTIVATE_ME'] = 'Ne možete isključiti svoj račun!';
$lang['ACTIVATE_CONFIRM'] = 'Jeste li sigurni da želite onemogućiti ovog korisnika?';
...
$lang['SCREENSHOTS_RULES'] = 'Pročitajte pravila o postavljanju screenshotova!';
$lang['AJAX_EDIT_OPEN'] = 'Već ste otvorili brzu izmjenu!';
...
$lang['DL_PERCENT'] = 'Popunite postotak';
$lang['DL_UL'] = 'UL';
$lang['DL_DL'] = 'DL';
...
$lang['DEL_LIST_MY_MESSAGE_INFO'] = 'Nakon uklanjanja, prije ažuriranja <b>cijeli popis</b> mogu biti već prikazane obrisane teme';
$lang['DEL_LIST_INFO'] = 'Da biste izbrisali redoslijed s popisa, kliknite na ikonu lijevo od naziva bilo kojeg odjeljka';

// Watched topics
$lang['WATCHED_TOPICS'] = 'Praćene teme';
$lang['NO_WATCHED_TOPICS'] = 'Ne pratite teme';
...
$lang['ACTIONS_LOG'] = 'Izvještaj o akciji';
...
$lang['AUTH_POLLCREATE'] = $lang['POLLCREATE'] = 'Izraditi anketu';
...
$lang['AUTH_SELF_ERROR'] = 'Nije moguće promijeniti se iz administratora u korisnika';
...
$lang['SMILIES_PATH_EXPLAIN'] = 'Put pod vašim TorrentPier korijenskim direktorijem, npr. stilovi/slike/nasmijana';
...
$lang['LOGIN_RESET_TIME_EXPLAIN'] = 'Vrijeme u minutama koje korisnik treba čekati da se ponovno prijavi nakon prekoračenja broja pokušaja.';
...
$lang['PREMOD_HELP'] = '<h4><span class="tor-icon tor-dup">&#8719;</span> pre-moderacija</h4> <h6>Ako nemate distribucije sa statusima v, # ili t u ovoj sekciji, uključujući podsekcije, distribucija će automatski dobiti taj status.</h6>';
...
$lang['SEED_BONUS_ADD'] = '<h4>Dodavanje bonusa za sjeme</h4> <h6> Broj distribucija koje je izdao korisnik i veličina bonusa za njih (naplaćivanje po satu) </h6>';
$lang['SEED_BONUS_RELEASE'] = 'N-broj izdanja';
$lang['SEED_BONUS_POINTS'] = 'bonus na sat';
$lang['SEED_BONUS_TOR_SIZE'] = '<h4>Minimalna distribucija za koju će se dodijeliti bonusi</h4> <h6> Ako želite izračunati bonuse za sve distribucije, ostavite prazno. </h6>';
$lang['SEED_BONUS_USER_REGDATA'] = '<h4>Minimalna dužina korisničkog trackera, nakon koje će se dodijeliti bonusi</h4> <h6> Ako želite dodijeliti bonuse svim korisnicima, ostavite prazno. </h6>';
...
$lang['BT_CHECK_ANNOUNCE_URL_EXPL'] = 'Registrirajte se samo na dopuštene URL adrese.';
...
$lang['DELETE_JOB'] = 'Jeste li sigurni da želite da uklonite zakazanu radnju?';
...
$lang['RUN_DAY_EXPL'] = 'dan kada se ovaj posao izvršava.';
$lang['RUN_TIME'] = 'Vrijeme izvođenja';
$lang['RUN_TIME_EXPL'] = 'vrijeme kada se izvršava taj zadatak (na primjer, 05:00:00).';
...
$lang['START_OPTION_CONTINUE'] = 'nastavite s posljednje prekid';
...
$lang['CALLSEED'] = 'Pozovi seede.';
$lang['CALLSEED_EXPLAIN'] = 'Obavijestite nas sa zahtjevom da se vratite na distribuciju.';
$lang['CALLSEED_SUBJECT'] = 'Preuzmi pomoć %s';
$lang['CALLSEED_TEXT'] = 'Pozdrav![br]Vaša pomoć potrebna je za izlaz [url=%s]%s[/url][br]Ako se odlučite pomoći, ali ste već obrisali torrent datoteku, možete je preuzeti [url=%s]ovdje[/url][br][br]Nadam se u vašu pomoć!';
$lang['CALLSEED_MSG_OK'] = 'Poruka poslana svima onima koji su preuzeli ovo izdanje';
$lang['CALLSEED_MSG_SPAM'] = 'Zahtjev je već jednom uspješno poslan (vjerojatno ne vi)<br /><br />Sljedeća prilika da pošaljete zahtjev će biti <b>%s</b>.';
...
$lang['LOG_ACTION']['LOG_TYPE'] = [
    ...
    'adm_user_ban' => 'Korisnika:<br /> <b>zabranjen</b>',
    'adm_user_unban' => 'Korisnika:<br /> <b>uklonjen iz zabrane</b>',
];
...
$lang['SEARCH_FOR_RANK'] = 'Pretraživanje nositelja ranga %s';
...
$lang['MC_COMMENT_PM_MSG'] = "Bok, [b]%s[/b]\nModerator je ostavio u vašoj poruci [url=%s][b]%s[/b][/url][quote]\n%s\n[/quote]";
$lang['MC_COMMENT'] = [
    0 => [
        'title' => '',
...
$lang['CAPTCHA_SETTINGS'] = '<h2>Captcha nije potpuno konfigurirana</h2><p>Generirajte ključeve koristeći nadzornu ploču vaše captcha usluge, nakon što ih trebate staviti u datoteku library/config.php.</p>';
