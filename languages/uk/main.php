...
$lang['ATTACHBOX_LIMIT'] = 'Ваш ящик вкладень заповнено на <b>%d%%</b>';
...
$lang['BT_FLIST_ANNOUNCERS_LIST'] = 'Список анонсерів';
$lang['BT_FLIST_ANNOUNCERS'] = 'Анонсери';
$lang['BT_FLIST_ANNOUNCERS_NOTICE'] = 'Цей список містить анонсерів торрент-файлу';
...
$lang['TOR_TYPE_LOG_ACTION'] = 'Тип торрента зміненостому: %s';
...
$lang['JAVASCRIPT_ON_REGISTER'] = 'Для реєстрації потрібно включити JavaScript';
...
// Attachments -> Sync
$lang['SYNC_THUMBNAIL_RESETTED'] = 'Попередній перегляд було скинуто для вкладення: %s'; // replace %s with physical Filename
...
$lang['TIME_LIMIT_EXPLAIN_SAFE'] = '<i>Ваш PHP (safe mode) має тайм-аут %s секунд, тому залишайтеся нижче цього значення</i>';
