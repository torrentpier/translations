...
$lang['NO_ITEMS'] = 'Daar lyk dit of daar geen data hier is nie...';
$lang['PLEASE_TRY_AGAIN'] = 'Probeer asseblief weer na \'n paar sekondes...';
...
$lang['ADMIN_DISABLE'] = 'Die forum is gedeaktiveer deur die administrateur. Jy kan dit enige tyd aktiveer.';
$lang['ADMIN_DISABLE_CRON'] = 'Forum gesluit deur die cron taak. Jy kan die sluiting enige tyd verwyder';
...
// Login
$lang['ENTER_PASSWORD'] = 'Voer asseblief jou gebruikersnaam en wagwoord in om aan te meld.';
...
$lang['ERROR_LOGIN'] = 'Die gebruikersnaam of wagwoord wat jy ingevoer het, is verkeerd.';
...
$lang['DONT_MESSAGE_TITLE'] = 'Jy moet \'n boodskaptitel spesifiseer';
$lang['INVALID_TOPIC_ID'] = 'Onderwerp nie gevind nie!';
$lang['INVALID_TOPIC_ID_DB'] = 'Onderwerp bestaan ​​nie in die databasis nie!';

$lang['NOT_EDIT_TOR_STATUS'] = 'Jy kan nie vrystelling met hierdie status wysig nie';
...
$lang['MAX_SMILIES_PER_POST'] = 'Beperking van emosiekon van %s oorskry.';
...
$lang['NO_SUCH_FOLDER'] = 'Gid nie gevind nie';
...
$lang['ADD_RETRACKER'] = 'Voeg retracker by torrent-lêers';
...
$lang['AGE'] = 'ouderdom';
$lang['BIRTHDAY_TO_HIGH'] = 'Jammer, hierdie webwerf aanvaar nie gebruikers ouer as %d jaar nie';
$lang['BIRTHDAY_TO_LOW'] = 'Jammer, hierdie webwerf aanvaar nie gebruikers jonger as %d jaar nie';
...
$lang['NOBIRTHDAY_WEEK'] = 'Geen gebruikers verjaar in die komende %d dae nie'; // %d is substituted with the number of days
...
$lang['SIGNATURE_DISABLE'] = 'Handtekening gedeaktiveer weens oortreding van forumreëls';
$lang['PUBLIC_VIEW_EMAIL'] = 'Wys e-pos adres in my profiel';

$lang['EMAIL_EXPLAIN'] = '\'n Verifikasie-e-pos sal na hierdie adres gestuur word om jou registrasie te voltooi';
...
$lang['RESET_AUTOLOGIN_EXPL'] = 'dit sal jou uitteken van alle toestelle waar outomatiese aanmelding aangeskakel is';
...
$lang['AVATAR_DISABLE'] = 'Avatar-oplaai gedeaktiveer weens oortreding van <a href="%s"><b>forumreëls</b></a>';
...
$lang['USERNAME_TOO_LONG'] = 'Jou gebruikersnaam is te lank.';
$lang['USERNAME_TOO_SMALL'] = 'Jou gebruikersnaam is te kort.';
...
// Thanks
$lang['THANK_TOPIC'] = 'Stem vir hierdie onderwerp';
$lang['THANKS_GRATITUDE'] = 'Ons waardeer jou erkenning';
$lang['LAST_LIKES'] = 'Laaste stemme';
$lang['LIKE_OWN_POST'] = 'Jy kan nie vir jou eie onderwerp stem nie';
$lang['NO_LIKES'] = 'Niemand het nog gestem nie';
$lang['LIKE_ALREADY'] = 'Jy het reeds vir hierdie onderwerp gestem';

// Invites
$lang['INVITE_CODE'] = 'Uitnodigingskode';
$lang['INCORRECT_INVITE'] = 'Uitnodiging nie gevind nie';
$lang['INVITE_EXPIRED'] = 'Uitnodiging het verval';
...
$lang['GROUP_JOINED'] = 'Jy het suksesvol aansoek gedoen om by hierdie groep aan te sluit.<br />Jy sal geïnformeer word wanneer jou lidmaatskap deur die groepsmodereerder goedgekeur word.';
...
$lang['UNSUB_SUCCESS'] = 'U is van hierdie groep af geskakel.';
...
// Country selector
$lang['COUNTRY'] = 'Land';
$lang['SET_OWN_COUNTRY'] = 'Stel eie land in (Handmatig)';
...
$lang['STREAM'] = 'Stroom';
$lang['RESOLUTION'] = 'Resolusie: <b>%s</b>';
$lang['CHANNELS'] = 'Kaneel: <b>%s</b>';
$lang['CHANNELS_LAYOUT'] = 'Kaneel-indeling: <b>%s</b>';
$lang['BITRATE'] = 'Bitrate: <b>%s</b>';
$lang['SAMPLE_RATE'] = 'Monster tempo: <b>%s</b>';
$lang['AUDIO_TRACK'] = 'Klankbaan-inligting (%d):';
$lang['AUDIO_CODEC'] = 'Klankkodek: <b title="%s">%s</b>';
$lang['VIDEO_CODEC'] = 'Video kodek: <b title="%s">%s</b>';
$lang['SHOW_MORE_INFORMATION_FILE'] = 'Wys meer inligting oor hierdie lêer';
$lang['DOWNLOAD_M3U_FILE'] = 'Laai .m3u-lêer af';
$lang['PLAYBACK_M3U'] = 'Speel .m3u-lêer af';
$lang['COPY_STREAM_LINK'] = 'Kopieer stroomskakel na klembord';
...
$lang['BT_REG_FAIL_SAME_HASH'] = 'Nog \'n torrent met dieselfde info_hash is reeds <a href="%s"><b>geregistreer</b></a>';
...
$lang['PASSKEY_ERR_TOR_NOT_REG'] = 'Kon nie passkey<br /><br />Torrent nie op spoorsnyer geregistreer nie.';
$lang['BT_PASSKEY'] = 'passkey';
$lang['BT_GEN_PASSKEY'] = 'Skep \'n nuwe';
$lang['BT_PASSKEY_VIEW'] = 'Wys';
$lang['BT_GEN_PASSKEY_NEW'] = "Aandag! Na die verandering van jou pas sleutel, sal jy al die aktiewe torrents weer moet aflaai!\nIs jy seker jy wil 'n nuwe pas sleutel skep?";
...
$lang['TOR_STATUS_NOT_SELECT'] = 'Jy het nie \'n status gekies nie.';
$lang['TOR_STATUS_SELECT_ALL'] = 'Alle statuses';
$lang['TOR_STATUS_FORBIDDEN'] = 'Die status van hierdie onderwerp is: ';
$lang['TOR_STATUS_NAME'] = [
    TOR_NOT_APPROVED => 'Nie nagegaan nie',
    TOR_CLOSED => 'gesluit',
    TOR_APPROVED => 'nagegaan',
    TOR_NEED_EDIT => 'moet geredigeer word',
    TOR_NO_DESC => 'onvolledig',
    TOR_DUP => 'duplikaat',
    TOR_CLOSED_CPHOLD => 'gesluit (kopiereg)',
    TOR_CONSUMED => 'geabsorbeer',
    TOR_DOUBTFUL => 'twyfelagtig',
    TOR_CHECKING => 'word nagegaan',
    TOR_TMP => 'tydelike',
    TOR_PREMOD => 'pre-moderering',
    TOR_REPLENISH => 'aanvulling',
];
$lang['TOR_STATUS_FAILED'] = 'Hierdie status bestaan nie!';
$lang['TORRENT_FAILED'] = 'Verspreiding is nie gevind nie!';
$lang['TOR_STATUS_DUB'] = 'Verspreiding het dieselfde status';
$lang['TOR_DONT_CHANGE'] = 'Statusverandering kan nie uitgevoer word nie!';
$lang['TOR_STATUS_OF'] = 'Verspreiding het die status van:';
$lang['TOR_STATUS_CHANGED'] = 'Status verander:';
$lang['TOR_BACK'] = 'terug';
$lang['PROCEED'] = 'Voortgaan';
$lang['CHANGE_TOR_TYPE'] = 'Torrent-tipe is suksesvol verander';
...
$lang['UNEXECUTED_RELEASE'] = 'Jy het \'n onafgehandelde vrystelling. Voordat jy \'n nuwe een skep, voltooi dit asseblief!';
$lang['TOR_STATUS_LOG_ACTION'] = 'Nuwe status: %s.<br/>Vorige status: %s.';

// tor_comment
$lang['TOR_MOD_TITLE'] = 'Verspreidingsstatus verander – %s';
$lang['TOR_MOD_MSG'] = "Hallo, %s.\n\nDie status van [url=%s]jou[/url] verspreiding is verander na [b]%s[/b]";

$lang['TOR_AUTH_TITLE'] = 'Opmaakveranderings versoek – %s';
$lang['TOR_AUTH_MSG'] = "Hallo, %s.\n\nJou verspreiding is verander - [url=%s]%s[/url]\n\nKontroleer asseblief weer.";
$lang['TOR_AUTH_FIXED'] = 'Vas!';
$lang['TOR_AUTH_SENT_COMMENT'] = ' &middot; <span class="seed bold">Die inligting is na die modereerder gestuur. Wag asseblief vir \'n reaksie.</span>';
...
$lang['UNSET_GOLD_TORRENT'] = 'Verwyder goue status';
$lang['SET_SILVER_TORRENT'] = 'Maak silwer';
$lang['UNSET_SILVER_TORRENT'] = 'Verwyder silwer status';
$lang['GOLD_STATUS'] = 'GOEWE TORRENT! AFLaAI-VERKEER WORD NIE GETEL NIE!';
$lang['SILVER_STATUS'] = 'SILWER TORRENT! AFLaAI-VERKEER WORD DEELWYS GETEL!';
...
$lang['GO_TO_SECTION'] = 'Gaan na afdeling.';
$lang['TORRENTS_FROM'] = 'Boodskappe van';
$lang['SHOW_ONLY'] = 'Wys net';
$lang['SHOW_COLUMN'] = 'Wys kolom';
$lang['SEL_CHAPTERS'] = 'Skakel na geselekteerde afdelings';
$lang['NOT_SEL_CHAPTERS'] = 'Jy het geen onderwerpe gekies nie';
$lang['SEL_CHAPTERS_HELP'] = 'Jy kan maksimum %s afdelings kies';
...
$lang['NOT_TORRENT'] = 'Hierdie lêer is nie \'n torrent nie';
...
$lang['BONUS'] = 'Bonus';
$lang['IT_WILL_BE_DOWN'] = 'sal getel word sodra afgelaai';
$lang['SPMODE_FULL'] = 'Wys eweknieë in volledige besonderhede';

// Seed Bonus
$lang['MY_BONUS'] = 'My bonus (%s punte beskikbaar)';
$lang['BONUS_SELECT'] = 'Kies';
$lang['SEED_BONUS'] = 'Saadbonus';
$lang['EXCHANGE'] = 'ruil';
$lang['EXCHANGE_BONUS'] = 'Saai bonusruiling';
$lang['BONUS_UPLOAD_DESC'] = '<b>+%s oplaai-krediet</b> <br /> Ruile bonuspunte vir %1$s oplaai-verkeer wat by jou rekening totaal gevoeg word.';
$lang['BONUS_UPLOAD_PRICE'] = '<b class="%s">%s</b>';
$lang['PRICE'] = 'prys';
$lang['EXCHANGE_NOT'] = 'Ruile is nie beskikbaar nie';
$lang['BONUS_SUCCES'] = '%s is suksesvol by jou rekening gekrediteer';
...
$lang['RANDOM_RELEASE'] = 'Toevalige vrystelling';
$lang['OPEN_TOPICS'] = 'Open onderwerpe';
$lang['OPEN_IN_SAME_WINDOW'] = 'Oop in dieselfde venster';
$lang['SHOW_TIME_TOPICS'] = 'wys onderwerp se skeppingstyd';
$lang['SHOW_CURSOR'] = 'Merk die ry onder die wyser';

$lang['BT_LOW_RATIO_FOR_DL'] = 'Jou verhouding van <b>%s</b> is te laag om torrents af te laai';
$lang['BT_RATIO_WARNING_MSG'] = 'As jou verhouding onder %s val, kan jy nie torrents aflaai nie! <a href="%s"><b>Meer oor verhouding.</b></a>';

$lang['SEEDER_LAST_SEEN'] = 'Saaier nie gesien nie: <b>%s</b>';

$lang['NEED_TO_LOGIN_FIRST'] = 'Jy moet eers inteken';
$lang['ONLY_FOR_MOD'] = 'Hierdie opsie is slegs vir modereerders';
$lang['ONLY_FOR_ADMIN'] = 'Hierdie opsie is slegs vir administrateurs';
$lang['ONLY_FOR_SUPER_ADMIN'] = 'Hierdie opsie is slegs vir super administrateurs';

$lang['LOGS'] = 'Onderwerpgeskiedenis';
$lang['FORUM_LOGS'] = 'Forumgeskiedenis';
...
$lang['ALREADY_REG_IP'] = '‘n gebruiker %s is reeds geregistreer met jou IP adres. As jy nog nie voorheen op ons dop geregistreer het nie, e-pos die <a href="mailto:%s">Administrateur</a>';
...
$lang['NO_POSTS_REMOVED'] = 'Geen plasings is verwyder nie.';
...
$lang['BOT_REASON_MOVED'] = 'Rede om te skuif';
$lang['BOT_AFTER_SPLIT_TO_OLD'] = 'Voeg bot-boodskap oor verdeel na <b>old onderwerp</b>';
$lang['BOT_AFTER_SPLIT_TO_NEW'] = 'Voeg bot-boodskap oor verdeel na <b>nuwe onderwerp</b>.';
//qr
...
// search
$lang['SEARCH_S'] = 'Soek...';
$lang['FORUM_S'] = 'op die forum';
$lang['TRACKER_S'] = 'op die dop';
$lang['HASH_S'] = 'Deur info_hash';

// copyright
$lang['NOTICE'] = '! AANDAG!';
$lang['COPY'] = 'Die webwerf bied nie elektroniese weergawes van produkte aan nie, en is slegs betrokke by die versameling en katalogisering van die verwysings wat deur ons lesers gestuur en gepubliseer word op die forum. As jy die regmatige eienaar van enige ingediende materiaal is en nie wil hê dat die verwysing daarvan in ons katalogus moet verskyn nie, kontak ons en ons sal dit onmiddellik verwyder. Lêers vir uitruil op die dop word deur gebruikers van die webwerf voorsien, en die administrasie dra nie verantwoordelikheid vir hulle inhoud nie. Moet asseblief nie lêers wat deur outeursreg beskerm word, of lêers met onwettige inhoud op laai nie!';
...
$lang['ERROR_BUILD'] = 'Die inhoud van hierdie torrent kan nie vertoon word nie (kon nie lêerlys bou nie)';
$lang['TORFILE_INVALID'] = 'Torrent-lêer is korrup';

// Profile
$lang['WEBSITE_ERROR'] = 'Die "webwerf" mag slegs http://sitenaam bevat.';
$lang['PROFILE_USER'] = 'Kyk na profiel';
$lang['GOOD_UPDATE'] = 'suksesvol opgedateer';
$lang['UCP_DOWNLOADS'] = 'aflaaie.';
$lang['HIDE_DOWNLOADS'] = 'Versteek die huidige lys van aflaaie op jou profiel';
$lang['BAN_USER'] = 'Gebruikersbeperkings';
...
$lang['USER_DELETE_ME'] = 'Jammer, jou rekening kan nie verwyder word nie!';
$lang['USER_DELETE_CSV'] = 'Jammer, hierdie rekening kan nie verwyder word nie!';
...
$lang['DELETE_USER_POSTS'] = 'Verwyder alle plasings behalwe die eerste plasing in elke onderwerp';
$lang['DELETE_USER_POSTS_ME'] = 'Is jy seker jy wil al my plasings uitvee?';
$lang['DELETE_USER_POSTS_CONFIRM'] = 'Is jy seker jy wil alle plasings verwyder behalwe die eerste plasing in elke onderwerp?';
...
$lang['INDIVIDUAL'] = 'Het individuele regte';
...
$lang['DEACTIVATE_CONFIRM'] = 'Is jy seker jy wil hierdie gebruiker deaktiver?';
$lang['USER_ACTIVATE_ON'] = 'Gebruiker is suksesvol geaktiveer';
$lang['USER_DEACTIVATE_ME'] = 'Jy kan nie jou eie rekening deaktiveer nie!';
$lang['ACTIVATE_CONFIRM'] = 'Is jy seker jy wil hierdie gebruiker aktiveer?';
$lang['USER_ACTIVATE_OFF'] = 'Gebruiker is suksesvol gedeaktiveer';

// Register
$lang['CHOOSE_A_NAME'] = 'Kies asseblief \'n gebruikersnaam';
$lang['CHOOSE_E_MAIL'] = 'Jy moet \'n e-posadres verskaf';
$lang['CHOOSE_PASS'] = 'Die wagwoordveld mag nie leeg wees nie!';
...
$lang['CHOOSE_PASS_ERR_MAX'] = 'Jou wagwoord moet nie langer wees as %d karakters nie';
$lang['CHOOSE_PASS_ERR_NUM'] = 'Die wagwoord moet ten minste een syfer bevat';
$lang['CHOOSE_PASS_ERR_LETTER'] = 'Die wagwoord moet ten minste een letter van die Latynse alfabet bevat';
$lang['CHOOSE_PASS_ERR_LETTER_UPPERCASE'] = 'Die wagwoord moet ten minste een hoofletter van die Latynse alfabet bevat';
$lang['CHOOSE_PASS_ERR_SPEC_SYMBOL'] = 'Die wagwoord moet ten minste een spesiale karakter bevat';
...
$lang['EMAILER_DISABLED'] = 'Jammer, hierdie funksie is tydelik onbeskikbaar';
...
$lang['YOUR_NEW_PASSWORD'] = 'U nuwe wagwoord:';
...
$lang['EXPLAINED_LOG'] = 'Verklaring log';
$lang['CUT_LOG'] = 'Sny lang navrae';
...
$lang['SCREENSHOTS_RULES'] = 'Lees die reël oor die plasing van skermkiekies!';
$lang['AJAX_EDIT_OPEN'] = 'Jy het reeds \'n vinnige redigering sessie oop!';
...
$lang['BOX_TAG'] = 'Raam om teks: [box]teks[/box] of [box=#333,#888]teks[/box]';
$lang['INDENT_TAG'] = 'Voeg inspringing in: [indent]teks[/indent]';
$lang['PRE_TAG'] = 'Vooraf opgemaakte teks: [pre]teks[/pre]';
$lang['NFO_TAG'] = 'NFO: [nfo]teks[/nfo]';
$lang['SUPERSCRIPT'] = 'Superskrif teks: [sup]teks[/sup]';
$lang['SUBSCRIPT'] = 'Subskrip teks: [sub]teks[/sub]';
...
$lang['ACRONYM'] = 'Akroniem';
$lang['ACRONYM_TITLE'] = 'Akroniem: [acronym=Volledige teks]Kort teks[/acronym]';
$lang['QUOTE_SEL'] = 'Quote selected text must be exactly as per original.';
$lang['JAVASCRIPT_ON'] = 'JavaScript moet geaktiveer wees om boodskappe te stuur';
...
$lang['DL_PORT'] = 'Port';
$lang['DL_CLIENT'] = 'BitTorrent kliënt';
...
$lang['HIDE_PEER_USERNAME'] = 'Versteek my gebruikersnaam in peer lys';

// Post PIN
$lang['POST_PIN'] = 'Plak eerste plasing';
$lang['POST_UNPIN'] = 'Unpin first post needs accurate translation.';
$lang['POST_PINNED'] = 'First post pinned needs to reflect the action correctly.';
$lang['POST_UNPINNED'] = 'First post unpinned should be accurate.';
...
$lang['DEL_LIST_MY_MESSAGE_INFO'] = 'Na verwydering kan die <b>volledige lys</b> steeds voorheen verwyderde drade vertoon totdat dit verfris is';
$lang['DEL_LIST_INFO'] = 'Om \'n inskrywing van die lys te verwyder, klik die ikoon links van enige afdeling se naam';

// Watched topics
$lang['WATCHED_TOPICS'] = 'Watched topics should be more accurately translated.';
$lang['NO_WATCHED_TOPICS'] = 'Geen onderwerpe word gekyk nie';
...
$lang['INDEXER_SUCCESS'] = 'Soekindeks was suksesvol bygewerk';
...
$lang['MANAGE'] = 'bestuur';
$lang['DISALLOW'] = 'Disallow names translation needs accuracy.';
$lang['PRUNE'] = 'snoei';
...
$lang['MIGRATIONS_UP_TO_DATE'] = 'Alle op datum';
$lang['MIGRATIONS_PENDING_COUNT'] = 'hangende';
$lang['MIGRATIONS_APPLIED'] = 'Toegepaste Migrasies';
$lang['MIGRATIONS_PENDING'] = 'Hangende Migrasies';
$lang['MIGRATIONS_VERSION'] = 'Weergawe';
$lang['MIGRATIONS_NAME'] = 'Migrasie Naam';
$lang['MIGRATIONS_FILE'] = 'Migrasie Lêer';
...
$lang['MIGRATIONS_ACTION_REQUIRED'] = 'Aksie Vereis';
...
$lang['PHP_INFO'] = 'PHP-inligting';

$lang['CLICK_RETURN_ADMIN_INDEX'] = 'Klik %sHier%s om terug te keer na die Administrasie-indeks';
...
// System information
$lang['ADMIN_SYSTEM_INFORMATION'] = 'Stelselinligting';
$lang['ADMIN_SYSTEM_OS'] = 'OS:';
$lang['ADMIN_SYSTEM_PHP_VER'] = 'PHP:';
$lang['ADMIN_SYSTEM_DATABASE_VER'] = 'Databasis:';
$lang['ADMIN_SYSTEM_PHP_MEM_LIMIT'] = 'Geheimegrens:';
$lang['ADMIN_SYSTEM_DISK_SPACE_INFO_TITLE'] = 'Skyfruimte-inligting:';
$lang['ADMIN_SYSTEM_DISK_SPACE_INFO'] = '%s (gebruik: %s | vry: %s)';
...
// Robots.txt editor
$lang['ROBOTS_TXT_EDITOR_TITLE'] = ' bestuur robots.txt';
$lang['ROBOTS_TXT_UPDATED_SUCCESSFULLY'] = 'Lêer robots.txt is suksesvol opgedateer';
$lang['CLICK_RETURN_ROBOTS_TXT_CONFIG'] = '%sKlik Hier om terug te keer na robots.txt bestuurder%s';
...
$lang['AUTH_POLLCREATE'] = $lang['POLLCREATE'] = 'Skep peiling';
...
$lang['AUTH_SELF_ERROR'] = 'Kon nie jouself van administrateur na gebruiker verander nie';
$lang['NO_FORUMS_AVAILABLE'] = 'Geen forums beskikbaar nie. Skep forums eerstens om regte te bestuur.';
...
// Banning
$lang['BAN_CONTROL'] = 'Banbeheer';
$lang['BAN_EXPLAIN'] = 'Hier kan jy die ban van gebruikers beheer.';
$lang['BAN_USERNAME'] = 'Verbied een of meer spesifieke gebruikers';
$lang['UNBAN_USERNAME'] = 'Ontban een of meer spesifieke gebruikers';
...
$lang['NO_BANNED_USERS'] = 'Geen verbode gebruikers.';
...
$lang['FORUMS_DISABLE'] = 'Deaktiveer Forum.';
...
$lang['ABILITIES_SETTINGS'] = 'Gebruikers en Forum Basiese Instellings.';
...
$lang['SMILIES_PATH_EXPLAIN'] = 'Pad onder jou TorrentPier openbare gids, bv. assets/images/smiles';
...
$lang['EXPORT_SMILES'] = 'Om \'n smileyspak uit jou geïnstalleerde smileys te skep, klik %sHier%s om die glimlag.pak-lêer af te laai. Noem hierdie lêer op toepaslike wyse om die .pak lêeruitbreiding te behou. Maak dan \'n zip-lêer met al jou smiley beelde plus hierdie .pak konfigurasie lêer.';
...
$lang['GROUP_ADMIN_EXPLAIN'] = 'Vanuit hierdie paneel kan u al u gebruikersgroepe administreer. U kan bestaande groepe uitvee, skep en redigeer. U kan moderators kies, oop/geslote groepstatus skakel en stel die groep naam en beskrywing in.';
...
$lang['PRUNE_TOPICS_NOT_POSTED'] = 'Snoei onderwerpe met geen antwoord in hierdie aantal dae';
$lang['TOPICS_PRUNED'] = 'Onderwerpe gesnoei';
$lang['PRUNE_SUCCESS'] = 'Forum is suksesvol gesnoei';
$lang['NOT_DAYS'] = 'Snoei dae nie gekies nie';

// Word censor
$lang['WORDS_TITLE'] = 'Woordsensorering';
$lang['WORDS_EXPLAIN'] = 'Vanuit hierdie kontrolepaneel kan u woorde byvoeg, wysig en verwyder wat outomaties gesensoriseer word op u forums. Daarbenewens sal mense nie toegelaat word om te registreer met gebruikersname wat hierdie woorde bevat nie. Wildcards (*) word aanvaar in die woordveld. Byvoorbeeld, *test* sal ooreenstem met detestable, test* sal ooreenstem met testing, *test sal ooreenstem met detest.';
$lang['WORD'] = 'woord';
...
$lang['STYLE_COLOR_FAQ'] = 'Spesifiseer \'n klas om die titel met die verlangde kleur te styl. Byvoorbeeld: <i class="bold">colorAdmin</i>';
...
$lang['LOGIN_RESET_TIME_EXPLAIN'] = 'Tyd in minute wat die gebruiker moet wag voordat hy weer kan aanmeld nadat hy die toegelate aantal aanmeldpogings oorskry het.';
...
$lang['FORUM_AUTH_LIST_EXPLAIN_PRIVATE'] = 'The translation is incorrect and does not accurately reflect the meaning of the original text.';
...
$lang['FORUM_AUTH_LIST_EXPLAIN_AUTH_REPLY'] = '%s kan op plasings in hierdie forum antwoord gee';
...
$lang['SYNC'] = 'This term should be replaced with an appropriate Afrikaans equivalent.';

// Mods
$lang['MAX_NEWS_TITLE'] = 'Max. nuustitel lengte';
...
$lang['TRACKER_STATS'] = 'Trackerstatistiek';
$lang['WHOIS_INFO'] = 'IP-adres inligting';
$lang['SHOW_MOD_HOME_PAGE'] = 'Wys modereerders op die tuisblad (index.php)';
$lang['SHOW_BOARD_STARTED_INDEX'] = 'Wys bord begin datum op index.php';
$lang['PREMOD_HELP'] = '<h4><span class="tor-icon tor-dup">&#8719;</span> Voormoderering</h4> <h6>Indien daar geen torrents met status v, #, of T in hierdie afdeling en sy subafdelings is nie, sal nuwe verspreidings outomaties hierdie status ontvang</h6>';
$lang['TOR_COMMENT'] = '<h4>Kommentaar op status van \'n verspreiding</h4> <h6>Die kommentaar laat jou toe om foute in die vrystelling uit te wys. Indien korreksies nodig is, word \'n reaksievorm beskikbaar gestel aan die oplaaiers om die vrystelling reg te stel</h6>';
$lang['SEED_BONUS_ADD'] = '<h4>Saai bonusreëls</h4> <h6>Aantal torrents wat deur die gebruiker gesaai word en die ooreenstemmende bonuspunte wat per uur toegekend word</h6>';
$lang['SEED_BONUS_RELEASE'] = 'tot N vrystellings';
$lang['SEED_BONUS_POINTS'] = 'bonuspunte per uur';
$lang['SEED_BONUS_TOR_SIZE'] = '<h4>Minimale torrent-grootte om vir bonuspunte in aanmerking te kom</h4> <h6>Laat leeg om bonusse toe te ken vir alle torrents ongeag grootte.</h6>';
$lang['SEED_BONUS_USER_REGDATA'] = '<h4>Minimale ouderdom van gebruikersrekening om vir bonuspunte in aanmerking te kom</h4> <h6>Laat leeg om bonusse aan alle gebruikers toe te ken, ongeag rekeningouderdom.</h6>';
$lang['SEED_BONUS_WARNING'] = 'AANDAG! Saadbonusse moet in stygende volgorde wees';
$lang['SEED_BONUS_EXCHANGE'] = 'Konfigurering van ruil vir saai bonusse';
$lang['SEED_BONUS_ROPORTION'] = 'Wisselkoers: bonuspunte na GB van oplaai-krediet';
...
$lang['ALLOW_REG_TRACKER'] = 'Toegelate forums vir die registrasie van .torrents op die spoorsnyer';
$lang['ALLOW_PORNO_TOPIC'] = 'Toegestaan om 18+ inhoud te plaas';
$lang['SELF_MODERATED'] = 'Gebruikers kan <b>hul</b> onderwerpe na \'n ander forum beweeg';
...
$lang['BT_PRIVATE_TRACKER'] = 'Hierdie dop is privaat: lêerlys (vir gaste), DHT | PEX is gedeaktiveer';
$lang['BT_PRIVATE_TORRENT'] = 'Die skepper van hierdie torrent het dit privaat gemaak';
$lang['BT_CHECK_ANNOUNCE_URL'] = 'Verifieer aankondigings-URL';
$lang['BT_CHECK_ANNOUNCE_URL_EXPL'] = 'registreer slegs toegelate URL\'s op die tracker';
$lang['BT_REPLACE_ANN_URL'] = 'Vervang aankondigings-URL';
$lang['BT_REPLACE_ANN_URL_EXPL'] = 'Vervang oorspronklike aankondigings-URL met jou standaard in .torrent lêers';
...
$lang['BT_SHOW_PEERS_HEAD'] = 'Eweknieë Lys';
$lang['BT_SHOW_PEERS'] = 'Wys eweknieë (saadjies en leechers)';
$lang['BT_SHOW_PEERS_EXPL'] = 'Dit sal \'n lys van saadjies/leechers bo die onderwerp met torrent wys';
...
$lang['BT_ALLOW_SPMODE_CHANGE_EXPL'] = 'As "nee" is, sal slegs die standaard eweknie vertooningsmodus beskikbaar wees';
...
$lang['BT_ADD_AUTH_KEY'] = 'Aktiveer voeg paspoort by die torrent-lêers voor aflaai';
...
$lang['QUESTION'] = 'Is jy seker jy wil hierdie aksie uitvoer?';
...
$lang['CRON_RUN'] = 'Doen niks';
$lang['CRON_DEL'] = 'Verwyder';
$lang['CRON_DISABLE'] = 'Afskakel';
$lang['CRON_ENABLE'] = 'In staat te stel';
$lang['DELETE_JOB'] = 'Is jy seker jy wil hierdie cronjob verwyder?';
...
$lang['NOSELECT'] = 'Nie gekies nie';
$lang['RUN_DAY'] = 'Begin dag';
$lang['RUN_DAY_EXPL'] = 'die dag waarop hierdie werk uitgevoer word';
$lang['RUN_TIME'] = 'Looptyd';
$lang['RUN_TIME_EXPL'] = 'die tyd waarop hierdie werk uitgevoer word (bv. 05:00:00)';
$lang['RUN_ORDER'] = 'Begin bestelling';
$lang['LAST_RUN'] = 'Laaste uitvoering';
$lang['NEXT_RUN'] = 'Volgende uitvoering';
$lang['RUN_INTERVAL'] = 'Begin interval';
$lang['RUN_INTERVAL_EXPL'] = 'Bv. 00:10:00';
$lang['LOG_ENABLED'] = 'Log aangeskakel';
$lang['LOG_FILE'] = 'Loglêer';
$lang['LOG_FILE_EXPL'] = 'die lêer waarin die log gestoor word';
$lang['LOG_SQL_QUERIES'] = 'Teken SQL-navrae';
$lang['FORUM_DISABLE'] = 'Deaktiveer forum';
...
$lang['SCRIPT_DUPLICATE'] = '"n Cron-taak met hierdie skrip bestaan reeds';
$lang['TITLE_DUPLICATE'] = '"n Cron-taak met hierdie titel bestaan reeds';
...
$lang['START_OPTION_CONTINUE'] = 'gaan voort vanaf waar jy laas opgehou het';
...
$lang['REFRESH_RATE'] = 'Refresh koers';
...
$lang['INFO_ESTIMATED_VALUES'] = '(*) Al die beraamde waardes is ongeveer bereken<br />en mag nie die werklike finale waardes verteenwoordig nie.<br />Soos die voltooide persentasie verhoog, sal die beraamde waardes nader aan die werklike wees.';
...
$lang['BOT_TOPIC_MOVED_FROM_TO'] = 'Onderwerp is verskuif vanaf forum [b]%s[/b] na forum [b]%s[/b].[br][b]Rede vir verskuiwing:[/b] %s[br][br]%s';
...
$lang['CALLSEED'] = 'Bel saad';
$lang['CALLSEED_EXPLAIN'] = 'Stel saaiers in kennis met \'n versoek om hierdie vrystelling weer te saai';
$lang['CALLSEED_SUBJECT'] = 'Saai hulp benodig: %s';
$lang['CALLSEED_TEXT'] = 'Hallo![br]Jou hulp word benodig vir die vrystelling [url=%s]%s[/url][br]Indien jy wil help maar die torrent-lêer reeds verwyder het, kan jy dit [url=%s]hier[/url] aflaai[br][br]Jou hulp sal baie waardeer word!';
$lang['CALLSEED_MSG_OK'] = 'Versoek is na almal gestuur wat hierdie vrystelling afgelaai het';
$lang['CALLSEED_MSG_SPAM'] = '\'n Versoek is onlangs reeds gestuur (miskien nie deur jou nie).<br /><br />Die volgende versoek kan gestuur word op <b>%s</b>.';
...
$lang['LOG_ACTION']['LOG_TYPE'] = [
    ...
    'mod_topic_tor_register' => 'Onderwerp:<br /> <b>torrent geregistreer</b>',
    'mod_topic_tor_delete' => 'Onderwerp:<br /> <b>torrent verwyder</b>',
    'mod_topic_renamed' => 'Onderwerp:<br /> <b>hernoem</b>',
    'mod_topic_poll_started' => 'Onderwerp:<br /> <b>stemming begin</b>',
    'mod_topic_poll_finished' => 'Onderwerp:<br /> <b>stemming klaar</b>',
    'mod_topic_poll_deleted' => 'Onderwerp:<br /> <b>stemming verwyder</b>',
    'mod_topic_poll_added' => 'Onderwerp:<br /> <b>stemming bygevoeg</b>',
    'mod_topic_poll_edited' => 'Onderwerp:<br /> <b>stemming gewysig</b>',
    'mod_post_delete' => 'Pos: <br /> <b>deleted</b>',
    'mod_post_pin' => 'Pos:<br /> <b>gepin</b>',
    'mod_post_unpin' => 'Pos:<br /> <b>ontgepin</b>',
    'adm_user_delete' => 'Gebruiker: <br /> <b>deleted</b>',
    'adm_user_ban' => 'Gebruiker:<br /> <b>verbode</b>',
    'adm_user_unban' => 'Gebruiker:<br /> <b>ontverbode</b>',
];
...
$lang['SEARCH_INVALID_USERFIELD'] = 'Ongeldige gebruikersvelddata ingevoer';
...
$lang['SEARCH_FOR_USERNAME'] = 'Soek gebruikersname wat ooreenstem met %s';
$lang['SEARCH_FOR_EMAIL'] = 'Soek e-posadresse wat ooreenstem met %s';
$lang['SEARCH_FOR_IP'] = 'Soek IP-adresse wat ooreenstem met %s';
$lang['SEARCH_FOR_DATE'] = 'Soek tans gebruikers wat by %s %d / %d / %d aangesluit het.';
$lang['SEARCH_FOR_GROUP'] = 'Soek groeplede van %s';
$lang['SEARCH_FOR_RANK'] = 'Soek na gebruikers met rang %s';
$lang['SEARCH_FOR_BANNED'] = 'Soek na verbode gebruikers';
$lang['SEARCH_FOR_ADMINS'] = 'Soek administrateurs';
$lang['SEARCH_FOR_MODS'] = 'Soek moderators';
...
$lang['SEARCH_FOR_LASTVISITED_INTHELAST'] = 'Op soek na gebruikers wat besoek het in die laaste %s';
...
$lang['BEFORE'] = 'voordat';
$lang['AFTER'] = 'na';
$lang['SEARCH_USERS_JOINED_EXPLAIN'] = 'Soek na gebruikers wat voor of na \'n spesifieke datum aangesluit het. Die datumformaat is JJJJ/MM/DD.';
$lang['SEARCH_USERS_GROUPS_EXPLAIN'] = 'Bekyk alle lede van die gekose groep.';
$lang['SEARCH_USERS_RANKS_EXPLAIN'] = 'Sien alle gebruikers met die geselekteerde rang.';
...
$lang['SEARCH_USERS_LASTVISITED_EXPLAIN'] = 'U kan gebruikers soek op grond van hul laaste inskrywingsdatum deur hierdie soektog te gebruik.';
...
$lang['SEARCH_USERS_NEW'] = '%s het %d resultaat(s) opgelewer. Voer <a href="%s">nog \'n soektog</a> uit.';
$lang['BANNED'] = 'Verban';
...
$lang['MC_COMMENT_PM_MSG'] = "Hallo, [b]%s[/b]\n'n Modereerder het 'n kommentaar op jou plasing [url=%s][b]%s[/b][/url] gemaak.[quote]\n%s\n[/quote]";
$lang['MC_COMMENT'] = [
    0 => [
        'title' => '',
...
$lang['SITEMAP_ADD_EXP_1'] = 'U kan addisionele bladsye op u webwerf spesifiseer wat ingesluit moet word in die sitemap-lêer wat u aan die gang is.';
$lang['SITEMAP_ADD_EXP_2'] = 'Elke verwysing moet begin met http(s):// en \'n nuwe reël!';

$lang['FORUM_MAP'] = 'Forums se kaart';
$lang['ATOM_FEED'] = 'Voer ontslag';
$lang['ATOM_ERROR'] = 'Kon nie voer genereer nie.';
$lang['ATOM_SUBSCRIBE'] = 'Teken in op die voer.';
$lang['ATOM_UPDATED'] = 'Opgedateer.';
$lang['ATOM_GLOBAL_FEED'] = 'Globale voer vir alle fora.';

$lang['HASH_INVALID'] = 'Hash %s is ongeldig';
$lang['HASH_NOT_FOUND'] = 'Vrylating met hash %s nie gevind nie';

$lang['TERMS_EMPTY_TEXT'] = '[align=center]Die teks van hierdie bladsy is geredigeer op: [url]%s[/url]. Hierdie reël kan net deur administrateurs gesien word.[/align]';
$lang['TERMS_EXPLAIN'] = 'Op hierdie bladsy kan u die teks van die basiese reëls van die bron spesifiseer vir gebruikers.';
$lang['TERMS_UPDATED_SUCCESSFULLY'] = 'Voorwaardes is suksesvol opgedateer';
$lang['CLICK_RETURN_TERMS_CONFIG'] = '%sKlik hier om terug te keer na Voorwaardes van redigeerder%s';

$lang['TR_STATS'] = [
    0 => 'Onaktiewe gebruikers oor 30 dae',
    1 => 'Onaktiewe gebruikers vir 90 dae',
    2 => 'medium grootte verspreidings op die dop.',
...
$lang['UPLOAD_ERROR_DIMENSIONS'] = 'Beeldafmetings oorskry die maksimum toelaatbare %sx%s pixels';
...
$lang['UPLOAD_ERRORS'] = [
    ...
    UPLOAD_ERR_EXTENSION => 'Upload gestop deur uitbreiding.',
];

// Captcha
$lang['CAPTCHA'] = 'Maak seker dat jy nie \'n robot is nie';
$lang['CAPTCHA_WRONG'] = 'Jy kon nie bevestig dat jy nie \'n robot is nie';
$lang['CAPTCHA_SETTINGS'] = '<h2>Captcha is nie volledig gekonfigureer nie</h2><p>Genereer die sleutels met die dashboard van jou captcha-diens, daarna moet jy dit in die lêer config/config.php plaas.</p>';
$lang['CAPTCHA_OCCURS_BACKGROUND'] = 'Die CAPTCHA-verifikasie vind in die agtergrond plaas';

// Sending email
$lang['REPLY_TO'] = 'Antwoord op';
$lang['EMAILER_SUBJECT'] = [
    ...
    'TOPIC_NOTIFY' => 'Kennisgewing van antwoord in die draad - %s',
...
// Null ratio
$lang['BT_NULL_RATIO'] = 'Herstel ratio';
$lang['BT_NULL_RATIO_NONE'] = 'Jy het nie \'n verhouding nie';
$lang['BT_NULL_RATIO_ALERT'] = "Aandag!\n\nIs jy seker jy wil jou verhouding herstel?";
$lang['BT_NULL_RATIO_AGAIN'] = 'Jy het jou verhouding reeds herstel!';
$lang['BT_NULL_RATIO_NOT_NEEDED'] = 'Jy het \'n goeie verhouding. Herstel is slegs moontlik met \'n verhouding van minder as %s';
$lang['BT_NULL_RATIO_SUCCESS'] = 'Die verhouding is suksesvol herstel!';
...
$lang['TWO_FACTOR_VERIFICATION'] = 'Twee-stap verifikasie';
$lang['TWO_FACTOR_SECURITY'] = 'Sekuriteit';
$lang['TWO_FACTOR_AUTH_EXPLAIN'] = 'Voeg \'n ekstra laag sekuriteit by jou rekening deur \'n TOTP-verifikasieprogram te gebruik';
$lang['TWO_FACTOR_ENABLE'] = 'Skakel 2FA aan';
$lang['TWO_FACTOR_DISABLE'] = 'Skakel 2FA af';
$lang['TWO_FACTOR_ENABLED'] = 'Aangeskakel';
$lang['TWO_FACTOR_DISABLED'] = ' Gestremd';
$lang['TWO_FACTOR_SETUP'] = 'Stel twee-stap verifikasie op';
$lang['TWO_FACTOR_SETUP_EXPLAIN'] = 'Skandeer hierdie QR-kode met jou verifikasieprogram (Google Authenticator, Authy, ens.) of voer die sleutel handmatig hieronder in.';
$lang['TWO_FACTOR_MANUAL_ENTRY'] = 'Of voer hierdie sleutel handmatig in';
$lang['TWO_FACTOR_ENTER_CODE'] = 'Voer die 6-syfer kode van jou verifikasieprogram in';
$lang['TWO_FACTOR_CODE'] = 'Verifikasie kode';
$lang['TWO_FACTOR_VERIFY'] = 'Verifieer';
$lang['TWO_FACTOR_VERIFY_AND_ENABLE'] = 'Verifieer en skakel aan';
$lang['TWO_FACTOR_INVALID_CODE'] = 'Ongeldige kode. Probeer asseblief weer.';
$lang['TWO_FACTOR_SESSION_EXPIRED'] = 'Verifikasiesessie is verval. Meld asseblief weer aan.';
$lang['TWO_FACTOR_SETUP_EXPIRED'] = 'Opstellingsessie is verval. Probeer asseblief weer.';
$lang['TWO_FACTOR_ALREADY_ENABLED'] = 'Twee-stap verifikasie is reeds op jou rekening geaktiveer.';
$lang['TWO_FACTOR_NOT_ENABLED'] = 'Twee-stap verifikasie is nie op jou rekening geaktiveer nie.';
$lang['TWO_FACTOR_FEATURE_DISABLED'] = 'Twee-stap verifikasie is nie beskikbaar nie';
$lang['TWO_FACTOR_ENABLED_SUCCESS'] = 'Twee-stap verifikasie is aangeskakel';
$lang['TWO_FACTOR_DISABLED_SUCCESS'] = 'Twee-stap verifikasie is afgeskakel';
$lang['TWO_FACTOR_RECOVERY_CODES'] = 'Herstelkodes';
$lang['TWO_FACTOR_RECOVERY_WARNING'] = 'Stoor hierdie herstelkodes op \'n veilige plek. As jy jou verifikasie-toestel verloor, kan jy hierdie kodes gebruik om aan te meld.';
$lang['TWO_FACTOR_RECOVERY_EXPLAIN'] = 'Elke kode kan net een keer gebruik word. Stoor hulle apart van jou toestel.';
$lang['TWO_FACTOR_RECOVERY_CODE'] = 'Herstelkode';
$lang['TWO_FACTOR_ENTER_RECOVERY'] = 'Voer een van jou herstelkodes in';
$lang['TWO_FACTOR_USE_RECOVERY'] = 'Gebruik eerder \'n herstelkode';
$lang['TWO_FACTOR_USE_TOTP'] = 'Gebruik eerder \'n verifikasie kode';
$lang['TWO_FACTOR_INVALID_RECOVERY'] = 'Ongeldige herstelkode. Probeer asseblief weer.';
$lang['TWO_FACTOR_RECOVERY_CODE_USED'] = 'Herstelkode gebruik. Jy het nog {one} kode oor|{other} kodes oor.';
$lang['TWO_FACTOR_REMAINING_CODES'] = 'Jy het nog {one} herstelkode oor|{other} herstelkodes oor';
$lang['TWO_FACTOR_DOWNLOAD_CODES'] = 'Laai af as tekslêer';
$lang['TWO_FACTOR_RECOVERY_EXPIRED'] = 'Die vertoon van herstelkodes is verval. Jou kodes is steeds aktief.';
$lang['TWO_FACTOR_DOWNLOAD_EXPIRED'] = 'Laaiskakel is verval.';
$lang['TWO_FACTOR_DISABLE_WARNING'] = 'Hierdie aksie sal twee-stap verifikasie op jou rekening deaktiveer. Jy sal jou huidige verifikasiekode moet invoer om te bevestig.';
$lang['TWO_FACTOR_DISABLE_CONFIRM'] = 'Deaktiveer twee-stap verifikasie';
$lang['TWO_FACTOR_REGENERATE'] = 'Herskep herstelkodes';
$lang['TWO_FACTOR_REGENERATE_WARNING'] = 'Hierdie aksie sal alle bestaande herstelkodes ongeldig maak en nuwe genereer.';
$lang['TWO_FACTOR_REGENERATE_CONFIRM'] = 'Herskep kodes';
$lang['TWO_FACTOR_ADMIN_DISABLE'] = 'Deaktiveer gebruiker 2FA';
$lang['TWO_FACTOR_ADMIN_DISABLE_CONFIRM'] = 'Is jy seker jy wil twee-stap verifikasie vir hierdie gebruiker deaktiveer?';
$lang['TWO_FACTOR_TOO_MANY_ATTEMPTS'] = 'Te veel mislukte pogings. Probeer asseblief weer oor {one} minuut|{other} minute.';
$lang['TWO_FACTOR_INVALID_TOKEN'] = 'Ongeldige of vervalde token.';
$lang['TWO_FACTOR_DONE'] = 'Gedaan';
$lang['TWO_FACTOR_RECOVERY_ONETIME'] = 'Hierdie bladsy kan net een keer besigtig word. As jy vertrek, kan jy hierdie kodes nie weer sien nie.';
$lang['TWO_FACTOR_ADMIN_DISABLE_SELF'] = 'Jy kan nie jou eie twee-stap verifikasie vanaf die administrateur-paneel deaktiveer nie. Gebruik eerder jou profielinstellings.';
